---
title: "ConnectApi.IPLStandingCalcOutputNode"
domain: insurance-developer-guide
topic: connectapiiplstandingcalcoutputnode
apiVersion: 67.0
...
| --- | --- | --- | --- |
| amounts | ConnectApi.IPLStandingCalcAmounts | Details of the calculation amounts. | 65.0 |
| coverageInfo | ConnectApi.IPLStandingCalcCoverageInfo | Details of the claim coverage. | 65.0 |
| limitAttributes | ConnectApi.IPLStandingCalcLimitAttributes | Attribute details of the insurance policy limit. | 65.0 |
| mappedScopes | Map<String, >ConnectApi.IPLStandingMappedScopes | Details of the mapped scopes. | 65.0 |
| values | ConnectApi.IPLStandingCalcValues | Calculation values. | 65.0 |
