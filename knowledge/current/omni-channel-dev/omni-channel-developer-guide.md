---
title: "Omni-Channel Developer Guide"
domain: omni-channel-dev
topic: omni-channel-developer-guide
apiVersion: 67.0
...
Standard Omni-Channel reaches its End of Life (EOL) with the Summer '26 release. For continued support, access to the latest features, and an enhanced experience, update to [Enhanced Omni-Channel](https://help.salesforce.com/s/articleView?id=service.omnichannel_enable.htm&type=5&language=en_US).
...
-   **[Omni-Channel Objects](atlas.en-us.omni_channel_dev.meta/omni_channel_dev/service_presence_soap_api_intro.htm)**
...
-   **[Omni-Channel Metadata API Types](atlas.en-us.omni_channel_dev.meta/omni_channel_dev/omnichannel_metadata_api_intro.htm)**
    The Metadata API lets you access Omni-Channel feature settings and metadata information.
-   **[Omni-Channel Components for the Salesforce Console](atlas.en-us.omni_channel_dev.meta/omni_channel_dev/service_presence_console_api_intro.htm)**
    Omni-Channel lets your call center route any type of incoming work item to the most qualified, available agents.
-   **[External Routing for Omni-Channel](atlas.en-us.omni_channel_dev.meta/omni_channel_dev/omnichannel_external_routing.htm)**
