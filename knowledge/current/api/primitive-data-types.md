...
lastCollected: 2026-05-10T00:40:44.137Z
...
The API uses data types called field types that are defined in the WSDLs. For more information, see [Field Types](atlas.en-us.api.meta/api/field_types.htm "In addition to the primitive data types, the API defines the following data types for fields.").

## Related Topics

- Currency Field
        Type (atlas.en-us.api.meta/api/field_types.htm)
- Percent Field Type (atlas.en-us.api.meta/api/field_types.htm)
- Field
    Types (atlas.en-us.api.meta/api/field_types.htm)
