...
docType: concept
lastCollected: 2026-03-12T09:33:57.665Z
estimatedTokens: 2456
keywords: [Knowledge, possible, changed, noninclusive, terms, align, company, Equality, maintained, certain, avoid, any, effect, customer, implementations]
---
...
This entity relationship diagram (ERD) illustrates relationships between the Salesforce Knowledge objects in Lightning Knowledge.

![ERD of Lightning Knowledge](/docs/resources/img/en-us/260.0?doc_id=dev_guides%2Fapi%2Fimages%2FSforce_knowledge_lightning_objects.png&folder=api)

This ERD illustrates the relationship between objects in Salesforce Classic.

![ERD of Knowledge in Salesforce Classic](/docs/resources/img/en-us/260.0?doc_id=dev_guides%2Fapi%2Fimages%2FSforce_knowledge_objects.png&folder=api)

## Additional Information

To learn more about managing your knowledge base using the API, see the [Knowledge Developer Guide](https://developer.salesforce.com/docs/atlas.en-us.260.0.knowledge_dev.meta/knowledge_dev/knowledge_development_intro.htm).
