...
lastCollected: 2026-03-12T09:33:57.750Z
estimatedTokens: 179
...
See the examples provided for [login()](atlas.en-us.api.meta/api/sforce_api_calls_login.htm "Logs in to the login server and starts a client session.").
