...
lastCollected: 2026-03-12T09:33:53.431Z
estimatedTokens: 358
keywords: [Unified, Catalog, Business, APIs, provide, standardized, REST, accessing, data, rules, service, automation, workflows, enable, client]
---

# Unified Catalog Business APIs

> The Unified Catalog APIs provide a standardized REST interface for accessing catalog
    data and related business rules used in service automation workflows. These APIs enable client
    applications to retrieve catalog entities and eligibility rules in a consistent and versioned
    manner. They are designed to support scalable integrations without requiring catalog-specific
    logic in consuming systems.
...
- /connect/service-automation/eligibility-rule (atlas.en-us.industries_reference.meta/industries_reference/connect_resources_eligibility_rule.htm)
- /connect/service-automation/eligibility-rule-metadata (atlas.en-us.industries_reference.meta/industries_reference/connect_resources_eligibility_rule_metadata.htm)
- Resources (atlas.en-us.industries_reference.meta/industries_reference/unified_catalog_business_apis_resources.htm)
- Request Bodies (atlas.en-us.industries_reference.meta/industries_reference/unified_catalog_business_apis_requests.htm)
- Response Bodies (atlas.en-us.industries_reference.meta/industries_reference/unified_catalog_business_apis_responses.htm)
