...
lastCollected: 2026-04-07T18:36:43.003Z
estimatedTokens: 524
...
| IsActive | TypebooleanPropertiesDefaulted on create, Filter, Group, Nillable, SortDescriptionIndicates whether the data source is still active (true) or not (false). There can only be one active data source at a time.The default value is false. |
