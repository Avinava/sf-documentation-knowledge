...
lastCollected: 2026-03-12T05:14:50.219Z
estimatedTokens: 330
keywords: [Expression, Set, Output, representation, expression, set, create, update, delete, request.]
---
...
- Context ​Definition Output (atlas.en-us.industries_reference.meta/industries_reference/connect_responses_context_definition_output.htm)
- Expression Set​ Error (atlas.en-us.industries_reference.meta/industries_reference/connect_responses_expression_set_error.htm)
- Expression Set​ Version Output (atlas.en-us.industries_reference.meta/industries_reference/connect_responses_expression_set_version_output.htm)
