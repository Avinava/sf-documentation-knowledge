...
domain: omnistudio
topic: expression-set-custom-element-parameter
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-03-12T05:14:50.199Z
estimatedTokens: 207
keywords: [Expression, Set, Custom, Element, Output, representation, custom, element, expression, set.]
---
...
Output representation of a custom element parameter in an expression set.
...
| type | String | Type of custom element parameter.Valid values are:FormulaLiteralLookupParameterPicklistThe default value is Parameter. | Small, 58.0 | 58.0 |
