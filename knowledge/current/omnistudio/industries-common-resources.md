---
title: "Industries Common Resources"
domain: omnistudio
topic: industries-common-resources
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:25:11.374Z
keywords: [Industries, Common, Resources]
---
...
Certain feature sets are shared across industries. This guide contains developer documentation to help you put those features to work.

-   **[AI Accelerator and Scoring Framework](atlas.en-us.industries_reference.meta/industries_reference/ai_accelerator_and_scoring_framework.htm)**  
...
-   **[Action Launcher](atlas.en-us.industries_reference.meta/industries_reference/action_launcher.htm)**  
...
-   **[Actionable List Members](atlas.en-us.industries_reference.meta/industries_reference/actionable_list_members.htm)**  
...
-   **[Actionable Segmentation](atlas.en-us.industries_reference.meta/industries_reference/actionable_segmentation_objects.htm)**  
...
-   **[Business Rules Engine](atlas.en-us.industries_reference.meta/industries_reference/business_rules_engine.htm)**  
...
-   **[Collections and Recovery](atlas.en-us.industries_reference.meta/industries_reference/collections_objects.htm)**  
    Use Collections data model to streamline the collection process. Create prioritized lists of collection plans. Create and manage promise to pay agreements for better management of overdue amounts.
-   **[Context Service](atlas.en-us.industries_reference.meta/industries_reference/context_service_overview.htm)**  
...
-   **[Criteria-Based Search and Filter](atlas.en-us.industries_reference.meta/industries_reference/criteria_based_search_and_filter_overview.htm)**  
...
-   **[Data Processing Engine, Batch Management, and Monitor Workflow Services](atlas.en-us.industries_reference.meta/industries_reference/batch.htm)**  
...
-   **[Digital Lending](atlas.en-us.industries_reference.meta/industries_reference/digital_lending_overview.htm)**  
...
-   **[Discovery Framework](atlas.en-us.industries_reference.meta/industries_reference/discovery_framework.htm)**  
...
-   **[Decision Explainer](atlas.en-us.industries_reference.meta/industries_reference/decision_explainer.htm)**  
...
-   **[Einstein Relationship Insights](atlas.en-us.industries_reference.meta/industries_reference/eri.htm)**  
...
-   **[Einstein Standard Invocable Actions](atlas.en-us.industries_reference.meta/industries_reference/einstein_invocable_actions_parent.htm)**  
    Integrate custom deep-learning models into CRM workflows with Einstein Invocable Actions.
-   **[Engagement](atlas.en-us.industries_reference.meta/industries_reference/engagement.htm)**  
    Use the engagement objects to store details about an engagement between a customer and a customer service representative.
-   **[Group Membership and Households](atlas.en-us.industries_reference.meta/industries_reference/group_membership_and_households_overview.htm)**  
...
-   **[Identity Verification](atlas.en-us.industries_reference.meta/industries_reference/identity_verification.htm)**  
...
-   **[Intelligent Document Reader](atlas.en-us.industries_reference.meta/industries_reference/intelligent_document_reader.htm)**  
    Intelligent Document Reader provides optical character recognition to automatically extract data from external documents.
-   **[Intelligent Form Reader](atlas.en-us.industries_reference.meta/industries_reference/intelligent_form_reader_parent.htm)**  
    Intelligent Form Reader provides optical character recognition to automatically extract data from external documents.
-   **[Interest Tagging](atlas.en-us.industries_reference.meta/industries_reference/interest_tagging_parent.htm)**  
...
-   **[Omnistudio](atlas.en-us.industries_reference.meta/industries_reference/omnistudio_overview.htm)**  
    Omnistudio provides a suite of services, components, and data model objects that combine to create Industry Cloud applications. Use Omnistudio to create guided interactions using data from your Salesforce org and external sources. Create Omniscripts to guide users through sales and service processes with fast, personalized responses. Get and post data with Omnistudio Data Mappers and Integration Procedures.
-   **[Outcome Management Developer Guide](atlas.en-us.industries_reference.meta/industries_reference/outcome_management_developer_guide.htm)**  
...
-   **[Outreach List](atlas.en-us.industries_reference.meta/industries_reference/outreach_list.htm)**  
...
-   **[Process Compliance Navigator](atlas.en-us.industries_reference.meta/industries_reference/process_compliance_navigator_overview.htm)**  
    Use the Process Compliance Navigator management solution to make sure your organization meets regulatory requirements, internal policies, and industry standards. Create validation procedures with controls that help your organization avoid non-compliance and achieve ongoing regulatory compliance. Prevent compliance violations through compliance checks, deadline alerts, and compliant execution features.
-   **[Record Alerts](atlas.en-us.industries_reference.meta/industries_reference/record_alerts_parent.htm)**  
...
-   **[Record Rollup Definitions](atlas.en-us.industries_reference.meta/industries_reference/rollup_definitions.htm)**  
...
-   **[Scheduled Reminders](atlas.en-us.industries_reference.meta/industries_reference/scheduled_reminders.htm)**  
...
-   **[Sentiment Insights](atlas.en-us.industries_reference.meta/industries_reference/sentiment_insights.htm)**  
...
-   **[Service Process Studio](atlas.en-us.industries_reference.meta/industries_reference/service_process_studio.htm)**  
...
-   **[Stage Management](atlas.en-us.industries_reference.meta/industries_reference/stage_management.htm)**  
    Stage Management enables you to automate and manage business process stages and gain control over the record stage progress. You can get details of business process stages, transitions, and the fulfillment criteria for each stage of a complex business process.
-   **[Timeline](atlas.en-us.industries_reference.meta/industries_reference/timeline.htm)**  
...
-   **[Unified Catalog](atlas.en-us.industries_reference.meta/industries_reference/unified_catalog_overview.htm)**  
    The Unified Catalog provides a centralized, consistent framework for managing and accessing product and service definitions across business processes. It serves as a single source of truth for catalog data that can be reused by downstream systems and applications, ensuring uniformity in how offerings are defined, discovered, and consumed.
-   **[Virtual Calls](atlas.en-us.industries_reference.meta/industries_reference/virtual_calls.htm)**  
...
-   **[Associated Objects](atlas.en-us.industries_reference.meta/industries_reference/sforce_api_associated_objects_list.htm)**  
    This section provides a list of objects associated to Industries standard objects and their standard fields.
-   **[IndustriesSettings](atlas.en-us.industries_reference.meta/industries_reference/meta_industriessettings.htm)**  
...
-   **[Industries Object Access by Community License](atlas.en-us.industries_reference.meta/industries_reference/industries_object_access_by_license.htm)**  
...
-   **[Access Industries Features Deployed Using Managed Packages](atlas.en-us.industries_reference.meta/industries_reference/rest_reference_managed_packages.htm)**  
