...
lastCollected: 2026-03-12T05:14:51.055Z
estimatedTokens: 701
keywords: [Discovery, Framework, data, model, helps, manage, every, aspect, questionnaire-driven, information, collection, cases., users, collect, validate, their, customers’, compliant, manner., example]
---
...
-   **[Discovery Framework Standard Objects](atlas.en-us.industries_reference.meta/industries_reference/discovery_framework_standard_objects.htm)**
...
-   **[Discovery Framework Metadata API Types](atlas.en-us.industries_reference.meta/industries_reference/discovery_framework_metadata_api_parent.htm)**
    Metadata API enables you to access some types and feature settings that you can customize in the user interface.
-   **[Discovery Framework Invocable Actions](atlas.en-us.industries_reference.meta/industries_reference/discovery_framework_actions.htm)**
    Use actions to invoke Discovery Framework actions in a flow.
-   **[Discovery Framework Tooling API Objects](atlas.en-us.industries_reference.meta/industries_reference/discovery_framework_tooling_api_objects.htm)**
...
-   **[Discovery Framework Connect APIs](atlas.en-us.industries_reference.meta/industries_reference/dfdt_connect_apis.htm)**
...
-   **[DiscoveryFramework\_Prefill Integration Procedure](atlas.en-us.industries_reference.meta/industries_reference/discoveryframework_prefill_integration_procedure.htm)**
...
- Discovery Framework Tooling API Objects (atlas.en-us.industries_reference.meta/industries_reference/discovery_framework_tooling_api_objects.htm)
- Discovery Framework Connect APIs (atlas.en-us.industries_reference.meta/industries_reference/dfdt_connect_apis.htm)
- DiscoveryFramework_Prefill Integration Procedure (atlas.en-us.industries_reference.meta/industries_reference/discoveryframework_prefill_integration_procedure.htm)
