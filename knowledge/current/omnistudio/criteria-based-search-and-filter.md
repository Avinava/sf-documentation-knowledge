---
title: "Criteria-Based Search and Filter"
domain: omnistudio
topic: criteria-based-search-and-filter
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-03-12T05:14:50.938Z
estimatedTokens: 306
keywords: [Criteria-Based, Search, Filter, Configure, search, based, single, searchable, combines, data, that’s, spread, across, multiple, objects, fields.]
---
...
-   **[Metadata API Types](atlas.en-us.industries_reference.meta/industries_reference/criteria_based_search_and_filter_metadata_api_parent.htm)**
    Metadata API enables you to access some types and feature settings that you can customize in the user interface.
-   **[Tooling API Objects](atlas.en-us.industries_reference.meta/industries_reference/criteria_based_search_and_filter_tooling_api_parent.htm)**
...
-   **[Business APIs](atlas.en-us.industries_reference.meta/industries_reference/criteria_based_search_and_filter_apis.htm)**
