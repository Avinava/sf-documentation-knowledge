...
lastCollected: 2026-03-12T05:14:47.453Z
estimatedTokens: 776
namespace: BusinessRule
keywords: [CalculationMatrixMigrationService, Contains, migrating, calculation, matrices, Vlocity, package, Business, Rules, Engine, decision, matrices., Example, migrate, calculationMatrixIds, calculationMatrixId]
---
...
-   **[CalculationMatrixMigrationService Methods](atlas.en-us.industries_reference.meta/industries_reference/apex_class_BusinessRule_CalculationMatrixMigrationService.htm#apex_BusinessRule_CalculationMatrixMigrationService_methods)**
...
-   **[migrate(calculationMatrixIds, namespace)](atlas.en-us.industries_reference.meta/industries_reference/apex_class_BusinessRule_CalculationMatrixMigrationService.htm#apex_BusinessRule_CalculationMatrixMigrationService_migrate)**
    Migrate calculation matrices from the Vlocity package to the Business Rules Engine as decision matrices.
-   **[migrate(calculationMatrixId, namespace)](atlas.en-us.industries_reference.meta/industries_reference/apex_class_BusinessRule_CalculationMatrixMigrationService.htm#apex_BusinessRule_CalculationMatrixMigrationService_migrate_2)**
...
- CalculationMatrixMigrationService Methods (atlas.en-us.industries_reference.meta/industries_reference/apex_class_BusinessRule_CalculationMatrixMigrationService.htm)
- migrate(calculationMatrixIds, namespace) (atlas.en-us.industries_reference.meta/industries_reference/apex_class_BusinessRule_CalculationMatrixMigrationService.htm)
- migrate(calculationMatrixId, namespace) (atlas.en-us.industries_reference.meta/industries_reference/apex_class_BusinessRule_CalculationMatrixMigrationService.htm)
