...
lastCollected: 2026-03-12T05:14:51.153Z
estimatedTokens: 413
keywords: [Expression, Set, consist, series, steps, connected, logical, flow, built, variables, constants, conditions, calculations, lookups, aggregations., expression, set, allow, complex, math]
---
...
- Expression Set Standard Objects (atlas.en-us.industries_reference.meta/industries_reference/expression_set_standard_objects.htm)
- Expression Set Business APIs (atlas.en-us.industries_reference.meta/industries_reference/expression_set_connect_apis.htm)
- Expression Set Invocable Actions (atlas.en-us.industries_reference.meta/industries_reference/expression_set_invocable_actions.htm)
- Expression Set Metadata API Types (atlas.en-us.industries_reference.meta/industries_reference/expression_set_metadata_api_parent.htm)
- Expression Set Tooling API Objects (atlas.en-us.industries_reference.meta/industries_reference/expression_set_tooling_objects_parent.htm)
- Resources (atlas.en-us.industries_reference.meta/industries_reference/omnistudio_apis_resources.htm)
- Request Bodies (atlas.en-us.industries_reference.meta/industries_reference/omnistudio_apis_requests.htm)
- Response Bodies (atlas.en-us.industries_reference.meta/industries_reference/omnistudio_apis_responses.htm)
