...
> Based on criteria that you select, you can set rules to help your users see only records
  ...
  have. Your users can still open and report on all records that they have access to per your org’s
  sharing settings.
...
-   **[Scoping Rules](atlas.en-us.scoping_rules.meta/scoping_rules/scoping_rules_about.htm)**
...
-   **[Quick Start: Display Records by Branch Location](atlas.en-us.scoping_rules.meta/scoping_rules/scoping_rules_quickstart.htm)**
...
-   **[Example Scenarios](atlas.en-us.scoping_rules.meta/scoping_rules/scoping_rules_examples.htm)**
    These sample scoping rules provide relevant records to users.
-   **[Tooling API Reference](atlas.en-us.scoping_rules.meta/scoping_rules/scoping_rules_reference_tooling.htm)**
    This section provides more information on the RestrictionRule Tooling API object used to create scoping rules.
-   **[Metadata API Reference](atlas.en-us.scoping_rules.meta/scoping_rules/scoping_rules_reference_metadata.htm)**
