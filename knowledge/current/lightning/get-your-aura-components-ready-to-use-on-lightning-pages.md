---
title: "Get Your Aura Components Ready to Use on Lightning Pages"
domain: lightning
topic: get-your-aura-components-ready-to-use-on-lightning-pages
apiVersion: 67.0
...
-   **[Create Components for the Outlook and Gmail Integrations](atlas.en-us.lightning.meta/lightning/components_config_for_app_builder_email_app_pane.htm)**
...
-   **[Create Components for Forecast Pages](atlas.en-us.lightning.meta/lightning/components_config_for_app_builder_forecasts_page.htm)**
...
-   **[Create a Custom Lightning Page Template Component](atlas.en-us.lightning.meta/lightning/components_config_for_app_builder_template_component.htm)**
