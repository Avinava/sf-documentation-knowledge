---
title: "System Tag Reference"
domain: lightning
topic: system-tag-reference
apiVersion: 67.0
...
-   **[aura:event](atlas.en-us.lightning.meta/lightning/ref_aura_event.htm)**
    An event is represented by the aura:event tag, which has the following attributes.
-   **[aura:interface](atlas.en-us.lightning.meta/lightning/ref_aura_interface.htm)**
