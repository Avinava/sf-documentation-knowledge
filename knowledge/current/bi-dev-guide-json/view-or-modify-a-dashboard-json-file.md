---
title: "View or Modify a Dashboard JSON File"
domain: bi-dev-guide-json
topic: view-or-modify-a-dashboard-json-file
apiVersion: 67.0
...
| --- |
| To modify the JSON file that defines a dashboard: | Create and Edit CRM Analytics Dashboards |
