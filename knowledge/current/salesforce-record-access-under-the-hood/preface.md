...
> If you’re a Salesforce architect, you
   ...
   security model, then build a data access model that reflects it in your Salesforce organization. You have a rich set
   of Salesforce tools at your disposal for
   m
