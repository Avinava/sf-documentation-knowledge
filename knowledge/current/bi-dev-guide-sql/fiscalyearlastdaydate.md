---
title: "fiscal_year_last_day(date)"
domain: bi-dev-guide-sql
topic: fiscalyearlastdaydate
apiVersion: 67.0
...
```
SELECT OrderDate as "date", fiscal_year_last_day(OrderDate) as "fiscal_year_last_day" FROM "dates_sample_data";
```
