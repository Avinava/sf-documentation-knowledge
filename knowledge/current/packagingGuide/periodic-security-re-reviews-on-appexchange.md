---
title: "Periodic Security Re-Reviews on AppExchange"
domain: packagingGuide
topic: periodic-security-re-reviews-on-appexchange
apiVersion: 67.0
...
> To help safeguard against the latest vulnerabilities, we conduct periodic security
        ...
        security review, and they include automated and manual testing. You can voluntarily request
        a re-review of your solution, or in certain instances we notify you that your solution
        requires a re-review. In both cases, security review fees apply.
...
![A sample solution with two versions and callouts in the Listing Readiness and Security Review columns](/docs/resources/img/en-us/260.0?doc_id=appexchange%2Fsecurity_review%2Fimages%2Fsecurity_review_values.png&folder=packagingGuide)
...
![The details tab of an AppExchange listing with a callout around the last reviewed version and date of the solution associated with the listing](/docs/resources/img/en-us/260.0?doc_id=appexchange%2Fsecurity_review%2Fimages%2Fappexchange_listing_reviewed_details.png&folder=packagingGuide)
...
-   **[Submit Your AppExchange Solution for Periodic Security Re-Review](atlas.en-us.packagingGuide.meta/packagingGuide/security_review_request_periodic_review.htm)**
