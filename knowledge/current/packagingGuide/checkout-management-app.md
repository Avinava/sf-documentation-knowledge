---
title: "Checkout Management App"
domain: packagingGuide
topic: checkout-management-app
apiVersion: 67.0
...
The CMA is available in English and Japanese to eligible Salesforce partners. For more information on the Partner Program, including eligibility requirements, visit [https://partners.salesforce.com](https://partners.salesforce.com/ "HTML (New Window)").

Start with the dashboard to get a big picture view of your AppExchange Checkout data.

![A view of the dashboard in the Checkout Management App](/docs/resources/img/en-us/260.0?doc_id=appexchange%2Fcma%2Fimages%2Fcma_dashboard_overview.png&folder=packagingGuide)
...
![A view of the notification page in the Checkout Management App](/docs/resources/img/en-us/260.0?doc_id=appexchange%2Fcma%2Fimages%2Fcma_notification_overview.png&folder=packagingGuide)

-   **[Checkout Management App Best Practices](atlas.en-us.packagingGuide.meta/packagingGuide/cma_best_practices.htm)**
    Follow these guidelines and best practices when you use the Checkout Management App (CMA).
-   **[Checkout Management App Objects](atlas.en-us.packagingGuide.meta/packagingGuide/cma_key_objects.htm)**
...
-   **[Get Started with the Checkout Management App](atlas.en-us.packagingGuide.meta/packagingGuide/cma_setup.htm)**
...
-   **[Update Settings in the Checkout Management App](atlas.en-us.packagingGuide.meta/packagingGuide/cma_update_settings.htm)**
...
-   **[View Checkout Management App Logs](atlas.en-us.packagingGuide.meta/packagingGuide/cma_view_logs.htm)**
