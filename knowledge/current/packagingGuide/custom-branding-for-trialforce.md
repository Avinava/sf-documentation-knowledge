---
title: "Custom Branding for Trialforce"
domain: packagingGuide
topic: custom-branding-for-trialforce
apiVersion: 67.0
...
> If you use Trialforce, you can optionally set up a branded login site and emails. By
  ...
  brand from signup to log in. Apply custom branding only for non-CRM solutions. Don’t apply it to
  solutions that extend Salesforce CRM and require standard objects, such as Leads, Opportunities,
  and Cases.
...
-   **[Create Branded Emails](atlas.en-us.packagingGuide.meta/packagingGuide/trialforce_creating_branded_emails.htm)**
    You can customize the branding of the emails sent to subscribers of new trial organizations.
-   **[Create a Branded Login Page](atlas.en-us.packagingGuide.meta/packagingGuide/trialforce_creating_branded_login.htm)**
