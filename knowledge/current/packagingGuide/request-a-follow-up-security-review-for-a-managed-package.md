---
title: "Request a Follow-Up Security Review for a Managed Package"
domain: packagingGuide
topic: request-a-follow-up-security-review-for-a-managed-package
apiVersion: 67.0
...
> Request a follow-up review for your managed package in the AppExchange Partner Console
        ...
        or when you fixed some vulnerabilities and determined others are false positives.
        To request a follow-up review, start a new review from the Solutions page 
        in the AppExchange security review wizard. 
        Submit your remediated solution and false-positives documentation. 
...
| --- |
| To manage security reviews in the AppExchange Partner Console: | Manage Listings |
