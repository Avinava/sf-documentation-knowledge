---
title: "Manage Orders in the Channel Order App"
domain: packagingGuide
topic: manage-orders-in-the-channel-order-app
apiVersion: 67.0
...
-   **[Submit an Order](atlas.en-us.packagingGuide.meta/packagingGuide/coa_submit_order.htm)**
...
-   **[Edit an Order](atlas.en-us.packagingGuide.meta/packagingGuide/coa_edit_order.htm)**
...
-   **[Clone an Order](atlas.en-us.packagingGuide.meta/packagingGuide/coa_clone_order.htm)**
    When creating an order that’s similar to one you’ve submitted previously, you can save time by cloning the original order.
-   **[Recall an Order](atlas.en-us.packagingGuide.meta/packagingGuide/coa_recall_order.htm)**
...
-   **[Delete a Draft Order](atlas.en-us.packagingGuide.meta/packagingGuide/coa_delete_order.htm)**
...
-   **[Fix Errors on Returned Orders](atlas.en-us.packagingGuide.meta/packagingGuide/coa_fix_issues.htm)**
