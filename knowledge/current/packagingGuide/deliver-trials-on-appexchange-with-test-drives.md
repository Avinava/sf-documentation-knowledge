---
title: "Deliver Trials on AppExchange with Test Drives"
domain: packagingGuide
topic: deliver-trials-on-appexchange-with-test-drives
apiVersion: 67.0
...
> Use test drives to deliver free trials of your AppExchange solution in read-only
        ...
        preconfigured Trialforce template. Then install your solution in the test org, configure it,
        and connect it to the AppExchange Partner Console. If a test drive org expires soon, log a
...
-   **[Create a Test Drive Org with Environment Hub](atlas.en-us.packagingGuide.meta/packagingGuide/free_trial_configure_test_drive.htm)**
...
-   **[Prepare Your Test Drive Org](atlas.en-us.packagingGuide.meta/packagingGuide/free_trial_prepare_test_drive.htm)**
    Prepare your test drive org by installing your solution and configuring the evaluation user.
-   **[Provide Test Drives on Your AppExchange Listing](atlas.en-us.packagingGuide.meta/packagingGuide/free_trial_connect_test_drive.htm)**
...
-   **[Request an Extension for a Test Drive Org](atlas.en-us.packagingGuide.meta/packagingGuide/free_trial_extend_test_drive.htm)**
