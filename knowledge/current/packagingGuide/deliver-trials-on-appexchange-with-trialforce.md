---
title: "Deliver Trials on AppExchange with Trialforce"
domain: packagingGuide
topic: deliver-trials-on-appexchange-with-trialforce
apiVersion: 67.0
...
> Use Trialforce to deliver free trials of your AppExchange solution in Salesforce orgs
        ...
        best practices. Then set up Trialforce, create a Trialforce template for your solution, and
...
-   **[Trialforce Key Concepts and Relationships](atlas.en-us.packagingGuide.meta/packagingGuide/trialforce_conceptual_overview.htm)**
...
-   **[Trialforce Best Practices](atlas.en-us.packagingGuide.meta/packagingGuide/trialforce_best_practices.htm)**
    Apply these best practices to create trial experiences that engage prospects and increase conversion.
-   **[Request a Trialforce Management Org](atlas.en-us.packagingGuide.meta/packagingGuide/trialforce_get_tmo.htm)**
    A Trialforce Management Org (TMO) is the starting point for creating trials with Trialforce. To request your TMO, log a case.
-   **[Custom Branding for Trialforce](atlas.en-us.packagingGuide.meta/packagingGuide/trialforce_branding_about.htm)**
...
-   **[Update Your Trialforce Template](atlas.en-us.packagingGuide.meta/packagingGuide/free_trial_modify_upgrade.htm)**
