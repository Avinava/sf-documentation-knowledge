---
title: "Connect the Channel Order App to Salesforce"
domain: packagingGuide
topic: connect-the-channel-order-app-to-salesforce
apiVersion: 67.0
...
-   [← Previous](atlas.en-us.packagingGuide.meta/packagingGuide/coa_request_credentials.htm "Request Service Order Credentials for the Channel Order App")
-   [Next →](atlas.en-us.packagingGuide.meta/packagingGuide/coa_show_customers_tab.htm "Display Customers in the Channel Order App")

## Related Topics

- ← Previous (atlas.en-us.packagingGuide.meta/packagingGuide/coa_request_credentials.htm)
- Next → (atlas.en-us.packagingGuide.meta/packagingGuide/coa_show_customers_tab.htm)
