---
title: "Activity Sources in AppExchange Marketplace Analytics"
domain: packagingGuide
topic: activity-sources-in-appexchange-marketplace-analytics
apiVersion: 67.0
...
> See how internal and external traffic sources contribute to activity on your AppExchange
    ...
    in an AppExchange search versus a Google search.
...
![The Activity Sources visualization with highlights around the local filter menu and the datapoint tooltip.](/docs/resources/img/en-us/260.0?doc_id=appexchange%2Fdashboard%2Fimages%2Factivity_sources.png&folder=packagingGuide)
