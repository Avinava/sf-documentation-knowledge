---
title: "Update Settings in the Checkout Management App"
domain: packagingGuide
topic: update-settings-in-the-checkout-management-app
apiVersion: 67.0
...
> Control when customers and team members receive emails from the Checkout Management App
    ...
    data into your Salesforce org. Only admin
    users can update settings in the CMA.
...
-   **[Change Notification Settings in the Checkout Management App](atlas.en-us.packagingGuide.meta/packagingGuide/cma_edit_notification_settings.htm)**
...
-   **[Change the Stripe Account Associated with the Checkout Management App](atlas.en-us.packagingGuide.meta/packagingGuide/cma_change_stripe_account.htm)**
...
-   **[Reimport Stripe Data into the Checkout Management App](atlas.en-us.packagingGuide.meta/packagingGuide/cma_reimport_data.htm)**
