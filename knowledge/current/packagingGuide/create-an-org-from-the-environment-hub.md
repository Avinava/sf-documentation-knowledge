---
title: "Create an Org from the Environment Hub"
domain: packagingGuide
topic: create-an-org-from-the-environment-hub
apiVersion: 67.0
...
> You can create orgs from the Environment Hub for development, testing, and trial
  ...
  limits, more storage, and other customizations to support app development. When you create an org
  from the Environment Hub, it becomes a hub member with a default language set by the user’s
  locale.
...
You can create up to 20 member orgs per day. To create more orgs, log a support case in the [Salesforce Partner Community](https://partners.salesforce.com "HTML (New Window)").
