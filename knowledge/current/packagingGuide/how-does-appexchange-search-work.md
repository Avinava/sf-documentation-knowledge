---
title: "How Does AppExchange Search Work?"
domain: packagingGuide
topic: how-does-appexchange-search-work
apiVersion: 67.0
...
> Search is one of the most popular ways that Salesforce customers find
   ...
   and trust score
   influence
   the search results that customers see. Then apply tips to help customers discover your listing
...
![An illustration of a search bar and the three factors that influence search results, which are keyword relevance, semantic meaning, and trust score.](/docs/resources/img/en-us/260.0?doc_id=appexchange%2Fimages%2Fappexchange_search_factors.png&folder=packagingGuide)
