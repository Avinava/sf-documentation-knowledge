---
title: "Types of Security Review Office Hours"
domain: packagingGuide
topic: types-of-security-review-office-hours
apiVersion: 67.0
...
> Salesforce security review teams host two types of office hours for AppExchange
  ...
  review team members. To get answers about the submission process, attend operations office hours
  with Security Review Operations team members. To get help with troubleshooting security
  vulnerabilities, attend technical office hours with members of the Product Security
  team.
...
-   [Schedule a Security Review Office Hours Appointment](atlas.en-us.packagingGuide.meta/packagingGuide/security_review_schedule_office_hours.htm "Access expert guidance from AppExchange security review team members through scheduled web conferences. Get answers about security review logistics and submission requirements from Security Review Operations. Troubleshoot security-related technical issues with Product Security engineers. Visit the Partner Security Portal to schedule an appointment.")

## Related Topics

- Schedule a Security Review Office Hours Appointment (atlas.en-us.packagingGuide.meta/packagingGuide/security_review_schedule_office_hours.htm)
