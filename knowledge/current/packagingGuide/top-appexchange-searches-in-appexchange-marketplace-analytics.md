---
title: "Top AppExchange Searches in AppExchange Marketplace Analytics"
domain: packagingGuide
topic: top-appexchange-searches-in-appexchange-marketplace-analytics
apiVersion: 67.0
...
![The Top AppExchange Searches visualization with a search term and a bar chart segment.](/docs/resources/img/en-us/260.0?doc_id=appexchange%2Fdashboard%2Fimages%2Ftop_searches.png&folder=packagingGuide)

![Note](/docs/resources/img/en-us/260.0?doc_id=images%2Ficon_note.png&folder=packagingGuide)

#### Note

Only searches performed with the search bar on the AppExchange website are included. Search terms from external search engines aren’t available.
