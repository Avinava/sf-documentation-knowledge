---
title: "Assign Channel Order App Permission Sets and Accept the Email Service"
domain: packagingGuide
topic: assign-channel-order-app-permission-sets-and-accept-the-email-service
apiVersion: 67.0
...
> Assign a permission set to give team members access to the Channel Order App (COA).
        ...
        tasks using the COA’s guided onboarding experience.
...
-   [← Previous](atlas.en-us.packagingGuide.meta/packagingGuide/coa_grant_access.htm "Launch Channel Order App Guided Onboarding")
-   [Next →](atlas.en-us.packagingGuide.meta/packagingGuide/coa_request_credentials.htm "Request Service Order Credentials for the Channel Order App")

## Related Topics

- ← Previous (atlas.en-us.packagingGuide.meta/packagingGuide/coa_grant_access.htm)
- Next → (atlas.en-us.packagingGuide.meta/packagingGuide/coa_request_credentials.htm)
