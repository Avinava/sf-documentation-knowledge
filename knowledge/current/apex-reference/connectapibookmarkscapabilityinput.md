---
title: "ConnectApi.BookmarksCapabilityInput"
domain: apex-reference
topic: connectapibookmarkscapabilityinput
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-05-10T00:39:31.722Z
estimatedTokens: 200
keywords: [ConnectApi.BookmarksCapabilityInput, bookmark]
---
...
| --- | --- | --- | --- | --- |
| isBookmarked​ByCurrentUser | Boolean | Specifies if the feed element should be bookmarked for the user (true) or not (false). | No | 32.0 |
