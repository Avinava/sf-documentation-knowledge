...
topic: settestgetfeedelementsfromfeedcommunityid-feedtype-recentcommentcount-density-pa
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.229Z
keywords: [setTestGetFeedElementsFromFeed, communityId, feedType, recentCommentCount, density, pageParam, pageSize, sortParam, filter, threadedCommentsCollapsed, result, Register, ConnectApi.FeedElementPage, object, returned, matching, ConnectApi.getFeedElementsFromFeed, method, called, test]
---
...
> Register a ConnectApi.FeedElementPage object to be returned when the matching ConnectApi.getFeedElementsFromFeed method is called
            in a test context. Use the method with the same parameters or you receive
                an exception.
