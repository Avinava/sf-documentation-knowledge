---
title: "ConnectApi.ManagedContentSpaceChannelRepresentation"
domain: apex-reference
topic: connectapimanagedcontentspacechannelrepresentation
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-03-12T09:33:27.900Z
estimatedTokens: 270
...
| --- | --- | --- | --- |
| channelSummary | ConnectApi.​ManagedContent​ChannelSummary | Information about the managed content space channel. | 62.0 |
| createdBy | ConnectApi.​ManagedContent​UserSummary | Information about the user who created the managed content space channel. | 62.0 |
| createdDate | Datetime | Date when the managed content space channel was created. | 62.0 |
| status | ConnectApi.​ManagedContent​SpaceChannel​Status | Status of the add or remove operation for a channel and managed content space.Added—Channel was added to the managed content space.Failed—Add or remove operation failed.Pending—Add or remove operation is pending.Removed—Channel was removed from the managed content space. | 62.0 |
