...
topic: setisreadbymecommunityid-feedelementid-readby
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.227Z
keywords: [setIsReadByMe, communityId, feedElementId, readBy, Mark, feed, element, read, context, user, input, class., API, Version, Requires, Chatter, Signature, Parameters, Return, Value]
---
...
> Mark a feed element as read for
      the context user using an input class.
