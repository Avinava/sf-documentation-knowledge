---
title: "ConnectApi.OrderItemSummary"
domain: apex-reference
topic: connectapiorderitemsummary
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-04-07T09:02:25.254Z
estimatedTokens: 212
...
| fields | Map<String, ConnectApi.​RecordField> | Map of fields from order item summary and other related objects that were queried. | 51.0 |
| orderItem​SummaryId | String | ID of the order item summary. | 51.0 |
| orderSummaryId | String | ID of the order summary. | 51.0 |
| product | ConnectApi.​OrderItemSummary​Product | Associated product item information. | 51.0 |
