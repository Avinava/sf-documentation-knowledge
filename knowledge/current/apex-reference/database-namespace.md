...
lastCollected: 2026-03-12T05:14:31.545Z
estimatedTokens: 1524
namespace: Database
keywords: [Database, provides, classes, used, DML, operations.]
---
...
- BatchableContext Interface (atlas.en-us.apexref.meta/apexref/apex_interface_database_batchablecontext.htm)
- Cursor Class (atlas.en-us.apexref.meta/apexref/apex_class_Database_Cursor.htm)
- CursorFetchResult Class (atlas.en-us.apexref.meta/apexref/apex_class_Database_CursorFetchResult.htm)
- DeletedRecord Class (atlas.en-us.apexref.meta/apexref/apex_class_database_deletedrecord.htm)
- DeleteResult Class (atlas.en-us.apexref.meta/apexref/apex_methods_system_database_deleteresult.htm)
- DMLOptions Class (atlas.en-us.apexref.meta/apexref/apex_methods_system_database_dmloptions.htm)
- DmlOptions.AssignmentRuleHeader Class (atlas.en-us.apexref.meta/apexref/apex_class_Database_AssignmentRuleHeader.htm)
- DMLOptions.DuplicateRuleHeader Class (atlas.en-us.apexref.meta/apexref/apex_class_Database_DMLOptions_DuplicateRuleHeader.htm)
- DmlOptions.EmailHeader Class (atlas.en-us.apexref.meta/apexref/apex_class_Database_EmailHeader.htm)
