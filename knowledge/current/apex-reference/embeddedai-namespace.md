...
lastCollected: 2026-03-12T09:33:31.729Z
estimatedTokens: 189
namespace: The
...
-   **[ApexMap Class](atlas.en-us.apexref.meta/apexref/apex_class_embeddedai_ApexMap.htm#apex_class_embeddedai_ApexMap)**
    Create, clone, and convert string based key-value pairs to a JSON string format.
-   **[RecordApexRepresentation Class](atlas.en-us.apexref.meta/apexref/apex_class_embeddedai_RecordApexRepresentation.htm#apex_class_embeddedai_RecordApexRepresentation)**
...
- ApexMap Class (atlas.en-us.apexref.meta/apexref/apex_class_embeddedai_ApexMap.htm)
- RecordApexRepresentation Class (atlas.en-us.apexref.meta/apexref/apex_class_embeddedai_RecordApexRepresentation.htm)
