---
title: "PaymentMethodTokenizationRequest Methods"
domain: apex-reference
topic: paymentmethodtokenizationrequest-methods
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:35.058Z
keywords: [PaymentMethodTokenizationRequest, Methods, Maintains, integrity, lists, type, determining, equality, external, objects, list., method, dynamic, based, equals, Java., obj, Signature, Parameters, Return]
---

# PaymentMethodTokenizationRequest Methods

> Maintains the integrity of lists of type PaymentMethodTokenizationRequest by determining the equality
      of external objects in a list. This method is dynamic and is based on the equals method in
      Java.
