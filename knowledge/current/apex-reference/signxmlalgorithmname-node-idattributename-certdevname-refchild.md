...
topic: signxmlalgorithmname-node-idattributename-certdevname-refchild
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:36.436Z
keywords: [signXML, algorithmName, node, idAttributeName, certDevName, refChild, Inserts, signature, envelope, before, specified, child, node., Signature, Parameters, Return, Value, Example]
---

# signXML(algorithmName, node, idAttributeName, certDevName,
      refChild)

> Inserts the signature envelope before the specified child
    node.
