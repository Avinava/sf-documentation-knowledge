...
lastCollected: 2026-03-12T05:14:20.111Z
estimatedTokens: 1231
namespace: Database
keywords: [DmlOptions.EmailHeader, Enables, setting, email, options., Usage, Example, triggerAutoResponseEmail, triggerOtherEmail, Note, triggerUserEmail]
---
...
- triggerAutoResponseEmail (atlas.en-us.apexref.meta/apexref/apex_class_Database_EmailHeader.htm)
- triggerOtherEmail (atlas.en-us.apexref.meta/apexref/apex_class_Database_EmailHeader.htm)
- triggerUserEmail (atlas.en-us.apexref.meta/apexref/apex_class_Database_EmailHeader.htm)
