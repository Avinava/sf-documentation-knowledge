---
title: "searchFeedElementsInFeed(communityId, feedType, pageParam,
         pageSize, sortParam, q)"
domain: apex-reference
topic: searchfeedelementsinfeedcommunityid-feedtype-pageparam-pagesize-sortparam-q
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.227Z
keywords: [searchFeedElementsInFeed, communityId, feedType, pageParam, pageSize, sortParam, Get, page, sorted, feed, elements, Company, DirectMessageModeration, Home, Isolated, Moderation, PendingReview, feeds, match, search]
---

# searchFeedElementsInFeed(communityId, feedType, pageParam,
         pageSize, sortParam, q)

> Get a page of sorted feed elements from the Company, DirectMessageModeration, Home, Isolated, Moderation, and PendingReview feeds
...
-   [setTestSearchFeedElementsInFeed(communityId, feedType, pageParam, pageSize, sortParam, q, result)](atlas.en-us.apexref.meta/apexref/apex_ConnectAPI_ChatterFeeds_static_methods.htm#apex_ConnectAPI_ChatterFeeds_setTestSearchFeedElementsInFeed_3 "Register a ConnectApi.FeedElementPage object to be returned when the matching ConnectApi.searchFeedElementsInFeed method is called in a test context. Use the method with the same parameters or you receive an exception.")
