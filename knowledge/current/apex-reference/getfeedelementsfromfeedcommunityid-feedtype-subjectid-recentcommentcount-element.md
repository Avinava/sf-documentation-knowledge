...
title: "getFeedElementsFromFeed(communityId, feedType, subjectId,
      ...
      showInternalOnly, customFilter, threadedCommentsCollapsed)"
domain: apex-reference
topic: getfeedelementsfromfeedcommunityid-feedtype-subjectid-recentcommentcount-element
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.224Z
keywords: [getFeedElementsFromFeed, communityId, feedType, subjectId, recentCommentCount, elementsPerBundle, density, pageParam, pageSize, sortParam, showInternalOnly, customFilter, threadedCommentsCollapsed, Get, page, filtered, sorted, feed, elements, comments]
---
...
> Get a page of filtered and sorted feed elements with comments in a
      threaded style from a case feed.
