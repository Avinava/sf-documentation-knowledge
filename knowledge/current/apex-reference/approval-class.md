...
lastCollected: 2026-03-12T05:14:30.206Z
estimatedTokens: 7507
namespace: ProcessRequest
keywords: [Approval, true, record, locked, false, it’s, not., Usage, isLocked, ids, sobject, sobjects, lock, recordId, recordIds, recordToLock, recordsToLock, allOrNothing, process, approvalRequest]
---
...
- isLocked(id) (atlas.en-us.apexref.meta/apexref/apex_methods_system_approval.htm)
- isLocked(ids) (atlas.en-us.apexref.meta/apexref/apex_methods_system_approval.htm)
- isLocked(sobject) (atlas.en-us.apexref.meta/apexref/apex_methods_system_approval.htm)
- isLocked(sobjects) (atlas.en-us.apexref.meta/apexref/apex_methods_system_approval.htm)
- lock(recordId) (atlas.en-us.apexref.meta/apexref/apex_methods_system_approval.htm)
- lock(recordIds) (atlas.en-us.apexref.meta/apexref/apex_methods_system_approval.htm)
- lock(recordToLock) (atlas.en-us.apexref.meta/apexref/apex_methods_system_approval.htm)
- lock(recordsToLock) (atlas.en-us.apexref.meta/apexref/apex_methods_system_approval.htm)
- lock(recordId, allOrNothing) (atlas.en-us.apexref.meta/apexref/apex_methods_system_approval.htm)
