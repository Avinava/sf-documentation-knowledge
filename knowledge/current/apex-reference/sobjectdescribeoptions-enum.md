...
lastCollected: 2026-05-10T00:39:44.398Z
estimatedTokens: 293
keywords: [SObjectDescribeOptions, Schema.SObjectDescribeOptions, SObjectType.getDescribe]
---
...
For more information about the method using this enum, see [getDescribe(options)](atlas.en-us.apexref.meta/apexref/apex_class_Schema_SObjectType.htm#unique_1768814447 "Returns the describe sObject result for this field; the parameter value determines whether all child relationships are loaded up-front, or not.").
...
See [getDescribe(options)](atlas.en-us.apexref.meta/apexref/apex_class_Schema_SObjectType.htm#unique_1768814447 "Returns the describe sObject result for this field; the parameter value determines whether all child relationships are loaded up-front, or not.").
