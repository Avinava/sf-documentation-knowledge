---
title: "searchFeedElements(communityId, q, sortParam)"
domain: apex-reference
topic: searchfeedelementscommunityid-q-sortparam
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.226Z
keywords: [searchFeedElements, communityId, sortParam, Get, first, page, sorted, feed, elements, match, search, criteria., API, Version, Available, Guest, Users, Requires, Chatter, Signature]
---

# searchFeedElements(communityId, q, sortParam)

> Get the first page of sorted feed elements that match the search
   criteria.
...
-   [setTestSearchFeedElements(communityId, q, sortParam, result)](atlas.en-us.apexref.meta/apexref/apex_ConnectAPI_ChatterFeeds_static_methods.htm#apex_ConnectAPI_ChatterFeeds_setTestSearchFeedElements_2 "Register a ConnectApi.FeedElementPage object to be returned when the matching ConnectApi.searchFeedElements method is called in a test context. Use the method with the same parameters or you receive an exception.")
