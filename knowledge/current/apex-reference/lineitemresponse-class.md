...
lastCollected: 2026-03-12T05:14:22.273Z
estimatedTokens: 2991
namespace: CommerceTax
keywords: [LineItemResponse, Response, stores, details, list, line, items, which, tax, engine, calculated, tax., Example, setAddresses, addresses, setAmountDetails, amountDetails, setCustomTaxAttributes, customTaxAttributes, setEffectiveDate]
---
...
- LineItemResponse Methods (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_LineItemResponse.htm)
- setAddresses(addresses) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_LineItemResponse.htm)
- setAmountDetails(amountDetails) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_LineItemResponse.htm)
- setCustomTaxAttributes(customTaxAttributes) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_LineItemResponse.htm)
- setEffectiveDate(effectiveDate) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_LineItemResponse.htm)
- setIsTaxable(isTaxable) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_LineItemResponse.htm)
- setLineNumber(lineNumber) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_LineItemResponse.htm)
- setProductCode(productCode) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_LineItemResponse.htm)
- setQuantity(quantity) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_LineItemResponse.htm)
