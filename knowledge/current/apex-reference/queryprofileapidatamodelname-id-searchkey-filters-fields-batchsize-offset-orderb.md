---
title: "queryProfileApi(dataModelName, id, searchKey, filters,
      fields, batchSize, offset, orderby)"
domain: apex-reference
topic: queryprofileapidatamodelname-id-searchkey-filters-fields-batchsize-offset-orderb
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:30.166Z
keywords: [queryProfileApi, dataModelName, searchKey, filters, fields, batchSize, offset, orderby, Query, Profile, data, model, object, search, key., API, Version, Requires, Chatter, Signature]
---

# queryProfileApi(dataModelName, id, searchKey, filters,
      fields, batchSize, offset, orderby)
