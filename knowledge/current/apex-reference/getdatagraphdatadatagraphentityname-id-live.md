...
topic: getdatagraphdatadatagraphentityname-id-live
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:30.166Z
keywords: [getDataGraphData, dataGraphEntityName, live, Query, data, graph, performing, lookup, default, space., real-time, graphs, method, attempts, retrieve, falls, back, standard, unavailable., API]
---

# getDataGraphData(dataGraphEntityName, id,
    live)

> Query a data graph by performing a live lookup in the default data space.
