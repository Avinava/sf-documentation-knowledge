---
title: "getRecommendationsForUser(communityId, userId, contextAction,
      contextObjectId, maxResults)"
domain: apex-reference
topic: getrecommendationsforusercommunityid-userid-contextaction-contextobjectid-maxres
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:32.702Z
keywords: [getRecommendationsForUser, communityId, userId, contextAction, contextObjectId, maxResults, Get, Chatter, recommendations, such, user, group, file, record, context, user., custom, static, API, Version]
---

# getRecommendationsForUser(communityId, userId, contextAction,
      contextObjectId, maxResults)

> Get the Chatter recommendations, such as user, group, file, and record
      recommendations for the context user. Get the custom and static recommendations for the
      context user.
