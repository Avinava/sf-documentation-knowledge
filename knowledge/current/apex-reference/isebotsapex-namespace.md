---
title: "ise_bots_apex Namespace"
domain: apex-reference
topic: isebotsapex-namespace
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-05-10T00:39:48.719Z
estimatedTokens: 199
namespace: The
...
> The ise_bots_apex namespace provides classes and properties to facilitate dynamic content
    ...
    items that adapt to user inputs, context, and underlying object data.

**Namespace:** `The`

# ise\_bots\_apex Namespace
...
The ise\_bots\_apex namespace includes these classes.

-   **[DynamicMenuItem Class](atlas.en-us.apexref.meta/apexref/apex_class_ise_bots_apex_DynamicMenuItem.htm#apex_class_ise_bots_apex_DynamicMenuItem)**
...
- DynamicMenuItem Class (atlas.en-us.apexref.meta/apexref/apex_class_ise_bots_apex_DynamicMenuItem.htm)
