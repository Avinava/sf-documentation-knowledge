...
docType: concept
lastCollected: 2026-03-12T05:14:22.663Z
estimatedTokens: 2758
namespace: LxScheduler
keywords: [SchedulerResources, Contains, holds, business, logic, get, resources, availability., Implementation, Considerations, Example, getAppointmentCandidates, getAppointmentCandidatesInput, Note, getAppointmentSlots, getAppointmentSlotsInput, setAppointmentCandidatesMock, expectedResponse, setAppointmentSlotsMock]
---
...
- SchedulerResources Methods (atlas.en-us.apexref.meta/apexref/apex_class_lxscheduler_SchedulerResources.htm)
- getAppointmentCandidates(getAppointmentCandidatesInput) (atlas.en-us.apexref.meta/apexref/apex_class_lxscheduler_SchedulerResources.htm)
- getAppointmentSlots(getAppointmentSlotsInput) (atlas.en-us.apexref.meta/apexref/apex_class_lxscheduler_SchedulerResources.htm)
- setAppointmentCandidatesMock(expectedResponse) (atlas.en-us.apexref.meta/apexref/apex_class_lxscheduler_SchedulerResources.htm)
- setAppointmentSlotsMock(expectedResponse) (atlas.en-us.apexref.meta/apexref/apex_class_lxscheduler_SchedulerResources.htm)
- lxscheduler.GetAppointmentCandidatesInput (atlas.en-us.apexref.meta/apexref/apex_class_lxscheduler_GetAppointmentCandidatesInput.htm)
- String (atlas.en-us.apexref.meta/apexref/apex_methods_system_string.htm)
- lxscheduler.GetAppointmentSlotsInput (atlas.en-us.apexref.meta/apexref/apex_class_lxscheduler_GetAppointmentSlotsInput.htm)
