...
topic: settestgetfeeditemsfromfeedcommunityid-feedtype-recentcommentcount-density-pagep
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.232Z
keywords: [setTestGetFeedItemsFromFeed, communityId, feedType, recentCommentCount, density, pageParam, pageSize, sortParam, result, Register, ConnectApi.FeedItemPage, object, returned, getFeedItems​FromFeed, called, matching, parameters, test, context., get]
---
...
-   [getFeedItemsFromFeed(communityId, feedType, recentCommentCount, density, pageParam, pageSize, sortParam)](atlas.en-us.apexref.meta/apexref/apex_ConnectAPI_ChatterFeeds_static_methods.htm#apex_ConnectAPI_ChatterFeeds_getFeedItemsFromFeed_3 "Get a page of sorted feed items from the Company, Home, and Moderation feeds. Each feed item contains no more than the specified number of comments.")
