---
title: "createShiftsFromPattern(shiftsFromPatternInput,
      shiftPatternId)"
domain: apex-reference
topic: createshiftsfrompatternshiftsfrompatterninput-shiftpatternid
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:32.119Z
keywords: [createShiftsFromPattern, shiftsFromPatternInput, shiftPatternId, Create, 000, shifts, pattern., API, Version, Requires, Chatter, Signature, Parameters, Return, Value]
---

# createShiftsFromPattern(shiftsFromPatternInput,
      shiftPatternId)
