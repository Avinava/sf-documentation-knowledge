...
lastCollected: 2026-03-12T05:14:22.216Z
estimatedTokens: 3462
namespace: CommerceTax
keywords: [CalculateTaxResponse, values, tax, transaction, following, response, external, engine., Extends, AbstractTransactionResponse, top-level, class., Example, setAddresses, addresses, setAmountDetails, amountDetails, setCurrencyIsoCode, currencyIsoCode, setDescription]
---
...
- AbstractTransactionResponse (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_AbstractTransactionResponse.htm)
- CommerceTax (atlas.en-us.apexref.meta/apexref/apex_namespace_commercetax.htm)
- CalculateTaxResponse Methods (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_CalculateTaxResponse.htm)
- setAddresses(addresses) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_CalculateTaxResponse.htm)
- setAmountDetails(amountDetails) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_CalculateTaxResponse.htm)
- setCurrencyIsoCode(currencyIsoCode) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_CalculateTaxResponse.htm)
- setDescription(dscptn) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_CalculateTaxResponse.htm)
- setDocumentCode(documentCode) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_CalculateTaxResponse.htm)
- setEffectiveDate(effectiveDate) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_CalculateTaxResponse.htm)
- setLineItems(lineItems) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_CalculateTaxResponse.htm)
