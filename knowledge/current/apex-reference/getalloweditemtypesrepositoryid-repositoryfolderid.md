---
title: "getAllowedItemTypes(repositoryId,
    repositoryFolderId)"
domain: apex-reference
topic: getalloweditemtypesrepositoryid-repositoryfolderid
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:32.055Z
keywords: [getAllowedItemTypes, repositoryId, repositoryFolderId, Get, item, types, context, user, allowed, create, repository, folder., API, Version, Requires, Chatter, Signature, Parameters, Return, Value]
---

# getAllowedItemTypes(repositoryId,
    repositoryFolderId)

> Get the item types that the context user is allowed to create in the repository
    folder.
