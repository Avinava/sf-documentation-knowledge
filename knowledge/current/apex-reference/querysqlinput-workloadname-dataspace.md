---
title: "querySql(input, workloadName, dataspace)"
domain: apex-reference
topic: querysqlinput-workloadname-dataspace
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:30.166Z
keywords: [querySql, input, workloadName, dataspace, Submit, SQL, query, request, execution, specify, workload, name, data, space., API, Version, Requires, Chatter, Signature, Parameters]
---

# querySql(input, workloadName, dataspace)

> Submit an SQL query request for execution and specify the workload name and data
    space.
