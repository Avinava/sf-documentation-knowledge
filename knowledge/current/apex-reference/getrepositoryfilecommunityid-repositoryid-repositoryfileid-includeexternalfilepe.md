---
title: "getRepositoryFile(communityId, repositoryId, repositoryFileId,
      includeExternalFilePermissionsInfo)"
domain: apex-reference
topic: getrepositoryfilecommunityid-repositoryid-repositoryfileid-includeexternalfilepe
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:32.056Z
keywords: [getRepositoryFile, communityId, repositoryId, repositoryFileId, includeExternalFilePermissionsInfo, Get, repository, file, without, permissions, information, Experience, Cloud, site., API, Version, Requires, Chatter, Signature, Parameters]
---

# getRepositoryFile(communityId, repositoryId, repositoryFileId,
      includeExternalFilePermissionsInfo)

> Get a repository file with or without permissions information in an Experience Cloud
    site.
