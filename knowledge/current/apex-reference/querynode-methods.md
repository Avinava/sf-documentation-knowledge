---
title: "QueryNode Methods"
domain: apex-reference
topic: querynode-methods
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:36.146Z
keywords: [QueryNode, Methods, Build, query, string, represented, assign, stream, name., build, streamName, Signature, Parameters, Return, Value, foreach, projections, group, groups, Example]
---

# QueryNode Methods

> Build the query string represented by this QueryNode and assign it
      to a stream name.
