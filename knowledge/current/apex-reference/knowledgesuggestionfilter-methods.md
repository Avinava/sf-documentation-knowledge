---
title: "KnowledgeSuggestionFilter Methods"
domain: apex-reference
topic: knowledgesuggestionfilter-methods
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:34.267Z
keywords: [KnowledgeSuggestionFilter, Methods, Adds, filter, narrows, suggestion, results, display, specified, article, type., optional., addArticleType, articleType, Signature, Parameters, Return, Value, Usage, addDataCategory]
---

# KnowledgeSuggestionFilter Methods

> Adds a filter that narrows suggestion results to display the specified
      article type. This filter is optional.
