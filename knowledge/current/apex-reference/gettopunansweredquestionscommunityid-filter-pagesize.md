...
topic: gettopunansweredquestionscommunityid-filter-pagesize
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.226Z
keywords: [getTopUnansweredQuestions, communityId, filter, pageSize, Get, page, filtered, top, unanswered, questions, context, user, Experience, Cloud, site., Pilot, Note, API, Version, Requires]
---

# getTopUnansweredQuestions(communityId, filter,
      pageSize)

> Get a page of filtered top unanswered questions for the context user
