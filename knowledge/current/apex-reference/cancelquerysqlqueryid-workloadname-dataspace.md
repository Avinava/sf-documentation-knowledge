---
title: "cancelQuerySql(queryId, workloadName,
    dataspace)"
domain: apex-reference
topic: cancelquerysqlqueryid-workloadname-dataspace
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:30.166Z
keywords: [cancelQuerySql, queryId, workloadName, dataspace, Delete, specified, query, terminate, long-running, queries, longer, needed, manage, resource, consumption., Specify, data, space, workload, name.]
---

# cancelQuerySql(queryId, workloadName,
    dataspace)
