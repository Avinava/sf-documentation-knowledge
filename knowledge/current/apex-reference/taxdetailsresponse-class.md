...
lastCollected: 2026-04-05T00:23:44.810Z
...
-   **[TaxDetailsResponse Methods](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_methods)**
...
-   **[setCustomTaxAttributes(customTaxAttributes)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setCustomTaxAttributes)**
...
-   **[setExemptAmount(exemptAmount)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setExemptAmount)**
    Sets the ExemptAmount field of the TaxDetailsResponse class.
-   **[setExemptReason(reason)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setExemptReason)**
    Sets the ExemptReason field of the TaxDetailsResponse class.
-   **[setImposition(imposition)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setImposition)**
    Sets the Imposition field of the TaxDetailsResponse class using an instance of the ImpositionResponse class.
-   **[setJurisdiction(jurisdiction)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setJurisdiction)**
    Sets the Jurisdiction field of the TaxDetailsResponse using an instance of the JurisdictionResponse class.
-   **[setRate(rate)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setRate)**
    Sets the Rate field of the TaxDetailsResponse class.
-   **[setSerCode(serCode)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setSerCode)**
    Sets the Service Code field of the TaxDetailsResponse class.
-   **[setTax(tax)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setTax)**
    Sets the Tax field of the TaxDetailsResponse class.
-   **[setTaxAuthorityTypeId(taxAuthorityTypeId)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setTaxAuthorityTypeId)**
    Sets the TaxAuthorityTypeId field of the TaxDetailsResponse class.
-   **[setTaxId(taxId)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setTaxId)**
    Sets the TaxId field of the TaxDetailsResponse class.
-   **[setTaxRegionId(taxRegionId)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setTaxRegionId)**
    Sets the TaxRegionId field on the TaxDetailsResponse class.
-   **[setTaxRuleDetails(taxRuleDetails)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setTaxRuleDetails)**
    Sets the TaxRuleDetails field of the TaxDetailsResponse class.
-   **[setTaxableAmount(taxableAmount)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm#apex_commercetax_TaxDetailsResponse_setTaxableAmount)**
...
Type: [RuleDetailsResponse](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_RuleDetailsResponse.htm#apex_class_commercetax_RuleDetailsResponse "Contains details about the tax rules used for tax calculation.")
...
- TaxDetailsResponse Methods (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm)
- setCustomTaxAttributes(customTaxAttributes) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm)
- setExemptAmount(exemptAmount) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm)
- setExemptReason(reason) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm)
- setImposition(imposition) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm)
- setJurisdiction(jurisdiction) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm)
- setRate(rate) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm)
- setSerCode(serCode) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm)
- setTax(tax) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_TaxDetailsResponse.htm)
