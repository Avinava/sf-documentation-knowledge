---
title: "DynamicPickListRows Methods"
domain: apex-reference
topic: dynamicpicklistrows-methods
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:34.649Z
keywords: [DynamicPickListRows, Methods, Adds, list, picklist, items, dynamic, rendered, Lightning, component, page., addAllRows, rows, Signature, Parameters, Return, Value, addRow, row, clone]
---

# DynamicPickListRows Methods

> Adds a list of picklist items to a dynamic picklist rendered in a
        Lightning component on a Lightning page.
