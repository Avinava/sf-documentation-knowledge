---
title: "searchFeedItems(communityId, q, pageParam,
    pageSize)"
domain: apex-reference
topic: searchfeeditemscommunityid-q-pageparam-pagesize
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.232Z
keywords: [searchFeedItems, communityId, pageParam, pageSize, Get, page, feed, items, match, search, criteria., API, Version, Important, Available, Guest, Users, Requires, Chatter, Signature]
---

# searchFeedItems(communityId, q, pageParam,
    pageSize)
...
In version 32.0 and later, use [searchFeedElements(communityId, q, pageParam, pageSize)](#apex_ConnectAPI_ChatterFeeds_searchFeedElements_3 "Get a page of feed elements that match the search criteria.").
