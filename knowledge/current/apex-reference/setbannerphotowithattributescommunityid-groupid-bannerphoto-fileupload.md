...
title: "setBannerPhotoWithAttributes(communityId, groupId,
      bannerPhoto, fileUpload)"
domain: apex-reference
topic: setbannerphotowithattributescommunityid-groupid-bannerphoto-fileupload
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.353Z
keywords: [setBannerPhotoWithAttributes, communityId, groupId, bannerPhoto, fileUpload, Set, crop, file, hasn’t, uploaded, group, banner, photo., API, Version, Requires, Chatter, Signature, Parameters, Return]
---

# setBannerPhotoWithAttributes(communityId, groupId,
      bannerPhoto, fileUpload)

> Set and crop a file that hasn’t been uploaded as the group banner
      photo.
