...
lastCollected: 2026-03-12T05:14:31.724Z
estimatedTokens: 374
namespace: The
keywords: [Sfdc_Checkout, provides, classes, B2B, Commerce, apps, Salesforce., Sfdc, _Checkout]
---

# Sfdc_Checkout Namespace

> The Sfdc_Checkout namespace provides an interface and classes for B2B Commerce apps in
    Salesforce.
...
- AsyncCartProcessor Interface (atlas.en-us.apexref.meta/apexref/apex_interface_sfdc_checkout_AsyncCartProcessor.htm)
- B2BCheckoutController Class (atlas.en-us.apexref.meta/apexref/apex_class_sfdc_checkout_B2BCheckoutController.htm)
- IntegrationInfo Class (atlas.en-us.apexref.meta/apexref/apex_class_sfdc_checkout_IntegrationInfo.htm)
- IntegrationStatus Class (atlas.en-us.apexref.meta/apexref/apex_class_sfdc_checkout_IntegrationStatus.htm)
- IntegrationStatus.Status Enum (atlas.en-us.apexref.meta/apexref/apex_enum_sfdc_checkout_IntegrationStatus.Status.htm)
