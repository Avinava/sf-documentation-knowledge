...
lastCollected: 2026-03-12T05:14:19.536Z
estimatedTokens: 4122
namespace: Auth
keywords: [ConnectedAppPlugin, Deprecated, only, API, versions, 35.0, 36.0., version, 37.0, authorize, userId, connectedAppId, isAdminApproved, context, instead., Usage, Example, customAttributes, formulaDefinedAttributes, modifySAMLResponse]
---
...
- ConnectedAppPlugin Methods (atlas.en-us.apexref.meta/apexref/apex_class_Auth_ConnectedAppPlugin.htm)
- authorize(userId, connectedAppId, isAdminApproved) (atlas.en-us.apexref.meta/apexref/apex_class_Auth_ConnectedAppPlugin.htm)
- authorize(userId, connectedAppId, isAdminApproved, context) (atlas.en-us.apexref.meta/apexref/apex_class_Auth_ConnectedAppPlugin.htm)
- customAttributes(userId, connectedAppId, formulaDefinedAttributes) (atlas.en-us.apexref.meta/apexref/apex_class_Auth_ConnectedAppPlugin.htm)
- customAttributes(userId, connectedAppId, formulaDefinedAttributes, context) (atlas.en-us.apexref.meta/apexref/apex_class_Auth_ConnectedAppPlugin.htm)
- modifySAMLResponse(authSession, connectedAppId, samlResponse) (atlas.en-us.apexref.meta/apexref/apex_class_Auth_ConnectedAppPlugin.htm)
- refresh(userId, connectedAppId) (atlas.en-us.apexref.meta/apexref/apex_class_Auth_ConnectedAppPlugin.htm)
- refresh(userId, connectedAppId, context) (atlas.en-us.apexref.meta/apexref/apex_class_Auth_ConnectedAppPlugin.htm)
