...
lastCollected: 2026-05-10T00:39:26.406Z
estimatedTokens: 7158
namespace: Cache
keywords: [Session, Cache.Session, add, retrieve, manage, cache, active, long, user’s, Salesforce, user, logged, expired, Constants, key, setOfKeys, keys, cacheBuilder, getAvgGetSize, getAvgGetTime, getAvgValueSize, getCapacity, getKeys, getMaxGetSize, getMaxGetTime, getMaxValueSize, getMissRate, getName, getNumKeys, getPartition, partitionName, isAvailable, put, visibility, ttlSecs, immutable, remove]
---

> Use the Cache.Session
            class to add, retrieve, and manage values in the session cache. The session cache is
            active as long as the user’s Salesforce session is valid
...
- Session Constants (atlas.en-us.apexref.meta/apexref/apex_class_cache_Session.htm)
- Session Methods (atlas.en-us.apexref.meta/apexref/apex_class_cache_Session.htm)
- contains(key) (atlas.en-us.apexref.meta/apexref/apex_class_cache_Session.htm)
- contains(setOfKeys) (atlas.en-us.apexref.meta/apexref/apex_class_cache_Session.htm)
- get(key) (atlas.en-us.apexref.meta/apexref/apex_class_cache_Session.htm)
- get(keys) (atlas.en-us.apexref.meta/apexref/apex_class_cache_Session.htm)
- get(cacheBuilder, key) (atlas.en-us.apexref.meta/apexref/apex_class_cache_Session.htm)
- getAvgGetSize() (atlas.en-us.apexref.meta/apexref/apex_class_cache_Session.htm)
- getAvgGetTime() (atlas.en-us.apexref.meta/apexref/apex_class_cache_Session.htm)
