...
keywords: [Session, Class, Deletes, cached, value, corresponding, specified, key, session, cache., method, class, implements, CacheBuilder, interface., remove, cacheBuilder, Signature, Parameters, Return]
---

# Session Class

> Deletes the cached value corresponding to the specified key from the session
