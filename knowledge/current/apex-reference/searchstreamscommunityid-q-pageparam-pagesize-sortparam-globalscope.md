---
title: "searchStreams(communityId, q, pageParam, pageSize, sortParam,
      globalScope)"
domain: apex-reference
topic: searchstreamscommunityid-q-pageparam-pagesize-sortparam-globalscope
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.227Z
keywords: [searchStreams, communityId, pageParam, pageSize, sortParam, globalScope, Search, Chatter, feed, streams, Experience, Cloud, sites, context, user, return, sorted, page, results., API]
---

# searchStreams(communityId, q, pageParam, pageSize, sortParam,
      globalScope)

> Search the Chatter feed streams from all Experience Cloud sites for
      the context user and return a sorted page of results.
