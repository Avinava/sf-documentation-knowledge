---
title: "getVotesForComment(communityId, commentId, vote, pageParam,
      pageSize)"
domain: apex-reference
topic: getvotesforcommentcommunityid-commentid-vote-pageparam-pagesize
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.226Z
keywords: [getVotesForComment, communityId, commentId, vote, pageParam, pageSize, Get, page, users, who, upvoted, downvoted, comment., API, Version, Available, Guest, Users, Requires, Chatter]
---

# getVotesForComment(communityId, commentId, vote, pageParam,
      pageSize)

> Get a page of users who upvoted or downvoted a
    comment.
