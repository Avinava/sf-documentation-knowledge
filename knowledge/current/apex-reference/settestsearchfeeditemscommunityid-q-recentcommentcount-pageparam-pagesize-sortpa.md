---
title: "setTestSearchFeedItems(communityId, q, recentCommentCount,
         pageParam, pageSize, sortParam, result)"
domain: apex-reference
topic: settestsearchfeeditemscommunityid-q-recentcommentcount-pageparam-pagesize-sortpa
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-11T15:42:31.232Z
keywords: [setTestSearchFeedItems, communityId, recentCommentCount, pageParam, pageSize, sortParam, result, Register, test, feed, item, page, returned, searchFeedItems, called, during, test., API, Version, Signature]
---

# setTestSearchFeedItems(communityId, q, recentCommentCount,
         pageParam, pageSize, sortParam, result)

> Register a test feed item page to be returned when searchFeedItems(communityId, q, recentCommentCount, pageParam, pageSize,
         sortParam) is called during a test.
...
-   [searchFeedItems(communityId, q, recentCommentCount, pageParam, pageSize, sortParam)](atlas.en-us.apexref.meta/apexref/apex_ConnectAPI_ChatterFeeds_static_methods.htm#apex_ConnectAPI_ChatterFeeds_searchFeedItems_5 "Get a page of sorted feed items that match the search criteria.")
