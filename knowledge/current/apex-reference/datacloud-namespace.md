...
lastCollected: 2026-05-10T00:39:48.624Z
estimatedTokens: 787
namespace: Datacloud
...
> The Datacloud namespace provides classes and
  ...
  and when users can save duplicate records within Salesforce.
...
- AdditionalInformationMap Class (atlas.en-us.apexref.meta/apexref/apex_class_Datacloud_AdditionalInformationMap.htm)
- DuplicateResult Class (atlas.en-us.apexref.meta/apexref/apex_class_Datacloud_DuplicateResult.htm)
- FieldDiff Class (atlas.en-us.apexref.meta/apexref/apex_class_Datacloud_FieldDiff.htm)
- FindDuplicates Class (atlas.en-us.apexref.meta/apexref/apex_class_Datacloud_FindDuplicates.htm)
- FindDuplicatesByIds Class (atlas.en-us.apexref.meta/apexref/apex_class_Datacloud_FindDuplicatesByIds.htm)
- FindDuplicatesResult Class (atlas.en-us.apexref.meta/apexref/apex_class_Datacloud_FindDuplicatesResult.htm)
- MatchRecord Class (atlas.en-us.apexref.meta/apexref/apex_class_Datacloud_MatchRecord.htm)
- MatchResult Class (atlas.en-us.apexref.meta/apexref/apex_class_Datacloud_MatchResult.htm)
