...
lastCollected: 2026-03-12T05:14:22.175Z
estimatedTokens: 1022
namespace: CommerceTax
keywords: [AddressesResponse, tax, address, fields, based, response, external, engine., Contains, setter, Ship, Sold, addresses., Usage, Example, setShipFrom, shipFrom, setShipTo, shipTo, setSoldTo]
---
...
-   **[AddressesResponse Methods](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_AddressesResponse.htm#apex_commercetax_AddressesResponse_methods)**
...
-   **[setShipFrom(shipFrom)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_AddressesResponse.htm#apex_commercetax_AddressesResponse_setShipFrom)**
    Sets the value of a ShipFrom address field.
-   **[setShipTo(shipTo)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_AddressesResponse.htm#apex_commercetax_AddressesResponse_setShipTo)**
    Sets the value of a ShipTo address field.
-   **[setSoldTo(soldTo)](atlas.en-us.apexref.meta/apexref/apex_class_commercetax_AddressesResponse.htm#apex_commercetax_AddressesResponse_setSoldTo)**
...
- AddressesResponse Methods (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_AddressesResponse.htm)
- setShipFrom(shipFrom) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_AddressesResponse.htm)
- setShipTo(shipTo) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_AddressesResponse.htm)
- setSoldTo(soldTo) (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_AddressesResponse.htm)
- AddressResponse (atlas.en-us.apexref.meta/apexref/apex_class_commercetax_AddressResponse.htm)
