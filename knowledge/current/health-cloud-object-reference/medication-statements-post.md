---
title: "Medication Statements (POST)"
domain: health-cloud-object-reference
topic: medication-statements-post
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:34:33.321Z
estimatedTokens: 191
keywords: [Medication, Statements, POST, patient]
---

# Medication Statements (POST)
...
[Medication Statement Output](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/connect_responses_med_statement_output.htm "Output representation of the medication statement create request.")

## Code Examples

```
/connect/health/clinical/patients/${patientId}/medication-statement
```

```
https://yourInstance.salesforce.com/services/data/vXX.X/connect/
health/clinical/patients/001RM000005Il81YAC/medication-statement
```
