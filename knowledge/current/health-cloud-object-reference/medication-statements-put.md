---
title: "Medication Statements (PUT)"
domain: health-cloud-object-reference
topic: medication-statements-put
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:34:33.316Z
estimatedTokens: 194
keywords: [Medication, Statements, PUT, patient]
---

# Medication Statements (PUT)
...
[Medication Statement Update Output](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/connect_responses_med_statement_update_output.htm "Output representation of medication statement update request.")

## Code Examples

```
/connect/health/clinical/patients/${patientId}/medication-statement/${medicationStatementId}
```

```
https://yourInstance.salesforce.com/services/data/v55.0/connect/
health/clinical/patients/001RM000005PF3BYAW/medication-statement/0juRM00000000dDYAQ
```
