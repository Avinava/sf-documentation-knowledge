...
lastCollected: 2026-03-12T09:34:37.123Z
estimatedTokens: 896
keywords: [GoalDefinition, goal, business, objective, that’s, instantiated, records, GoalAssignment, serve, goals, care, plans, Special, Access, Rules]
---
...
In Integrated Care Management, this object represents the definition of a care plan goal in the reusable PGI library.
...
| ParentGoalId | TypereferencePropertiesCreate, Filter, Group, Nillable, Sort, UpdateDescriptionThe ID of the parent record.This field is a relationship field.In Health Cloud, this field is not used in Integrated Care Management.Relationship NameParentGoalRelationship TypeLookupRefers ToGoalDefinition |
...
| UsageType | TypepicklistPropertiesCreate, Filter, Group, Nillable, Restricted picklist, Sort, UpdateDescriptionSpecifies the usage type of the defined goal.In Health Cloud, this field is not used in Integrated Care Management. |
