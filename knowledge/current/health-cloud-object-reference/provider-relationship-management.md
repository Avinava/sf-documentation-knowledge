...
![Provider entity relationship diagram](/docs/resources/img/en-us/260.0?doc_id=dev_guides%2Fhealthcare_api%2Fimages%2Fhealthcloud_providerrelationshipmgmt_erd.png&folder=health_cloud_object_reference)
...
-   **[Use Composite API Requests to Import Data for Provider Relationship Cards](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_provider_search_import_card_data.htm)**
...
-   **[Accreditation](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_accreditation.htm)**
...
-   **[Award](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_award_hc.htm)**
    Represents a person's or organization's professional awards.
-   **[BoardCertification](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_boardcertification.htm)**
...
-   **[BusinessLicense](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_businesslicense.htm)**
    Represents the licenses of a party role like healthcare provider or producer.
-   **[CareProviderAdverseAction](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_careprovideradverseaction.htm)**
...
-   **[CareProviderFacilitySpecialty](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_careproviderfacilityspecialty.htm)**
...
-   **[CareProviderSearchableField](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_careprovidersearchablefield.htm)**
...
-   **[CareProviderSearchConfig](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_careprovidersearchconfig.htm)**
...
-   **[CareService](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_careservice.htm)**
...
-   **[CareSpecialty](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_carespecialty.htm)**
    Represents a listing of provider specialty codes and descriptions. For example, 02 - Physician/General Surgery.
-   **[CareSpecialtyTaxonomy](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_carespecialtytaxonomy.htm)**
    The junction object between CareSpecialty and CareTaxonomy. This object is available in API version 52.0 and later.
-   **[CareTaxonomy](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_caretaxonomy.htm)**
    Represents a static list of taxonomy codes.
-   **[HealthcareFacilityNetwork](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_healthcarefacilitynetwork.htm)**
...
-   **[HealthcarePayerNetwork](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_healthcarepayernetwork.htm)**
    Represents an insurance network group. For example, an insurance company’s exclusive provider organization (EPO) plans.
-   **[HealthcarePractitionerFacility](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_healthcarepractitionerfacility.htm)**
...
-   **[HealthcareProviderNpi](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_healthcareprovidernpi.htm)**
...
-   **[HealthcareProviderService](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_healthcareproviderservice.htm)**
...
-   **[HealthcareProviderSpecialty](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_healthcareproviderspecialty.htm)**
...
-   **[HealthcareProviderTaxonomy](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_healthcareprovidertaxonomy.htm)**
...
-   **[HealthcareServiceDetail](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_healthcareservicedetail.htm)**
...
-   **[HlthCareProvTreatedCondition](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_hlthcareprovtreatedcondition.htm)**
...
-   **[PersonEducation](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_personeducation.htm)**
    Represents information about professional education for a person in a provider role.
-   **[PersonEmployment](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_personemployment.htm)**
    Represents information about a person’s employment.
-   **[ProviderSearchSyncLog](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_providersearchsynclog.htm)**
