...
lastCollected: 2026-03-12T09:34:35.034Z
estimatedTokens: 2346
...
-   **[Supported Fields](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_upsert_provider_api.htm#hc_create_provider_api_fields)**
    The upsert provider API supports all standard and custom fields.
-   **[Resources](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_upsert_provider_api.htm#hc_upsert_provider_api_resource)**
    Details and JSON samples
-   **[Code Samples](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_upsert_provider_api.htm#hc_upsert_provider_api_samples)**
    Here are some JSON samples you can use as a starting point for building request bodies and interpreting responses.
-   **[Error Handling](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_upsert_provider_api.htm#hc_upsert_provider_api_errors)**
...
- Supported Fields (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_upsert_provider_api.htm)
- Resources (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_upsert_provider_api.htm)
- Code Samples (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_upsert_provider_api.htm)
- Error Handling (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_upsert_provider_api.htm)
