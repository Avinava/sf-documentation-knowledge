...
lastCollected: 2026-03-12T09:34:34.029Z
...
-   **[Use Cases](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm#hc_create_provider_api_use_cases)**
...
-   **[Prerequisites](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm#hc_create_provider_api_api)**
    Notes about lookups
-   **[Supported Fields](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm#hc_create_provider_api_fields)**
    The Create provider API supports all standard and custom fields.
-   **[Resources](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm#hc_create_provider_api_resource)**
    Details and JSON samples
-   **[Code Samples](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm#hc_create_provider_api_samples)**
    Here are some JSON samples that you can use as a starting point to build request bodies and interpret responses.
-   **[Error Handling](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm#hc_create_provider_api_errors)**
...
- Use Cases (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm)
- Prerequisites (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm)
- Supported Fields (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm)
- Resources (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm)
- Code Samples (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm)
- Error Handling (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/hc_create_provider_api.htm)
