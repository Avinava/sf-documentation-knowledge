---
title: "Health Cloud Platform Events"
domain: health-cloud-object-reference
topic: health-cloud-platform-events
apiVersion: 67.0
...
> Use the ApplnFormAppealStsChgEvnt platform event to notify subscribers when the status
    ...
    platform event to notify subscribers when the status of care benefit verify request
    changes.
...
This platform event object is available within the Health Cloud platform.

-   **[ApplnFormAppealStsChgEvnt](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_applnformappealstschgevnt.htm)**
...
-   **[CareBnftVrfyRqstStsChgEvent](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/sforce_api_objects_carebnftvrfyrqststschgevent.htm)**
