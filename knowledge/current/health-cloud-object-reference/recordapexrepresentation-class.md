...
lastCollected: 2026-03-12T09:34:32.250Z
...
-   **[RecordApexRepresentation Constructors](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm#apex_embeddedai_RecordApexRepresentation_constructors)**
    Learn more about the constructors available with the RecordApexRepresentation class.
-   **[RecordApexRepresentation Properties](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm#apex_embeddedai_RecordApexRepresentation_properties)**

-   **[RecordApexRepresentation Methods](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm#apex_embeddedai_RecordApexRepresentation_methods)**
...
-   **[RecordApexRepresentation(objectType, recordData, relatedRecordData)](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm#apex_embeddedai_RecordApexRepresentation_ctor)**
...
-   **[RecordApexRepresentation()](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm#apex_embeddedai_RecordApexRepresentation_ctor_2)**
...
Type: List<[embeddedai.ApexMap](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_ApexMap.htm#apex_class_embeddedai_ApexMap "Create, clone, and convert string based key-value pairs to a JSON string format.")\>
...
-   **[objectType](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm#apex_embeddedai_RecordApexRepresentation_objectType)**
    Stores the type of the object.
-   **[recordData](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm#apex_embeddedai_RecordApexRepresentation_recordData)**
    Stores a list of objects, where each object holds a key-value pair.
-   **[relatedRecordData](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm#apex_embeddedai_RecordApexRepresentation_relatedRecordData)**
...
-   **[toRecordApexRep(jsonString)](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm#apex_embeddedai_RecordApexRepresentation_toRecordApexRep)**
...
-   **[toString()](atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm#apex_embeddedai_RecordApexRepresentation_toString)**
...
- RecordApexRepresentation Constructors (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm)
- RecordApexRepresentation Properties (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm)
- RecordApexRepresentation Methods (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm)
- RecordApexRepresentation(objectType, recordData, relatedRecordData) (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm)
- RecordApexRepresentation() (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm)
- embeddedai.ApexMap (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_ApexMap.htm)
- objectType (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm)
- recordData (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm)
- relatedRecordData (atlas.en-us.health_cloud_object_reference.meta/health_cloud_object_reference/apex_class_embeddedai_RecordApexRepresentation.htm)
