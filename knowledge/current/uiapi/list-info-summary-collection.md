---
title: "List Info Summary Collection"
domain: uiapi
topic: list-info-summary-collection
apiVersion: 67.0
...
-   [Get List Views for an Object](atlas.en-us.uiapi.meta/uiapi/ui_api_resources_lists_object_get.htm "Get list views associated with an object.")

## Related Topics

- List Info
                  Summary (atlas.en-us.uiapi.meta/uiapi/ui_api_responses_list_info_summary.htm)
