---
title: "Related List Info Summary"
domain: uiapi
topic: related-list-info-summary
apiVersion: 67.0
...
| keyPrefix | String | The key prefix for IDs of the object that populates the list. This can be null for some related lists. | Small, 50.0 | 50.0 |
...
-   [Related List Info Summary Collection](atlas.en-us.uiapi.meta/uiapi/ui_api_responses_related_list_summary_collection.htm "A collection of related lists for a given object.")
