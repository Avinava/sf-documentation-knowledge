...
lastCollected: 2026-04-07T18:40:12.088Z
estimatedTokens: 467
...
| --- | --- | --- | --- | --- |
| editableForNew | Boolean | Indicates whether the item can be edited when creating a record. | Small, 41.0 | 41.0 |
...
| sortable | Boolean | Indicates whether the layout item is sortable. | Small, 41.0 | 41.0 |
