...
lastCollected: 2026-03-12T09:36:19.953Z
...
For information on the WITH DATA CATEGORY clause, see the [WITH DATA CATEGORY filteringExpression](atlas.en-us.soql_sosl.meta/soql_sosl/sforce_api_calls_soql_select_with_datacategory.htm "You can search for Salesforce Knowledge articles and questions by their data category in a SOQL query. WITH DATA CATEGORY is an optional clause in a SELECT statement that’s used to filter records that are associated with one or more data categories and are visible to users.").

![Tip](/docs/resources/img/en-us/260.0?doc_id=images%2Ficon_note_tip.png&folder=soql_sosl)

#### Tip

You can also search for articles by ID, without using the WITH DATA CATEGORY clause. For more information, see [Example WHERE Clauses](atlas.en-us.soql_sosl.meta/soql_sosl/sforce_api_calls_sosl_where.htm#i1423232).
...
- WITH DATA
                            CATEGORY
                        filteringExpression (atlas.en-us.soql_sosl.meta/soql_sosl/sforce_api_calls_soql_select_with_datacategory.htm)
- Example WHERE Clauses (atlas.en-us.soql_sosl.meta/soql_sosl/sforce_api_calls_sosl_where.htm)
