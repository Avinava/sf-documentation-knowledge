---
title: "SOQL SELECT Functions"
domain: soql-sosl
topic: soql-select-functions
apiVersion: 67.0
...
- convertCurrency() (atlas.en-us.soql_sosl.meta/soql_sosl/sforce_api_calls_sosl_querying_currency_fields.htm)
