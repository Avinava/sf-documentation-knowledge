---
title: "Einstein Discovery REST API Response Bodies"
domain: bi-dev-guide-rest-sdd
topic: einstein-discovery-rest-api-response-bodies
apiVersion: 67.0
...
The successful execution of a request to an Einstein Discovery REST API resource can return a response body in either JSON or XML format.
...
-   **[Abstract Smart Data Discovery Validation Configuration](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_abstract_smart_data_discovery_validation_configuration.htm)**
...
-   **[Abstract Story Narrative Element](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_abstract_story_narrative_element.htm)**
...
-   **[Asset History](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_asset_history.htm)**
...
-   **[Base Asset Reference](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_base_asset_reference.htm)**
...
-   **[Directory Item Collection](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_directory_item_collection.htm)**
...
-   **[Predict History](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_predict_history.htm)**
    The historical predictions for a target.
-   **[Predict History Range](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_predict_history_range.htm)**
    A range used for the historical prediction query.
-   **[Predict History Value](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_predict_history_value.htm)**
    A historical prediction value at a specific point in time.
-   **[Report Source](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_report_source.htm)**
    An analytics report as the analysis source.
-   **[Smart Data Discovery Aggregate Predict Condition](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_aggregate_predict_condition.htm)**
...
-   **[Smart Data Discovery AI Model Residual](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_ai_model_residual.htm)**
    AnEinstein Discovery AI model residual.
-   **[Smart Data Discovery AI Model Transformation](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_ai_model_transformation.htm)**
...
-   **[Smart Data Discovery Categorical Projected Prediction](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_categorical_projected_prediction.htm)**
    An Einstein Discovery categorical projected prediction.
-   **[Smart Data Discovery Classification Prediction Property](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_classification_prediction_property.htm)**
    The classification prediction model type.
-   **[Smart Data Discovery Contact](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_contact.htm)**
    An Einstein Discovery contact.
-   **[Smart Data Discovery Custom Prescribable Field Definition](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_custom_prescribable_field_definition.htm)**
...
-   **[Smart Data Discovery Field Mapping Analytics Dataset Field](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_field_mapping_analytics_dataset_field.htm)**
    An Einstein Discovery field mapped from an analytics dataset source.
-   **[Smart Data Discovery Field Mapping Mapped Field](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_field_mapping_mapped_field.htm)**
    A mapped field in a field mapping.
-   **[Smart Data Discovery Field Mapping Salesforce Field](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_field_mapping_salesforce_field.htm)**
    An Einstein Discovery field mapped from a Salesforce field source.
-   **[Smart Data Discovery Field](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_field.htm)**
...
-   **[Smart Data Discovery Impute Strategy](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_impute_strategy.htm)**
    The impute strategy.
-   **[Smart Data Discovery Insight](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_insights.htm)**
    An insight for an Einstein Discovery analysis.
-   **[Smart Data Discovery Live Metric Detail](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_live_metric_detail.htm)**
    A live AI Einstein Discovery metric.
-   **[Smart Data Discovery Live Metrics](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_live_metrics.htm)**
...
-   **[Smart Data Discovery Prediction Definition Collection](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_model_collection.htm)**
    A collection of Einstein Discovery prediction definitions.
-   **[Smart Data Discovery Model Configuration](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_model_configuration.htm)**
...
-   **[Smart Data Discovery Multiclass Classification Prediction Property](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_multiclass_classification_prediction_property.htm)**
    The multiclass classification prediction model type.
-   **[Smart Data Discovery Multiclass Predict](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_multiclass_predict.htm)**
    An Einstein Discovery multiclass predict result.
-   **[Smart Data Discovery Narrative Details](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_narrative_details.htm)**
...
-   **[Smart Data Discovery Narrative Field](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_narrative_field.htm)**
    A single row of narrative data for an Einstein Discovery story.
-   **[Smart Data Discovery Narrative Post Body Filter](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_narrative_post_body_filter.htm)**
    A query filter for narrative data of an Einstein Discovery story.
-   **[Smart Data Discovery Narrative Post Body Insight](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_narrative_post_body_insight.htm)**
...
-   **[Smart Data Discovery Narrative Post Body](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_narrative_post_body.htm)**
    A single row of narrative data for an Einstein Discovery story.
-   **[Smart Data Discovery Numeric Range](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_numeric_range.htm)**
...
-   **[Smart Data Discovery Predict Column Custom Text](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_predict_column_custom_text.htm)**
    The custom text for a predict column given by the Einstein Discovery prediction.
-   **[Smart Data Discovery Predict Column](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_predict_column.htm)**
    A column given from an Einstein Discovery prediction.
-   **[Smart Data Discovery Predict Condition](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_predict_condition.htm)**
...
-   **[Smart Data Discovery Import Warnings](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_predict_import_warnings.htm)**
...
-   **[Smart Data Discovery Prediction Definition Outcome Field](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_pred_def_outcome_field.htm)**
...
-   **[Smart Data Discovery Projected Value](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_projected_value.htm)**
...
-   **[Smart Data Discovery Outcome](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_outcome.htm)**
...
-   **[Smart Data Discovery Refresh Task](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_refresh_task.htm)**
    An Einstein Discovery refresh task.
-   **[Smart Data Discovery Regression Classification Prediction Property](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_regression_classification_prediction_property.htm)**
    The regression classification prediction model type.
-   **[Smart Data Discovery Training Metrics](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_smart_data_discovery_training_metrics.htm)**
...
-   **[Story Diagnostic Insights Detail](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_diagnostic_insights_detail.htm)**
...
-   **[Story Chart Value](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_chart_value.htm)**
    A value in a story chart.
-   **[Story Chart Value Detail](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_chart_value_detail.htm)**
    The detail for a value in a story chart.
-   **[Story Chart](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_chart.htm)**
    A story chart.
...
-   **[Story Insights Detail](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_insights_detail.htm)**
...
-   **[Story Narrative Element Text](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_narrative_element_text.htm)**
    The text element for a story narrative.
-   **[Story Narrative](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_narrative.htm)**
...
-   **[Story Query Diagnostic Insights](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_query_diagnostic_insights.htm)**
    A story query diagnostic insights.
-   **[Story Query Disparate Impact Detail](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_query_disparate_impact_detail.htm)**
...
-   **[Story Range Field Value](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_range_field_value.htm)**
...
-   **[Story Text Field Value](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_text_field_value.htm)**
    The story data text property.
-   **[Story Version Reference](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_version_reference.htm)**
...
-   **[Story](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story.htm)**
    An Einstein Discovery story.
-   **[Story Year Field Value](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_story_year_field_value.htm)**
...
-   **[Validation Dataset](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_validation_dataset.htm)**
    The output for a validation dataset configuration.
-   **[Validation Ratio](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_validation_ratio.htm)**
