---
title: "Story Range Field Value Input"
domain: bi-dev-guide-rest-sdd
topic: story-range-field-value-input
apiVersion: 67.0
...
| --- | --- | --- | --- | --- |
| end​Value | String | The end value of the range. | Required | 52.0 |
| start​Value | String | The start value of the range. | Required | 52.0 |
