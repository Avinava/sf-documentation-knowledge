---
title: "Story Narrative Element Text"
domain: bi-dev-guide-rest-sdd
topic: story-narrative-element-text
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-04-07T09:03:13.611Z
estimatedTokens: 230
keywords: [Story, Narrative, Element, Text]
---
...
Inherits properties from [Abstract​Story​Narrative​Element](atlas.en-us.bi_dev_guide_rest_sdd.meta/bi_dev_guide_rest_sdd/bi_sdd_responses_abstract_story_narrative_element.htm "The base story narrative element.").

| Property Name | Type | Description | Filter Group and Version | Available Version |
| --- | --- | --- | --- | --- |
| condition​Field | Abstract​Story​Data​Property | The narrative text with data properties. Valid values are:Story All Other Field ValueStory Day Field ValueStory Day Of Week Field ValueStory Field OnlyStory Month Field ValueStory Month Of Year Field ValueStory Null Field ValueStory Quarter Field ValueStory Quarter Of Year Field ValueStory Range Field ValueStory Text Field ValueStory Year Field Value | Small, 54.0 | 54.0 |
