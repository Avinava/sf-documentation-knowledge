---
title: "Package Agentforce Metadata Components"
domain: pkg2-dev
topic: package-agentforce-metadata-components
apiVersion: 67.0
...
-   Create your agent’s actions and topics in the Agentforce Asset Library. See [Create a Custom Agent Action](https://help.salesforce.com/s/articleView?id=ai.copilot_actions_custom.htm&language=en_US) and [Create a Custom Topic](https://help.salesforce.com/s/articleView?id=ai.copilot_topics_add_custom.htm&language=en_US) for instructions. Any agent action or topic that will be packaged must be in the Agentforce Asset Library.

| Feature Name | Metadata Name | Available in … | More Information |
| --- | --- | --- | --- |
| Agent Actions | GenAiFunction | Managed 2GP and Managed 1GP | Agent Action |
| Agent Topics | GenAiPlugin | Managed 2GP and Managed 1GP | Agent Topic |
| Prompt Templates | GenAiPromptTemplate | Managed 2GP and Managed 1GP | Prompt Template |
| Agent Templates | BotTemplate, GenAiPlannerBundle | Managed 2GP and Managed 1GP | Bot Template, Gen AI Planner Bundle |
...
-   [*Salesforce Help*: Considerations for Packaging Prompt Templates](https://help.salesforce.com/s/articleView?id=ai.prompt_builder_considerations_packaging.htm&language=en_US "Salesforce Help: Considerations for Packaging Prompt Templates - HTML (New Window)")
