...
-   [Hide Custom Objects and Custom Permissions in Your Subscribers' Orgs](https://developer.salesforce.com/docs/atlas.en-us.pkg1_dev.meta/pkg2_dev/fma_hide_custom_objects_permissions.htm "Hide Custom Objects and Custom Permissions in Your Subscribers' Orgs - HTML (New Window)")
