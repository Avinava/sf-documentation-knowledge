---
title: "Run the DailyAggregation CRM Analytics Recipe"
domain: pkg2-dev
topic: run-the-dailyaggregation-crm-analytics-recipe
apiVersion: 67.0
...
-   [← Previous](atlas.en-us.pkg2_dev.meta/pkg2_dev/app_analytics_cookbook_tcrm_da_monitor.htm "Monitor the DailyAggregation CRM Analytics Recipe")

## Related Topics

- ← Previous (atlas.en-us.pkg2_dev.meta/pkg2_dev/app_analytics_cookbook_tcrm_da_monitor.htm)
