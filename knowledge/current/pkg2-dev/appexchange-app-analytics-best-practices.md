---
title: "AppExchange App Analytics Best Practices"
domain: pkg2-dev
topic: appexchange-app-analytics-best-practices
apiVersion: 67.0
...
> To plan and maximize your AppExchange App Analytics query strategy, follow our best
  ...
  automate your regular App Analytics queries. Third, plan, schedule, and automate catch-up queries
  to supplement your regular query data.
...
-   **[How Does AppExchange App Analytics Data Flow?](atlas.en-us.pkg2_dev.meta/pkg2_dev/app_analytics_data_flow.htm)**
...
-   **[How Should I Plan My App Analytics Query Strategy?](atlas.en-us.pkg2_dev.meta/pkg2_dev/app_analytics_query_strategy.htm)**
    Your detailed query strategy depends on the size and scope of your business and the data types that you’re querying.
-   **[Recommendations](atlas.en-us.pkg2_dev.meta/pkg2_dev/app_analytics_recommendations.htm)**
...
-   **[Where Do I Go for More Information About AppExchange App Analytics Queries?](atlas.en-us.pkg2_dev.meta/pkg2_dev/app_analytics_more_information.htm)**
