---
title: "Contact Salesforce Partner Support to Enable Specific Packaging Features"
domain: pkg2-dev
topic: contact-salesforce-partner-support-to-enable-specific-packaging-features
apiVersion: 67.0
...
3.  Complete the Subject and Description fields
    1.  After you enter a Description, a section called **Pick a different product & topic** will display.
