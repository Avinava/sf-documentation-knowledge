...
-   [*Salesforce Help*: Permission Set Group Considerations](https://help.salesforce.com/s/articleView?id=platform.perm_set_groups_considerations.htm&type=5&language=en_US "Salesforce Help: Permission Set Group Considerations - HTML (New Window)")
