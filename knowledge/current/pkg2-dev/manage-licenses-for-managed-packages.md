...
lastCollected: 2026-03-12T09:35:26.192Z
...
-   **[Get Started with the License Management App](atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_setup.htm)**
...
-   **[Lead and License Records in the License Management App](atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_terms_relationships.htm)**
    Each time a customer installs your managed package, the License Management App (LMA) creates lead and license records.
-   **[Modify a License Record](atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_edit_license.htm)**
...
-   **[Refresh Licenses for a Managed Package](atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_refresh_licenses.htm)**
...
-   **[Extending the License Management App](atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_extend.htm)**
...
-   **[Move the License Management App to Another Salesforce Org](atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_change_org.htm)**
...
-   **[Troubleshoot the License Management App](atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_troubleshoot.htm)**
    If you’re experiencing issues with the License Management App, review these troubleshooting tips.
-   **[Best Practices for the License Management App](atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_best_practices.htm)**
...
- Get Started with the License
                Management App (atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_setup.htm)
- Assign
                Permissions to the Subscriber Support Console (atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_subscriber_org_permissions.htm)
- Get Started with the License Management App (atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_setup.htm)
- Lead and License Records in the License Management App (atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_terms_relationships.htm)
- Modify a License Record (atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_edit_license.htm)
- Refresh Licenses for a Managed Package (atlas.en-us.pkg2_dev.meta/pkg2_dev/lma_refresh_licenses.htm)
