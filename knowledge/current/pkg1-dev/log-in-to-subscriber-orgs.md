...
docType: concept
lastCollected: 2026-03-12T09:35:25.424Z
estimatedTokens: 868
...
-   Control who has login access by giving the Log in to Subscriber Org user permission to specific support personnel via a profile or permission set. See [Assign Permissions to the Subscriber Org Console](atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_subscriber_org_permissions.htm#).

## Related Topics

- Assign Permissions to the Subscriber Org
            Console (atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_subscriber_org_permissions.htm)
