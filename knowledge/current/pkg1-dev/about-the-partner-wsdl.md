---
title: "About the Partner WSDL"
domain: pkg1-dev
topic: about-the-partner-wsdl
apiVersion: 67.0
...
For more information about the Partner WSDL, see [Using the Partner WSDL](https://developer.salesforce.com/docs/atlas.en-us.260.0.api.meta/api/sforce_api_partner.htm "html (New Window)") in SOAP API Developer Guide.
