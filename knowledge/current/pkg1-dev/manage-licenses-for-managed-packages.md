---
title: "Manage Licenses for Managed Packages"
domain: pkg1-dev
topic: manage-licenses-for-managed-packages
apiVersion: 67.0
release: summer-26-v67
docType: help-article
lastCollected: 2026-04-07T09:05:01.595Z
...
> Use the License Management App (LMA) to manage leads and licenses for your AppExchange
    ...
    package that is installed in all partner business orgs (PBO) and includes custom objects that
    track details on packages, package versions, and licenses.
...
| --- | --- | --- |
| Configure the LMA | System Admin profile | Get Started with the License Management App |
...
The LMA is available only in English.

The LMA is available to eligible Salesforce partners. For more information on the Partner Program, including eligibility requirements, visit [https://partners.salesforce.com](https://partners.salesforce.com "HTML (New Window)").

-   **[Get Started with the License Management App](atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_setup.htm)**
...
-   **[Lead and License Records in the License Management App](atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_terms_relationships.htm)**
    Each time a customer installs your managed package, the License Management App (LMA) creates lead and license records.
-   **[Modify a License Record](atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_edit_license.htm)**
...
-   **[Refresh Licenses for a Managed Package](atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_refresh_licenses.htm)**
...
-   **[Extending the License Management App](atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_extend.htm)**
...
-   **[Move the License Management App to Another Salesforce Org](atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_change_org.htm)**
...
-   **[Troubleshoot the License Management App](atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_troubleshoot.htm)**
    If you’re experiencing issues with the License Management App, review these troubleshooting tips.
-   **[Best Practices for the License Management App](atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_best_practices.htm)**
    Follow these best practices when you use the License Management App (LMA).
-   **[Troubleshoot Subscriber Issues](atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_subscriber_support_overview.htm)**
...
- Get Started with the License
                Management App (atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_setup.htm)
- Assign
                Permissions to the Subscriber Support Console (atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_subscriber_org_permissions.htm)
- Get Started with the License Management App (atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_setup.htm)
- Lead and License Records in the License Management App (atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_terms_relationships.htm)
- Modify a License Record (atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_edit_license.htm)
- Refresh Licenses for a Managed Package (atlas.en-us.pkg1_dev.meta/pkg1_dev/lma_refresh_licenses.htm)
