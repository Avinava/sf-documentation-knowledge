---
title: "Update Your First-Generation Managed Package"
domain: pkg1-dev
topic: update-your-first-generation-managed-package
apiVersion: 67.0
...
-   **[Package Versions in First-Generation Managed Packages](atlas.en-us.pkg1_dev.meta/pkg1_dev/dev_package_versions_overview.htm)**
...
-   **[Create and Upload Patches in First-Generation Managed Packages](atlas.en-us.pkg1_dev.meta/pkg1_dev/patches_creating.htm)**
    Patch versions are developed and maintained in a patch development org.
-   **[Work with Patch Versions](atlas.en-us.pkg1_dev.meta/pkg1_dev/packaging_patches_about.htm)**
...
-   **[Versioning Apex Code](atlas.en-us.pkg1_dev.meta/pkg1_dev/packaging_behavior_apex.htm)**
...
-   **[Apex Deprecation Effects for Subscribers](atlas.en-us.pkg1_dev.meta/pkg1_dev/packaging_effects_subscribers.htm)**
