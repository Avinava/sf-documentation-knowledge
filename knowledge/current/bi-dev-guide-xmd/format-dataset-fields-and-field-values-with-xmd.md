---
title: "Format Dataset Fields and Field Values with XMD"
domain: bi-dev-guide-xmd
topic: format-dataset-fields-and-field-values-with-xmd
apiVersion: 67.0
...
These topics explore some common uses of XMD. Almost all of the XMD functionality is now supported in the UI for CRM Analytics dashboards and lenses.
...
-   **[Format the Results of a Query with Multiple Datasets](atlas.en-us.bi_dev_guide_xmd.meta/bi_dev_guide_xmd/bi_dashboards_steps_multidataset_xmd.htm)**
