---
title: "Get Components for Configuration Item"
domain: agentforce
topic: get-components-for-configuration-item
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-04-05T00:23:34.991Z
estimatedTokens: 558
...
| Attributes (by developer name) | String | Configuration item attribute you request in the records is returned with its developer name. | 66.0 |

![Note](/docs/resources/img/en-us/260.0?doc_id=images%2Ficon_note.png&folder=agentforce_it_service_dev_guide)

#### Note

You can request any available configuration item attribute in the records selection by using its developer name (for example, SD\_AsNa, SD\_OpSy). The response includes only the fields you request. To learn more, see [CI Types and Attributes](atlas.en-us.agentforce_it_service_dev_guide.meta/agentforce_it_service_dev_guide/graphql_api_agentic_it_service_canonical.htm#CI_Types_Attributes).
