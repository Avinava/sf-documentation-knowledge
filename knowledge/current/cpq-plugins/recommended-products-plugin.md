...
lastCollected: 2026-03-12T09:34:24.000Z
...
![Plugins tab in Settings Editor showing Recommended Products plugin setting](/docs/resources/img/en-us/260.0?doc_id=images%2Fcpq_recommended_products_plugin_settings.png&folder=cpq_plugins)
...
1.  Add products to a quote and click the **Add Recommendations** custom action.
    ...
    ![Image of quote line editor with Add Recommendations custom action](/docs/resources/img/en-us/260.0?doc_id=images%2Fcpq_recommended_products_plugin_custom_action_button.png&folder=cpq_plugins)
...
2.  Salesforce calls your plugin implementation class and obtains an ordered list of PricebookEntry sObjects. These sObjects are then displayed on the Recommended Products page.
    ...
    ![Add Recommended Products page screen shot](/docs/resources/img/en-us/260.0?doc_id=images%2Fcpq_recommended_products_plugin_add_recommendations_page.png&folder=cpq_plugins)
