...
lastCollected: 2026-03-12T09:34:23.986Z
estimatedTokens: 885
...
-   **[Product Search Plugin](atlas.en-us.cpq_plugins.meta/cpq_plugins/cpq_product_search_plugins.htm)**
...
-   **[Recommended Products Plugin](atlas.en-us.cpq_plugins.meta/cpq_plugins/cpq_recommended_products_plugin.htm)**
    Use the Recommended Products plugin to recommend related products based on the existing products on a quote.
-   **[External Configurator Plugins](atlas.en-us.cpq_plugins.meta/cpq_plugins/cpq_external_config.htm)**
...
-   **[Legacy Quote Calculator Plugin](atlas.en-us.cpq_plugins.meta/cpq_plugins/cpq_legacy_quote_calculator_plugin.htm)**
    Use Apex code to perform calculations within the CPQ quote line editor.
-   **[Product Configuration Initializer for Guided Selling](atlas.en-us.cpq_plugins.meta/cpq_plugins/cpq_product_config_initializer.htm)**
...
-   **[Product Search Executor for Guided Selling](atlas.en-us.cpq_plugins.meta/cpq_plugins/cpq_product_search_executor.htm)**
...
-   **[Document Store Plugin](atlas.en-us.cpq_plugins.meta/cpq_plugins/cpq_doc_store_plugin.htm)**
    Use a CPQ document store plugin to store your quote documents as custom objects or in third-party integrations.
-   **[Custom Action Plugin](atlas.en-us.cpq_plugins.meta/cpq_plugins/cpq_custom_action_plugin.htm)**
...
-   **[Salesforce CPQ Electronic Signature Plugin](atlas.en-us.cpq_plugins.meta/cpq_plugins/cpq_esp_plugin.htm)**
