---
title: "Migrate All Apps from 9.1 to 9.2"
domain: mobile-sdk
topic: migrate-all-apps-from-91-to-92
apiVersion: 67.0
...
Before you begin upgrading, read about new 9.2 features in [What’s New in Mobile SDK 11.1](atlas.en-us.noversion.mobile_sdk.meta/mobile_sdk/gs_whatsnew.htm).
...
Mobile SDK 9.2 upgrades key store encryption. For most apps the upgrade happens automatically, but some apps require extra steps. See [Upgrading Encryption in Apps](atlas.en-us.noversion.mobile_sdk.meta/mobile_sdk/auth_secure_key_storage_ios.htm#ios_keystore_encryption_upgrading).
...
- Upgrading Encryption in Apps (atlas.en-us.noversion.mobile_sdk.meta/mobile_sdk/auth_secure_key_storage_ios.htm)
