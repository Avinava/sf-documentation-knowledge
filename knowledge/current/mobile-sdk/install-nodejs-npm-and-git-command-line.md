---
title: "Install Node.js, npm, and Git Command Line"
domain: mobile-sdk
topic: install-nodejs-npm-and-git-command-line
apiVersion: 67.0
...
> Many mobile developers want to use Mobile SDK as a
            ...
            case, Mobile SDK
            offers a variety of npm command line scripts that help you create apps. If you plan to
            take advantage of these npm tools, you first install Node.js. The Node.js installer
            automatically installs npm. You also install the latest version of the Git command
            line.
...
1.  Download the Node.js installer from [www.nodejs.org](https://www.nodejs.org "HTML (New Window)").
...
4.  If your command line doesn’t recognize the git command, go to [https://git-scm.com/](https://git-scm.com/ "HTML (New Window)") to download and install the latest Git package for your system.
