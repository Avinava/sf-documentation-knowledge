---
title: "About Login and Passcodes"
domain: mobile-sdk
topic: about-login-and-passcodes
apiVersion: 67.0
...
> To access Salesforce objects from a Mobile SDK app, the
      ...
      connected app configuration to Salesforce. Salesforce responds by posting a login screen to
      the mobile device.
...
2.  Add the following top-level property:
    ...
    ![Face ID configuration in the app's plist](/docs/resources/img/en-us/noversion?doc_id=dev_guides%2Fmobile_sdk%2Fimages%2Fface_id_plist_config.png&folder=mobile_sdk)
...
-   [OAuth 2.0 Authentication Flow](atlas.en-us.noversion.mobile_sdk.meta/mobile_sdk/oauth_intro_flow.htm)
