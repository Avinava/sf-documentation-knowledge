...
> Mobile SDK uses
   ...
   can disable the analytics feature in your app, and you can use the logging framework to output
   messages for your custom components.
...
-   **[iOS Compiler-Level Logging](atlas.en-us.noversion.mobile_sdk.meta/mobile_sdk/analytics_logging_ios.htm)**
    Mobile SDK 7.0 simplifies iOS logging and refers it to the underlying operating system framework.
-   **[Android Logging Framework](atlas.en-us.noversion.mobile_sdk.meta/mobile_sdk/analytics_logging_framework.htm)**
    Mobile SDK provides a logging framework that allows developers to easily create logs for app components.
-   **[Instrumentation and Event Collection](atlas.en-us.noversion.mobile_sdk.meta/mobile_sdk/analytics_overview.htm)**
