...
domain: mobile-sdk
topic: create-a-facebook-app
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-04-07T18:40:25.252Z
estimatedTokens: 253
keywords: [Facebook, App, enable, Experience, Cloud, site, logins, start, creating]
---

> To enable Experience Cloud site logins through Facebook, start by creating a Facebook
  app.
...
1.  Go to [developers.facebook.com](https://developers.facebook.com "HTML (New Window)").
