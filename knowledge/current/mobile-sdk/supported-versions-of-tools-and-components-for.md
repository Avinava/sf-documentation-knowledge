---
title: "Supported Versions of Tools and Components for"
domain: mobile-sdk
topic: supported-versions-of-tools-and-components-for
apiVersion: 67.0
...
| --- | --- | --- |
| Node.js | Latest | Install from nodejs.org |
...
| CocoaPods | 1.8 to no declared maximum | Install from cocoapods.org |
...
| Tool or Component | Supported Version | Installation Details |
| --- | --- | --- |
| Java JDK | 11.0.11+9 | Install from oracle.com |
| Android Studio | Latest | Install from developer.android.com/studio/ |
...
| Tool or Component | Supported Version | Installation Details |
| --- | --- | --- |
| Cordova | 12.0.1 (for Android), 7.0.1 (for iOS) | Install from cordova.apache.org |
