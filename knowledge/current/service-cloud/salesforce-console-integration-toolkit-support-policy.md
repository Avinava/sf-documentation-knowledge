---
title: "Salesforce Console Integration Toolkit Support Policy"
domain: service-cloud
topic: salesforce-console-integration-toolkit-support-policy
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-03-12T05:14:58.495Z
estimatedTokens: 234
keywords: [Salesforce, Console, Integration, Toolkit, Support, Policy, current, release, only, version, receives, enhancements.]
---

# Salesforce Console Integration Toolkit Support Policy

> The current release of the Salesforce Console Integration Toolkit is the only version that
...
-   **[Backward Compatibility](atlas.en-us.api_console.meta/api_console/sforce_api_console_backward_compatibility.htm)**
    Salesforce strives to make backward compatibility easy when using the Salesforce Console Integration Toolkit.
-   **[End-of-Life](atlas.en-us.api_console.meta/api_console/sforce_api_console_end_life.htm)**
