...
lastCollected: 2026-05-10T00:40:42.853Z
estimatedTokens: 1731
keywords: [Workspace, Tabs, Subtabs, Lightning, Experience, console, app, displays, Salesforce, pages, tab, main, work, item, record, account, subtab, records, account’s, contacts, opportunities]
---
...
-   **[addToBrowserTitleQueue() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_addToBrowserTitleQueue.htm)**
...
-   **[getTabInfo() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_getTabInfo.htm)**
    Returns information about the specified tab. This method works only in Lightning console apps.
-   **[getTabURL() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_getTabURL.htm)**
...
-   **[isConsoleNavigation() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_isConsoleNavigation.htm)**
...
-   **[isSubtab() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_isSubtab.htm)**
...
-   **[openConsoleUrl() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_openConsoleURL.htm)**
...
-   **[openSubtab() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_openSubtab.htm)**
...
-   **[openTab() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_opentab.htm)**
    Opens a new workspace tab. If the tab is already open, the tab is focused.
-   **[refreshTab() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_refreshTab.htm)**
...
-   **[removeFromBrowserTitleQueue() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_removeFromBrowserTitleQueue.htm)**
...
-   **[setTabHighlighted() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_setTabHighlighted.htm)**
...
-   **[setTabIcon() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_setTabIcon.htm)**
    Sets the icon and alternative text of the specified tab. This method works only in Lightning console apps.
-   **[setTabLabel() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_setTabLabel.htm)**
