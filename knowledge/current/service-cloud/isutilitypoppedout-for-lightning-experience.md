---
title: "isUtilityPoppedOut() for Lightning Experience"
domain: service-cloud
topic: isutilitypoppedout-for-lightning-experience
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-04-07T07:53:53.849Z
estimatedTokens: 203
keywords: [isUtilityPoppedOut, Lightning, Experience, Determines, whether, utility, popped-out, state, isn’t, Web, Components, LWC, Arguments, Sample, Code]
---
...
To check if a utility is in a popped-out state with LWC, use [getInfo() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lwc_getInfo.htm "Returns the state of the current utility as a utilityInfo object. This method is available for Lightning Web Components (LWC) only.").
