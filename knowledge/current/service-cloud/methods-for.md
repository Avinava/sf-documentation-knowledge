...
lastCollected: 2026-03-12T05:14:58.121Z
estimatedTokens: 668
keywords: [org, Lightning, Experience, Console, JavaScript, API, methods.]
---

# Methods for

> If your org is using Lightning Experience,
  use Lightning Console JavaScript API methods.

# Methods for

If your org is using Lightning Experience, use Lightning Console JavaScript API methods.

-   **[Methods for Navigation Items in Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_methods_lightning_navigationItemAPI.htm)**
...
-   **[Methods for Workspace Tabs and Subtabs in Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_methods_lightning_workspaceAPI.htm)**
...
-   **[LWC Methods for Enhanced Messaging in Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_methods_enhanced_lightning_conversationtoolkitapi_lwc.htm)**
...
-   **[Aura Methods for Enhanced Messaging in Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_methods_enhanced_lightning_conversationToolkitAPI.htm)**
...
-   **[Methods for Chat in Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_methods_lightning_conversationToolkitAPI.htm)**
    Let customers chat with your agents on your web page.
-   **[Methods for Omni-Channel in Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_methods_lightning_omniToolkitAPI.htm)**
