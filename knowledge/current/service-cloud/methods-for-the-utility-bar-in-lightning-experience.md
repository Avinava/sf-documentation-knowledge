...
lastCollected: 2026-04-07T07:53:54.345Z
...
-   **[enableModal() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lwc_enableModal.htm)**
...
-   **[enablePopout() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lwc_enablePopout.htm)**
...
-   **[getAllUtilityInfo() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_getAllUtilityInfo.htm)**
    Returns the state of all utilities as an array of utilityInfo objects.
-   **[getEnclosingUtilityId() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_getEnclosingUtilityId.htm)**
...
-   **[getInfo() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lwc_getInfo.htm)**
...
-   **[getUtilityInfo() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_getUtilityInfo.htm)**
...
-   **[isUtilityPoppedOut() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_isUtilityPoppedOut.htm)**
    Determines whether the utility is in a popped-out state. This method isn’t supported for Lightning Web Components (LWC).
-   **[minimize() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lwc_minimize.htm)**
    Minimizes a utility. This method is available for Lightning Web Components (LWC) only.
-   **[minimizeUtility() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_minimizeItem.htm)**
    Minimizes a utility. This method isn’t supported for Lightning Web Components (LWC).
-   **[onUtilityClick() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_onUtilityClick.htm)**
    Registers an eventHandler for the utility. This eventHandler is called when the utility is clicked.
-   **[open() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lwc_open.htm)**
...
-   **[openUtility() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_openUtility.htm)**
...
-   **[setPanelHeaderIcon() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_setPanelHeaderIcon.htm)**
...
-   **[setPanelHeaderLabel() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_setPanelLabel.htm)**
...
-   **[setPanelHeight() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_setPanelHeight.htm)**
    Sets a utility panel’s height. This method isn’t supported for Lightning Web Components (LWC).
-   **[setPanelWidth() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_setPanelWidth.htm)**
    Sets a utility panel’s width. This method isn’t supported for Lightning Web Components (LWC).
-   **[setUtilityHighlighted() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_setUtilityHighlighted.htm)**
...
-   **[setUtilityIcon() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_setUtilityIcon.htm)**
...
-   **[setUtilityLabel() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_setUtilityLabel.htm)**
...
-   **[toggleModalMode() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lightning_toggleModalMode.htm)**
...
-   **[updatePanel() for Lightning Experience](atlas.en-us.api_console.meta/api_console/sforce_api_console_lwc_updatePanel.htm)**
