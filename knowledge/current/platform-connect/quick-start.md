...
> This simple quick start shows you how to get started with Canvas by using the Heroku
  ...
  Java or Ruby, depending on the template you select. At the same time, it creates a corresponding
...
You can also specify where to display the Canvas app in Salesforce using the Canvas plugin for the external client app.
