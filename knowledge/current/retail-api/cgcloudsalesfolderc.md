---
title: "cgcloud__Sales_Folder__c"
domain: retail-api
topic: cgcloudsalesfolderc
apiVersion: 67.0
...
| cgcloud__Note__c | TypetextareaPropertiesCreate, Nillable, UpdateDescriptionGeneral notes about the Sales Folder. |
...
| cgcloud__Sales_Folder_Template__c | TypereferencePropertiesCreate, Filter, Group, Nillable, Sort, UpdateDescriptionReference to the Sales Folder Template.This is a relationship field.Relationship Namecgcloud__Sales_Folder_Template__rRelationship TypeLookupRefers Tocgcloud__Sales_Folder_Template__c |
| cgcloud__Sales_Org__c | TypepicklistPropertiesCreate, Filter, Group, Nillable, Restricted picklist, Sort, UpdateDescriptionDescribes the sales org to which the sales folder belongs.Possible values are:0000000100020003 |
| cgcloud__Valid_From__c | TypedatePropertiesCreate, Filter, Group, Nillable, Sort, UpdateDescriptionFirst date of the validity period of the sales folder. |
| cgcloud__Valid_Thru__c | TypedatePropertiesCreate, Filter, Group, Nillable, Sort, UpdateDescriptionLast date of the validity period of the sales folder. |
...
[cgcloud\_\_Sales\_Folder\_\_cFeed](atlas.en-us.retail_api.meta/retail_api/sforce_api_associated_objects_feed.htm "StandardObjectNameFeed is the model for all feed objects associated with standard objects. These objects represent the posts and feed-tracked changes of a standard object.")
...
[cgcloud\_\_Sales\_Folder\_\_cShare](atlas.en-us.retail_api.meta/retail_api/sforce_api_associated_objects_share.htm "StandardObjectNameShare is the model for all share objects associated with standard objects. These objects represent a sharing entry on the standard object.")
...
- cgcloud__Sales_Folder__cChangeEvent (atlas.en-us.retail_api.meta/retail_api/sforce_api_associated_objects_change_event.htm)
- cgcloud__Sales_Folder__cFeed (atlas.en-us.retail_api.meta/retail_api/sforce_api_associated_objects_feed.htm)
- cgcloud__Sales_Folder__cHistory (atlas.en-us.retail_api.meta/retail_api/sforce_api_associated_objects_history.htm)
- cgcloud__Sales_Folder__cOwnerSharingRule (atlas.en-us.retail_api.meta/retail_api/sforce_api_associated_objects_ownersharingrule.htm)
- cgcloud__Sales_Folder__cShare (atlas.en-us.retail_api.meta/retail_api/sforce_api_associated_objects_share.htm)
