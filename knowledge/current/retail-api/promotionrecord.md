...
-   **[global Boolean isNew](atlas.en-us.retail_api.meta/retail_api/tpm_promotion.record.htm#unique_543068952)**
    Indicates if the record is new or already exists in the database.
-   **[global Id getId](atlas.en-us.retail_api.meta/retail_api/tpm_promotion.record.htm#unique_103973056)**
...
-   **[global SObject getOriginalRecord](atlas.en-us.retail_api.meta/retail_api/tpm_promotion.record.htm#unique_39811098)**
    Returns the original SObject record as stored in the database. If the record is new, this method returns null.
-   **[global SObject getRecord](atlas.en-us.retail_api.meta/retail_api/tpm_promotion.record.htm#unique_1116513170)**
    Returns the wrapped SObject record. The returned record field values can be updated.
-   **[global void setFields](atlas.en-us.retail_api.meta/retail_api/tpm_promotion.record.htm#unique_1156072556)**
...
-   **[global void setIsDeleted](atlas.en-us.retail_api.meta/retail_api/tpm_promotion.record.htm#unique_2079214786)**
    Sets the record to be deleted or to update the existing one.
-   **[global void setIsNew](atlas.en-us.retail_api.meta/retail_api/tpm_promotion.record.htm#unique_1227675042)**
