---
title: "Product Search Plugin"
domain: cpq-dev-api
topic: product-search-plugin
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:34:23.824Z
estimatedTokens: 225
...
> The Salesforce CPQ product search plugin is an interface that you can implement to
		...
		plugin methods vary slightly between Product Search and Guided Selling
		implementations.
...
-   **[Product Search Plugin - Product Search Interface](atlas.en-us.cpq_dev_api.meta/cpq_dev_api/cpq_ProductSearchPlugin_ProductSearch.htm)**
...
-   **[SBQQ.ProductSearchPlugin - Guided Selling Interface](atlas.en-us.cpq_dev_api.meta/cpq_dev_api/cpq_ProductSearchPlugin_GuidedSelling.htm)**
