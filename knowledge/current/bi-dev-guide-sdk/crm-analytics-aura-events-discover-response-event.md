---
title: "CRM Analytics Aura Events - Discover Response Event"
domain: bi-dev-guide-sdk
topic: crm-analytics-aura-events---discover-response-event
apiVersion: 67.0
...
Refer to the [wave:discover](atlas.en-us.bi_dev_guide_sdk.meta/bi_dev_guide_sdk/bi_sdk_web_example_discoverdashboard.htm#discoverDashboardExample) event for details and an example using wave:discoverResponse.
...
- wave:discover (atlas.en-us.bi_dev_guide_sdk.meta/bi_dev_guide_sdk/bi_sdk_web_example_discoverdashboard.htm)
