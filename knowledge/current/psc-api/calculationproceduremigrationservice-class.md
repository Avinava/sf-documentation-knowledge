...
lastCollected: 2026-03-12T09:35:29.461Z
estimatedTokens: 819
namespace: BusinessRule
keywords: [CalculationProcedureMigrationService, migrating, calculation, procedures, Vlocity, package, Business, Rules, Engine, expression, Usage, migrate, calcProcedureIds, calcProcedureId]
---
...
-   **[CalculationProcedureMigrationService Methods](atlas.en-us.psc_api.meta/psc_api/apex_class_BusinessRule_CalculationProcedureMigrationService.htm#apex_BusinessRule_CalculationProcedureMigrationService_methods)**
...
-   **[migrate(calcProcedureIds, namespace)](atlas.en-us.psc_api.meta/psc_api/apex_class_BusinessRule_CalculationProcedureMigrationService.htm#apex_BusinessRule_CalculationProcedureMigrationService_migrate)**
    Migrate calculation procedures from the Vlocity package as expression sets to the Business Rules Engine.
-   **[migrate(calcProcedureId, namespace)](atlas.en-us.psc_api.meta/psc_api/apex_class_BusinessRule_CalculationProcedureMigrationService.htm#apex_BusinessRule_CalculationProcedureMigrationService_migrate_2)**
...
- CalculationProcedureMigrationService Methods (atlas.en-us.psc_api.meta/psc_api/apex_class_BusinessRule_CalculationProcedureMigrationService.htm)
- migrate(calcProcedureIds, namespace) (atlas.en-us.psc_api.meta/psc_api/apex_class_BusinessRule_CalculationProcedureMigrationService.htm)
- migrate(calcProcedureId, namespace) (atlas.en-us.psc_api.meta/psc_api/apex_class_BusinessRule_CalculationProcedureMigrationService.htm)
