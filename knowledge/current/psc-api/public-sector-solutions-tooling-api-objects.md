---
title: "Public Sector Solutions Tooling API Objects"
domain: psc-api
topic: public-sector-solutions-tooling-api-objects
apiVersion: 67.0
...
-   **[ApplicationRecordTypeConfig](atlas.en-us.psc_api.meta/psc_api/tooling_api_objects_applicationrecordtypeconfig.htm)**
    Configuration that maps object record types to an application. This object is available in API version 50.0 and later.
