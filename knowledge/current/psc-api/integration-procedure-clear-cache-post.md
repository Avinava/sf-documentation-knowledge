...
lastCollected: 2026-03-12T09:35:30.555Z
estimatedTokens: 388
...
[Integration Procedure Cache Details](atlas.en-us.psc_api.meta/psc_api/connect_responses_integration_procedure_cache_output.htm "Output representation of the cache that are cleared for the specified integration procedures.")
...
- Integration Procedure Cache Keys (atlas.en-us.psc_api.meta/psc_api/connect_requests_integration_procedure_cache_keys_list.htm)
- Integration
                        Procedure Details (atlas.en-us.psc_api.meta/psc_api/connect_requests_integration_procedure_cache_input_data.htm)
- Integration Procedure
              Cache Details (atlas.en-us.psc_api.meta/psc_api/connect_responses_integration_procedure_cache_output.htm)
