...
lastCollected: 2026-03-12T09:35:32.691Z
...
The [Service Process](atlas.en-us.psc_api.meta/psc_api/connect_resources_service_process_create.htm "Create a service process.") POST payload has four top-level properties: attributes, caseInfo, documentInfo, and svcCatalogItemDefApiName. For the transaction dispute management process, certain attributes are mapped to specific objects:
...
After you assemble the payload, you’re ready to invoke the [Service Process](atlas.en-us.psc_api.meta/psc_api/connect_resources_service_process_create.htm "Create a service process.") resource using your favorite REST client. This resource creates all the object records related to a transaction dispute record and returns a response like this:
...
- Service Process (atlas.en-us.psc_api.meta/psc_api/connect_resources_service_process_create.htm)
