...
domain: psc-api
topic: simulation-config-input
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-04-07T18:39:01.529Z
estimatedTokens: 177
...
Input information of the configuration version to run a simulation.
...
- Simulation Version Info Input (atlas.en-us.psc_api.meta/psc_api/connect_requests_simulation_version_info_input.htm)
