...
lastCollected: 2026-04-07T18:39:03.484Z
estimatedTokens: 548
...
-   **[AssessmentQuestion](atlas.en-us.psc_api.meta/psc_api/meta_assessmentquestion.htm)**
    Represents the container object that stores the questions required for an assessment.
-   **[AssessmentQuestionSet](atlas.en-us.psc_api.meta/psc_api/meta_assessmentquestionset.htm)**
    Represents the container object for Assessment Questions.
-   **[DocumentCategory](atlas.en-us.psc_api.meta/psc_api/meta_documentcategory.htm)**
    Represents a document category.
-   **[DocumentCategoryDocumentType](atlas.en-us.psc_api.meta/psc_api/meta_documentcategorydocumenttype.htm)**
    Represents the junction between a DocumentCategory and a DocumentType. Puts a DocumentType in a DocumentCategory.
-   **[DocumentType](atlas.en-us.psc_api.meta/psc_api/meta_documenttype.htm)**
    Represents a document type.
-   **[OmniScript](atlas.en-us.psc_api.meta/psc_api/meta_omniscript.htm)**
...
-   **[Supported Metadata Channels](atlas.en-us.psc_api.meta/psc_api/discovery_framework_channels.htm)**
...
-   **[Flow for Discovery Framework](atlas.en-us.psc_api.meta/psc_api/discovery_framework_flow_metadata_api.htm)**
