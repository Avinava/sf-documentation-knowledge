...
lastCollected: 2026-03-12T09:35:30.407Z
estimatedTokens: 433
...
[Decision Table Rows List](atlas.en-us.psc_api.meta/psc_api/connect_responses_decision_table_rows_list_output.htm "Output representation of the rows in relation to the decision table, including current state of pagination.")
...
[Decision Table Data](atlas.en-us.psc_api.meta/psc_api/connect_responses_decision_table_data_output.htm "Output representation of the status of an action performed.")
...
- Decision Table Rows List (atlas.en-us.psc_api.meta/psc_api/connect_responses_decision_table_rows_list_output.htm)
- Decision Table Row Input (atlas.en-us.psc_api.meta/psc_api/connect_requests_decision_table_row_list_input.htm)
- Decision Table Data (atlas.en-us.psc_api.meta/psc_api/connect_responses_decision_table_data_output.htm)
