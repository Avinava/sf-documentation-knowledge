...
lastCollected: 2026-03-12T09:35:32.635Z
estimatedTokens: 536
...
-   **[RecAlrtDataSrcExpSetDef](atlas.en-us.psc_api.meta/psc_api/sforce_api_objects_recalrtdatasrcexpsetdef.htm)**
...
-   **[RecordAlert](atlas.en-us.psc_api.meta/psc_api/sforce_api_objects_recordalert.htm)**
...
-   **[RecordAlertActionableTarget](atlas.en-us.psc_api.meta/psc_api/sforce_api_objects_recordalertactionabletarget.htm)**
    Represents the action associated with the parent record alert. This object is available in API version 63.0 and later.
-   **[RecordAlertCategory](atlas.en-us.psc_api.meta/psc_api/sforce_api_objects_recordalertcategory.htm)**
    Represents a category to group and present record alerts. This object is available in API version 54.0 and later.
-   **[RecordAlertCategoryLocalization](atlas.en-us.psc_api.meta/psc_api/sforce_api_objects_recordalertcategorylocalization.htm)**
...
-   **[RecordAlertDataSource](atlas.en-us.psc_api.meta/psc_api/sforce_api_objects_recordalertdatasource.htm)**
    Represents an internal or external source for record alert data. This object is available in API version 54.0 and later.
-   **[RecordAlertDataTranslation](atlas.en-us.psc_api.meta/psc_api/sforce_api_objects_recordalertdatatranslation.htm)**
...
-   **[RecordAlertTemplate](atlas.en-us.psc_api.meta/psc_api/sforce_api_objects_recordalerttemplate.htm)**
