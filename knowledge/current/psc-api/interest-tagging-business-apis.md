...
lastCollected: 2026-04-07T18:39:04.241Z
estimatedTokens: 632
...
-   **[REST Reference](atlas.en-us.psc_api.meta/psc_api/interest_tagging_apis_rest_references.htm)**
    You can access Interest Tags APIs using REST endpoints. These REST APIs follow similar conventions as Connect REST APIs.

## Related Topics

- /connect/interest-tags/tags (atlas.en-us.psc_api.meta/psc_api/connect_resources_delete_get_create_tags.htm)
- /connect/interest-tags/tags/${tagId} (atlas.en-us.psc_api.meta/psc_api/connect_resources_update_tags.htm)
- /connect/interest-tags/tags?tagId=tagId1 (atlas.en-us.psc_api.meta/psc_api/connect_resources_delete_get_create_tags.htm)
- /connect/interest-tags/categories (atlas.en-us.psc_api.meta/psc_api/connect_resources_get_tag-categories.htm)
- /connect/interest-tags/assignments/tag/${tagId} (atlas.en-us.psc_api.meta/psc_api/connect_resources_get_record_assignments_for_tag.htm)
- /connect/interest-tags/tags?categoryId={categoryId} (atlas.en-us.psc_api.meta/psc_api/connect_resources_delete_get_create_tags.htm)
- /connect/interest-tags/assignments/entity/${recordId} (atlas.en-us.psc_api.meta/psc_api/connect_resources_get_tags_assigned_to_entity.htm)
- /connect/interest-tags/assignments (atlas.en-us.psc_api.meta/psc_api/connect_resources_post_record_assignments_for_tag.htm)
- REST Reference (atlas.en-us.psc_api.meta/psc_api/interest_tagging_apis_rest_references.htm)
