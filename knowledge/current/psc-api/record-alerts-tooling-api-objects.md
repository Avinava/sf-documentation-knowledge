...
-   **[RecordAlertCategory](atlas.en-us.psc_api.meta/psc_api/tooling_api_objects_recordalertcategory.htm)**
    Represents a category to group and present record alerts. This object is available in API version 54.0 and later.
-   **[RecordAlertDataSource](atlas.en-us.psc_api.meta/psc_api/tooling_api_objects_recordalertdatasource.htm)**
