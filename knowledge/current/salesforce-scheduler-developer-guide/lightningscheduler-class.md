...
lastCollected: 2026-04-07T18:39:19.824Z
estimatedTokens: 1189
namespace: ConnectApi
keywords: [LightningScheduler, service, appointments, createServiceAppointment, createServiceAppointmentInput, API, Requires, Chatter, updateServiceAppointment, updateServiceAppointmentInput]
---
...
-   **[createServiceAppointment(createServiceAppointmentInput)](atlas.en-us.salesforce_scheduler_developer_guide.meta/salesforce_scheduler_developer_guide/apex_ConnectAPI_LightningScheduler_static_methods.htm#apex_ConnectAPI_LightningScheduler_createServiceAppointment_2)**
    Create a service appointment.
-   **[updateServiceAppointment(updateServiceAppointmentInput)](atlas.en-us.salesforce_scheduler_developer_guide.meta/salesforce_scheduler_developer_guide/apex_ConnectAPI_LightningScheduler_static_methods.htm#apex_ConnectAPI_LightningScheduler_updateServiceAppointment_1)**
...
Type: [ConnectApi.CreateServiceAppointmentInput](atlas.en-us.salesforce_scheduler_developer_guide.meta/salesforce_scheduler_developer_guide/apex_connectapi_input_create_service_appointment.htm "Contains information to create a service appointment.")

Input parameters to create a service appointment.

#### Return Value

Type: [ConnectApi.ServiceAppointmentOutput](atlas.en-us.salesforce_scheduler_developer_guide.meta/salesforce_scheduler_developer_guide/apex_connectapi_output_service_appointment_output.htm "Output of the create service appointment request.")
...
- createServiceAppointment(createServiceAppointmentInput) (atlas.en-us.salesforce_scheduler_developer_guide.meta/salesforce_scheduler_developer_guide/apex_ConnectAPI_LightningScheduler_static_methods.htm)
- updateServiceAppointment(updateServiceAppointmentInput) (atlas.en-us.salesforce_scheduler_developer_guide.meta/salesforce_scheduler_developer_guide/apex_ConnectAPI_LightningScheduler_static_methods.htm)
- ConnectApi.CreateServiceAppointmentInput (atlas.en-us.salesforce_scheduler_developer_guide.meta/salesforce_scheduler_developer_guide/apex_connectapi_input_create_service_appointment.htm)
- ConnectApi.ServiceAppointmentOutput (atlas.en-us.salesforce_scheduler_developer_guide.meta/salesforce_scheduler_developer_guide/apex_connectapi_output_service_appointment_output.htm)
