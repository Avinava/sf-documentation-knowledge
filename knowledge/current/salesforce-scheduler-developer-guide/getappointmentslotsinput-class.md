---
title: "GetAppointmentSlotsInput Class"
domain: salesforce-scheduler-developer-guide
topic: getappointmentslotsinput-class
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-04-07T18:39:19.859Z
estimatedTokens: 1036
namespace: LxScheduler
keywords: [GetAppointmentSlotsInput, appointment, time, slots, resource, work, group, territories]
---

> Contains information about the available appointment time slots for a
      resource based on given work type group and territories.
...
The constructor for this class can’t be called directly. Create an instance of this class using the [GetAppointmentSlotsInputBuilder.build()](atlas.en-us.salesforce_scheduler_developer_guide.meta/salesforce_scheduler_developer_guide/apex_class_lxscheduler_GetAppointmentSlotsInputBuilder.htm#apex_lxscheduler_GetAppointmentSlotsInputBuilder_build "Returns an instance of the lxscheduler.GetAppointmentSlotsInput object.") method.
...
- GetAppointmentSlotsInputBuilder.build() (atlas.en-us.salesforce_scheduler_developer_guide.meta/salesforce_scheduler_developer_guide/apex_class_lxscheduler_GetAppointmentSlotsInputBuilder.htm)
