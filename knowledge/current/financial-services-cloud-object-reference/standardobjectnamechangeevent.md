...
lastCollected: 2026-03-12T09:34:29.236Z
...
Change events are available for all custom objects and a subset of standard objects. Change events that correspond to custom settings are partially supported. They aren't supported in Apex triggers but are supported in other types of subscribers.
...
The following object has associated ChangeEvent objects.
...
-   FinancialAccountBalanceChangeEvent
-   FinancialAccountChangeEvent
-   FinancialAccountFeeChangeEvent
-   FinancialAccountPartyChangeEvent
-   FinancialAccountStatementChangeEvent
-   FinancialAccountTransactionChangeEvent
-   FinancialGoal
