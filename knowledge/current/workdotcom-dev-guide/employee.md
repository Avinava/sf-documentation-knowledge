...
lastCollected: 2026-04-07T18:40:13.832Z
estimatedTokens: 2847
keywords: [Employee, company, organization, API, 48.0, 49.0, supports, reports, criteria-based, sharing, plus, exclude, individual, layouts, Work.com, uses, standard, track, users, students, volunteers, roles, addition, employees, managed, packages, install]
---
...
-   [Employee Custom Fields](atlas.en-us.workdotcom_dev_guide.meta/workdotcom_dev_guide/wdc_cc_sforce_api_objects_employee.htm "Work.com uses the Employee standard object to track information about users who are students, volunteers, and other roles in addition to employees. Some managed packages also install custom fields for the Employee standard object.")

## Related Topics

- Employee Custom Fields (atlas.en-us.workdotcom_dev_guide.meta/workdotcom_dev_guide/wdc_cc_sforce_api_objects_employee.htm)
