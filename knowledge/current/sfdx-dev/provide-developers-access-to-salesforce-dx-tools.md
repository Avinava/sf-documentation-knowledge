---
title: "Provide Developers Access to Salesforce DX Tools"
domain: sfdx-dev
topic: provide-developers-access-to-salesforce-dx-tools
apiVersion: 67.0
...
Prepare your development team with the license, user access, and user permissions they need. Determine which org to use as your Dev Hub org, and enable the Dev Hub setting in that org.

-   **[Select and Enable a Dev Hub Org](atlas.en-us.sfdx_dev.meta/sfdx_dev/sfdx_setup_enable_devhub.htm)**
...
-   **[Enable Source Tracking in Sandboxes](atlas.en-us.sfdx_dev.meta/sfdx_dev/sfdx_setup_enable_source_tracking_sandboxes.htm)**
