...
lastCollected: 2026-03-12T09:36:18.979Z
estimatedTokens: 379
...
> If your users only require access to the Dev Hub, the Salesforce Limited Access -
		...
		by request. After this license is provisioned add a user with this license and the Limited
		Access user profile, and then create and assign them a permission set to the required Dev
		Hub objects.
