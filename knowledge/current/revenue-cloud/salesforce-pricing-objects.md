...
topic: salesforce-pricing-objects
apiVersion: 67.0
release: summer-26-v67
docType: help-article
lastCollected: 2026-07-26T01:59:44.840Z
estimatedTokens: 1423
keywords: [Salesforce, Pricing, deployment, sequence, API, lookup, translation, requirements, Revenue, Management]
---
...
| --- | --- | --- | --- | --- |
| Configuration | Product Selling ModelTranslation table: Product Selling Model Data Translation | ProductSellingModelTranslation table: ProductSelling​ModelData​Translation | 1 |  |
| Configuration | Product Selling Model OptionTranslation table: Product Selling Model Option Data Translation | ProductSellingModelOptionTranslation table: ProductSelling​ModelOption​Data​Translation | 2 | ProductSellingModel (Master-Detail), Product2 (Foreign key), ProrationPolicy (Foreign key) |
