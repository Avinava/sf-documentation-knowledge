...
lastCollected: 2026-07-26T01:59:47.130Z
estimatedTokens: 502
...
| IsInternal | TypebooleanPropertiesDefaulted on create, Filter, Group, SortDescriptionIndicates if the price recipe field mapping record is created internally by the platform (true) or not (false).The default value is false. |
