...
lastCollected: 2026-07-26T01:59:45.059Z
estimatedTokens: 501
...
| IsInternal | TypebooleanPropertiesCreate, Defaulted on create, Filter, Group, SortDescriptionIndicates if the procedure output resolution record is created internally by the platform (true) or not (false).The default value is false. |
