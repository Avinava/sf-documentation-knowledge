...
topic: new-sale-transaction-with-ramped-products
apiVersion: 67.0
release: summer-26-v67
docType: concept
lastCollected: 2026-04-07T18:35:42.807Z
estimatedTokens: 3652
keywords: [Considerations, New, Sale, Transaction, Ramped, Products, Understand, key, billing, schedule]
---
...
-   For new sale transactions with a ramped product, the RampIdentifier\_\_std value is required.
...
-   The billing schedules for transactions with the same RampIdentifier\_\_std value are created for the same billing schedule group.
