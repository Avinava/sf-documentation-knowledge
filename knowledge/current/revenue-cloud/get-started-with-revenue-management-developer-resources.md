...
topic: get-started-with-revenue-management-developer-resources
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-07-26T01:59:45.910Z
estimatedTokens: 4250
keywords: [Billing, Started, Revenue, Management, Developer, Resources, unified, system, automate, CRM, processes, sources, backend, work, support, end-to-end, solution, Product, Catalog, Salesforce, Pricing, Configurator, Transaction, Rate, Dynamic, Orchestrator]
---
...
See the [RevenueManagementSettings](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/meta_revenuemanagementsettings.htm "Represents the configuration settings to set up Revenue Management.") metadata type to set up Revenue Management through configuration settings.
