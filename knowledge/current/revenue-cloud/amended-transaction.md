...
topic: amended-transaction
apiVersion: 67.0
release: summer-26-v67
docType: concept
lastCollected: 2026-04-07T18:35:42.695Z
estimatedTokens: 3036
keywords: [Considerations, Amended, Transaction, Understand, key, billing, schedule]
---

> Understand the required values and key considerations before you create a billing
    schedule for an amended transaction.
...
| BillingActionType__std | The action that you want to perform for the transaction. Valid values are:AddAmendRenewCancelSpecify Amend as the BillingActionType for amended transactions. | Category field on the BillingSchedule object is populated as AmendQuantity. | Required |
...
-   The BillingActionType\_\_std value for any amended transaction must be Amend.
