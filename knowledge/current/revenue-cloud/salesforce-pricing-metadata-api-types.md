---
title: "Salesforce Pricing Metadata API Types"
domain: revenue-cloud
topic: salesforce-pricing-metadata-api-types
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:33:10.338Z
estimatedTokens: 479
keywords: [Salesforce, Pricing, Metadata, API, access, feature, settings, customize, user]
---
...
-   **[Flow for Salesforce Pricing](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/pricing_flow_metadata_api.htm)**
...
-   **[IndustriesPricingSettings](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/meta_industriespricingsettings.htm)**
    Represents the settings for Salesforce Pricing.
-   **[PricingActionParameters](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/meta_pricingactionparameters.htm)**
    Represents the pricing action that's associated with a context definition and pricing procedure.
-   **[PricingRecipe](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/meta_pricingrecipe.htm)**
...
-   **[ProcedureOutputResolution](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/meta_procedureoutputresolution.htm)**
