...
lastCollected: 2026-04-05T00:23:13.408Z
...
-   **[TaxEngineContext Constructors](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm#apex_commercetax_TaxEngineContext_constructors)**
    Learn more about the available constructors with the TaxEngineContext class.
-   **[TaxEngineContext Methods](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm#apex_commercetax_TaxEngineContext_methods)**
...
-   **[TaxEngineContext(request, requestType, namedUri)](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm#apex_commercetax_TaxEngineContext_ctor)**
...
Type: [RequestType](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_enum_commercetax_RequestType.htm "Shows the type of tax request made to the tax engine.")
...
-   **[getNamedUri()](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm#apex_commercetax_TaxEngineContext_getNamedUri)**
    Retrieves the value of the NamedUri field of the TaxEngineContext class.
-   **[getRequest()](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm#apex_commercetax_TaxEngineContext_getRequest)**
    Gets the value of the TaxEngineContext's Request field.
-   **[getRequestType()](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm#apex_commercetax_TaxEngineContext_getRequestType)**
...
- TaxEngineContext Constructors (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm)
- TaxEngineContext Methods (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm)
- TaxEngineContext(request, requestType, namedUri) (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm)
- RequestType (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_enum_commercetax_RequestType.htm)
- getNamedUri() (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm)
- getRequest() (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm)
- getRequestType() (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_class_commercetax_TaxEngineContext.htm)
