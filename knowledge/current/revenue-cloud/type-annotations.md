...
lastCollected: 2026-06-07T00:37:37.194Z
estimatedTokens: 914
...
| groupBy | Variable name | Used with virtual = true, the groupBy annotation organizes child products—the individual instances populating a relationship—into virtual containers based on a shared attribute value.See Relationships and the Grouping Generators by Voltage example. |
...
- Grouping Generators by Voltage example (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/cml_core_concept_examples.htm)
- Group
                  Type (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/cml_group_type.htm)
...
- Sharing Accessories in a Generator Set
