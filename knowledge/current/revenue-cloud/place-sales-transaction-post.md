...
lastCollected: 2026-03-12T05:14:07.037Z
estimatedTokens: 1718
keywords: [Place, Sales, Transaction, POST, Create, sales, transaction, such, order, quote, integrated, pricing, configuration., Additionally, update, insert, delete, line, items, calculate]
---
...
[Place Sales Transaction](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/connect_responses_place_sales_transaction_output.htm "Output representation of the request to create a sales transaction.")
...
- Place Sales
              Transaction (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/connect_responses_place_sales_transaction_output.htm)
