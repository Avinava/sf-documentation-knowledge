...
lastCollected: 2026-03-12T05:14:05.292Z
estimatedTokens: 1133
namespace: CommerceTax
keywords: [TaxEngineAdapter, processRequest, takes, instance, TaxEngineContext, response, calculated, tax, details, through, TaxDetailsResponse, error, ErrorResponse, class., requestType, Example, Implementation, Usage, Retrieves, evaluates]
---
...
-   **[TaxEngineAdapter Methods](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_interface_commercetax_TaxEngineAdapter.htm#apex_commercetax_TaxEngineAdapter_methods)**
...
-   **[processRequest(requestType)](atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_interface_commercetax_TaxEngineAdapter.htm#apex_commercetax_TaxEngineAdapter_processRequest)**
...
- commercetax (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_namespace_commercetax.htm)
- TaxEngineAdapter Methods (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/apex_commercetax_TaxEngineAdapter_methods.htm)
- TaxEngineAdapter Example Implementation (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/billing_apex_interface_TaxEngineAdapter_Example.htm)
- Tax Mappings for Invoices and Credits (atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/billing_tax_contract_mappings_for_invoices_and_credits.htm)
