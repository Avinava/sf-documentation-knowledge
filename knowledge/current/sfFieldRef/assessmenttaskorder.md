...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see AssessmentTaskOrder in the Consumer Goods Cloud Developer Guide.
...
| Id | Assessment Task Order ID | id |  | 18 |  |  |
