...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [PresenceDeclineReason](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_presencedeclinereason.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Presence Decline Reason ID | id |  | 18 |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| Language | Master Language | picklist |  | 40 |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| MasterLabel | Presence Decline Reason Name | string |  | 80 |  |  |
