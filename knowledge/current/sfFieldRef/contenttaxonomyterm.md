...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [ContentTaxonomyTerm](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_contenttaxonomyterm.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Content Taxonomy Term ID | id |  | 18 |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| Name | Content Taxonomy Term Name | string |  | 255 |  |  |
