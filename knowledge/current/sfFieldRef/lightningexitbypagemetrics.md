...
lastCollected: 2026-04-07T18:39:46.200Z
estimatedTokens: 259
keywords: [LightningExitByPageMetrics, frequency, metrics, standard, pages, users, switched, Lightning, Experience, Salesforce, Classic, API, 44.0]
---
...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [LightningExitByPageMetrics](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_lightningexitbypagemetrics.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.

## Fields

| Field Name | Field Label | Type | Digits | Length | Precision | Scale |
| --- | --- | --- | --- | --- | --- | --- |
| Id | Lightning Exit By Page Metrics ID | id |  | 18 |  |  |
