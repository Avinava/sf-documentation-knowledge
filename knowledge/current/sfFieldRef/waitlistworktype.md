...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see WaitlistWorkType in the Salesforce Scheduler Developer Guide.
...
| Id | Waitlist Work Type ID | id |  | 18 |  |  |
