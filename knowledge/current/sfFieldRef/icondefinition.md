...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [IconDefinition](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_icondefinition.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.

## Fields

| Field Name | Field Label | Type | Digits | Length | Precision | Scale |
| --- | --- | --- | --- | --- | --- | --- |
| ContentType | Content Type | string |  | 255 |  |  |
| DurableId | Icon Definition Durable ID | string |  | 255 |  |  |
| Height | Height | int | 9 |  |  |  |
| Id | Icon Definition ID | id |  | 18 |  |  |
