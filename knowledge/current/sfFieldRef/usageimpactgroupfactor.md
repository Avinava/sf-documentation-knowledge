...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [UsageImpactGroupFactor](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_usageimpactgroupfactor.htm "HTML (New Window)") in the Energy and Utilities Cloud Developer Guide and Object Reference for the Salesforce Platform.
...
| FactorValue | FactorValue | double |  |  | 18 | 0 |
| Id | Usage Impact Group Factor ID | id |  | 18 |  |  |
...
| UsageImpactFactorId | Usage Impact Factor ID | reference |  | 18 |  |  |
