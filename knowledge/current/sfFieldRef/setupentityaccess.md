...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [SetupEntityAccess](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_setupentityaccess.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.

## Fields

| Field Name | Field Label | Type | Digits | Length | Precision | Scale |
| --- | --- | --- | --- | --- | --- | --- |
| Id | SetupEntityAccess ID | id |  | 18 |  |  |
| ParentId | Parent ID | reference |  | 18 |  |  |
| SetupEntityId | Setup Entity ID | reference |  | 18 |  |  |
| SetupEntityType | Setup Entity Type | picklist |  | 40 |  |  |
