...
lastCollected: 2026-03-12T09:36:09.863Z
estimatedTokens: 335
keywords: [ProductServiceCampaignItemStatus, status, product, service, campaign, item, API, version, 51.0, later]
---
...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [ProductServiceCampaignItemStatus](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_productservicecampaignitemstatus.htm "HTML (New Window)") in the Field Service Developer Guide and Object Reference for the Salesforce Platform.
...
| Id | Product Service Campaign Item Status ID | id |  | 18 |  |  |
