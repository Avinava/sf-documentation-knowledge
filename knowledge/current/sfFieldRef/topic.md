...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [Topic](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_topic.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Topic ID | id |  | 18 |  |  |
| ManagedTopicType | Enabled For | string |  | 99 |  |  |
| Name | Name | string |  | 99 |  |  |
| SystemModstamp | System Modstamp | datetime |  |  |  |  |
| TalkingAbout | Talking About | int | 9 |  |  |  |
