...
lastCollected: 2026-03-12T09:35:51.935Z
estimatedTokens: 348
...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see CareProgramEnrollmentCard in the Life Sciences Cloud Developer Guide.

## Fields

| Field Name | Field Label | Type | Digits | Length | Precision | Scale |
| --- | --- | --- | --- | --- | --- | --- |
| CardNumber | Card Number | string |  | 255 |  |  |
| CareProgramEnrolleeId | Care Program Enrollee ID | reference |  | 18 |  |  |
| CreatedById | Created By ID | reference |  | 18 |  |  |
| CreatedDate | Created Date | datetime |  |  |  |  |
| Id | Care Program Enrollment Card ID | id |  | 18 |  |  |
