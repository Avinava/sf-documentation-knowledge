...
Represents the details of the mapping between the document and the Salesforce object using Einstein Form Reader.

For more information, see OcrTemplate in the Salesforce Health Cloud Developer Guide.
