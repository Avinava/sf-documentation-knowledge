...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [CustomBrand](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_custombrand.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Custom Brand ID | id |  | 18 |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Modified Date | datetime |  |  |  |  |
| ParentId | Branded Entity ID | reference |  | 18 |  |  |
