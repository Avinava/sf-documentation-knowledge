...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [ProductSellingModelOption](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_productsellingmodeloption.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform and Salesforce Pricing Guide.
...
| Id | Product Selling Model Option ID | id |  | 18 |  |  |
...
| Name | Product Selling Model Option Name | string |  | 255 |  |  |
| Product2Id | Product ID | reference |  | 18 |  |  |
| ProductSellingModelId | Product Selling Model ID | reference |  | 18 |  |  |
| ProrationPolicyId | Proration Policy ID | reference |  | 18 |  |  |
