...
lastCollected: 2026-04-07T09:05:46.461Z
estimatedTokens: 301
keywords: [FlowTestView, flow, test, associated, definition, API, version, 55.0, later]
---
...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [FlowTestView](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_flowtestview.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| FlowTestApiName | Flow Test API Name | string |  | 255 |  |  |
| FlowTestLabel | Flow Test Label | string |  | 255 |  |  |
| Id | Flow Test View ID | id |  | 18 |  |  |
