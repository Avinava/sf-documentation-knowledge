...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see OmniSupervisorConfigSkill in the Omnistudio Guide.
...
| Id | Omni Supervisor Configuration Skill ID | id |  | 18 |  |  |
