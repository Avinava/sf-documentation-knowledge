...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [UsageImpactGroup](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_usageimpactgroup.htm "HTML (New Window)") in the Energy and Utilities Cloud Developer Guide and Object Reference for the Salesforce Platform.
...
| Id | Usage Impact Group ID | id |  | 18 |  |  |
