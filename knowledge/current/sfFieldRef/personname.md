...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see PersonName in the Salesforce Health Cloud Developer Guide.
...
| NameUsageType | Name Usage Type | picklist |  | 40 |  |  |
