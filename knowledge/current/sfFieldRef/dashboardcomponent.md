...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [DashboardComponent](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_dashboardcomponent.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.

## Fields

| Field Name | Field Label | Type | Digits | Length | Precision | Scale |
| --- | --- | --- | --- | --- | --- | --- |
| CustomReportId | Report ID | reference |  | 18 |  |  |
| DashboardId | Dashboard ID | reference |  | 18 |  |  |
| Id | Dashboard Component ID | id |  | 18 |  |  |
| Name | Dashboard Component Name | string |  | 80 |  |  |
