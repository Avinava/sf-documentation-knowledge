...
lastCollected: 2026-04-07T09:06:09.884Z
estimatedTokens: 385
keywords: [UsageImpactFactor, collection, Usage, Impact, Factors, across, jurisdictions, programs.This, API, version, 58.0, later]
---
...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [UsageImpactFactor](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_usageimpactfactor.htm "HTML (New Window)") in the Energy and Utilities Cloud Developer Guide and Object Reference for the Salesforce Platform.
...
| Id | Usage Impact Factor ID | id |  | 18 |  |  |
...
| ShortForm | Short Form | string |  | 255 |  |  |
