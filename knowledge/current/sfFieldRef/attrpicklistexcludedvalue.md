...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see AttrPicklistExcludedValue in the Product Catalog Management Guide.

## Fields

| Field Name | Field Label | Type | Digits | Length | Precision | Scale |
| --- | --- | --- | --- | --- | --- | --- |
| AttributeId | Attribute ID | reference |  | 18 |  |  |
| AttributePicklistValueId | Attribute Picklist Value ID | reference |  | 18 |  |  |
| CreatedById | Created By ID | reference |  | 18 |  |  |
| CreatedDate | Created Date | datetime |  |  |  |  |
| Id | Attribute Picklist Excluded Value ID | id |  | 18 |  |  |
