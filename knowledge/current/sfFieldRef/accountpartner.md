...
lastCollected: 2026-03-12T09:35:46.008Z
estimatedTokens: 402
keywords: [AccountPartner, partner, relationship, two, Account, records, record, created, automatically, accounts, opportunity’s, opportunity]
---
...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [AccountPartner](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_accountpartner.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.

## Fields

| Field Name | Field Label | Type | Digits | Length | Precision | Scale |
| --- | --- | --- | --- | --- | --- | --- |
| AccountFromId | Account ID | reference |  | 18 |  |  |
| AccountToId | Account ID | reference |  | 18 |  |  |
| CreatedById | Created By ID | reference |  | 18 |  |  |
| CreatedDate | Created Date | datetime |  |  |  |  |
| Id | Account Partner ID | id |  | 18 |  |  |
