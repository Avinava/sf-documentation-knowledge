...
lastCollected: 2026-04-07T18:39:30.134Z
estimatedTokens: 369
namespace: NamespacePrefix
keywords: [BriefcaseDefinition, briefcase, definition, selected, records, users, view, they’re, offline, Salesforce, Service, mobile, app, iOS, Android, API, 50.0]
---
...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [BriefcaseDefinition](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_briefcasedefinition.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Briefcase Definition ID | id |  | 18 |  |  |
