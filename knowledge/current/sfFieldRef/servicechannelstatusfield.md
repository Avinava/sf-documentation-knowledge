...
Represents the values that you use to indicate completed and in-progress work item status for the status field in the Status-Based Capacity routing model.

For more information, see ServiceChannelStatusField in the Object Reference for the Salesforce Platform.
...
| Id | Service Channel Status Field ID | id |  | 18 |  |  |
