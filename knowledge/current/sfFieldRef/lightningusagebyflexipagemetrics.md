...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [LightningUsageByFlexiPageMetrics](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_lightningusagebyflexipagemetrics.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| FlexiPageNameOrId | FlexiPage Name Or Id | string |  | 40 |  |  |
| FlexiPageType | FlexiPage Type | string |  | 40 |  |  |
| Id | Lightning Usage By FlexiPage Metrics ID | id |  | 18 |  |  |
| MedianEPT | Median EPT | int | 9 |  |  |  |
