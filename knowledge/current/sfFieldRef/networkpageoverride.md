...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [NetworkPageOverride](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_networkpageoverride.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Experience Page Override Id | id |  | 18 |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| NetworkId | Network ID | reference |  | 18 |  |  |
| OverrideSetting | Page Override Setting | picklist |  | 255 |  |  |
| OverrideType | Page Override Type | picklist |  | 255 |  |  |
