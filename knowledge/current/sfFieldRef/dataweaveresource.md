...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [DataWeaveResource](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_dataweaveresource.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| BodyLength | Body Length | int | 9 |  |  |  |
| ContentType | Content Type | picklist |  | 255 |  |  |
| CreatedById | Created By ID | reference |  | 18 |  |  |
| CreatedDate | Created Date | datetime |  |  |  |  |
| DeveloperName | Name | string |  | 80 |  |  |
| Id | DataWeave Resource ID | id |  | 18 |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| IsGlobal | Is Global | boolean |  |  |  |  |
