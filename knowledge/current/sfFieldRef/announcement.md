...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [Announcement](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_announcement.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Announcement ID | id |  | 18 |  |  |
| IsArchived | Is Announcement Archived | boolean |  |  |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| ParentId | Parent ID | reference |  | 18 |  |  |
| SendEmails | Send Emails on Announcement | boolean |  |  |  |  |
