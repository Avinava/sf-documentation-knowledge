...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [CollaborationGroupMemberRequest](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_collaborationgroupmemberrequest.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Group Member Request Id | id |  | 18 |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| RequesterId | User ID | reference |  | 18 |  |  |
| ResponseMessage | Response Message | string |  | 255 |  |  |
