...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [EmailTemplateMonthlyMetric](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_EmailTemplateMonthlyMetric.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Email Template Monthly Metric ID | id |  | 18 |  |  |
