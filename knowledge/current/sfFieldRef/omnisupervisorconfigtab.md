...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see OmniSupervisorConfigTab in the Omnistudio Guide.
...
| Id | Omni Supervisor Configuration Tab ID | id |  | 18 |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| OmniSupervisorConfigId | Omni Supervisor Configuration ID | reference |  | 18 |  |  |
| OmniSupervisorTabType | Omni Supervisor Tab Type | picklist |  | 255 |  |  |
