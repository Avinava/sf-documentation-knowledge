...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [SharingRecordCollectionItem](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_sharingrecordcollectionitem.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Record Collection Item ID | id |  | 18 |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| ItemId | Item ID | reference |  | 18 |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| Name | Record Collection Item Name | string |  | 255 |  |  |
