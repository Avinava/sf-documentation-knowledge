...
Represents information about the periods for which advanced account forecasting is applied.

For more information, see AdvAccountForecastPeriod in the Manufacturing Cloud Developer Guide.
...
| DisplayDuration | Display Duration | int | 9 |  |  |  |
| ForecastPeriodGroupId | Advanced Account Forecast Period Group ID | reference |  | 18 |  |  |
| Id | Advanced Account Forecast Period ID | id |  | 18 |  |  |
