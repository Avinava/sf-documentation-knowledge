...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [PaymentTermItem](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_paymenttermitem.htm "HTML (New Window)") in the Billing Guide and Object Reference for the Salesforce Platform.
...
| PaymentTimeframe | Payment Timeframe | picklist |  | 255 |  |  |
| Period | Period | int | 9 |  |  |  |
| PeriodUnit | Period Unit | picklist |  | 255 |  |  |
