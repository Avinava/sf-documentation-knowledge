...
Represents a relationship between an OCR template and an OCR sample document.

For more information, see OcrTemplateSampleDocument in the Salesforce Health Cloud Developer Guide.
...
| Id | OCR Template Sample Document ID | id |  | 18 |  |  |
