...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see RetrievalSummaryDefObject in the Financial Services Cloud Developer Guide.
...
| Id | Retrieval Summary Definition Object ID | id |  | 18 |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| RecordAggregationDefinitionId | Record Aggregation Definition ID | reference |  | 18 |  |  |
| RetrievalSummaryDefinitionId | Retrieval Summary Definition ID | reference |  | 18 |  |  |
