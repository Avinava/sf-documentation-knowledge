...
lastCollected: 2026-03-12T09:35:53.838Z
estimatedTokens: 940
keywords: [ContactDailyMetric, daily, engagement, metrics, contact]
---

# ContactDailyMetric

> Represents the daily engagement metrics for a contact.

# ContactDailyMetric

Represents the daily engagement metrics for a contact.

This guide only lists certain information for each object. For more information, including descriptions of the fields, see [ContactDailyMetric](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_ContactDailyMetric.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| AllEmailsDeliveredRate | All Emails Delivered Rate | percent |  |  | 5 | 2 |
...
| DailyCutOffTimeStamp | Daily Cutoff Time | datetime |  |  |  |  |
| Date | Date | date |  |  |  |  |
| DateInt | Date Int | int | 9 |  |  |  |
| HardBounceTrackableSends | Hard Bounce Trackable Sends | int | 9 |  |  |  |
| Id | Contact Daily Metric ID | id |  | 18 |  |  |
| InboundEngagementsCount | Inbound Engagements Count | int | 9 |  |  |  |
...
| OutboundEngagementsCount | Outbound Engagements Count | int | 9 |  |  |  |
