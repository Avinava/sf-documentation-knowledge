...
Represents the parties, such as partners and competitors, that are involved in the deal.

For more information, see FinancialDealParty in the Financial Services Cloud Developer Guide.
...
| Id | Financial Deal Party ID | id |  | 18 |  |  |
...
| PartyId | Account ID | reference |  | 18 |  |  |
| PartyRole | Party Role | picklist |  | 40 |  |  |
| PartyType | Party Type | picklist |  | 255 |  |  |
