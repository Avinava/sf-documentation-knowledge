...
lastCollected: 2026-03-12T09:36:12.671Z
estimatedTokens: 403
...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [ReturnOrderItemTax](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_returnorderitemtax.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Return Order Item Tax ID | id |  | 18 |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| Rate | Rate | percent |  |  | 5 | 2 |
| ReturnOrderId | Return Order ID | reference |  | 18 |  |  |
| ReturnOrderItemAdjustmentId | Return Order Item Adjustment ID | reference |  | 18 |  |  |
| ReturnOrderItemTaxNumber | Return Order Item Tax Number | string |  | 255 |  |  |
