...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [ProductAttribute](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_productattribute.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Product Attribute ID | id |  | 18 |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| Name | Product Attribute Name | string |  | 255 |  |  |
| ProductId | Product ID | reference |  | 18 |  |  |
| Sequence | Sequence | int | 9 |  |  |  |
| SystemModstamp | System Modstamp | datetime |  |  |  |  |
| VariantParentId | Product ID | reference |  | 18 |  |  |
