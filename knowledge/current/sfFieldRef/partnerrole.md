...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [PartnerRole](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_partnerrole.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Partner Role Value ID | id |  | 18 |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| MasterLabel | Master Label | string |  | 255 |  |  |
| ReverseRole | Reverse Role | picklist |  | 255 |  |  |
