...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [SlaProcess](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_slaprocess.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.
...
| Id | Entitlement Process ID | id |  | 18 |  |  |
| IsActive | Active | boolean |  |  |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| LastModifiedById | Last Modified By ID | reference |  | 18 |  |  |
| LastModifiedDate | Last Modified Date | datetime |  |  |  |  |
| LastViewedDate | Last Viewed Date | datetime |  |  |  |  |
| Name | Entitlement Process Name | string |  | 120 |  |  |
| NameNorm | Name | string |  | 240 |  |  |
| SobjectType | Entitlement Process Type | picklist |  | 40 |  |  |
| StartDateField | Custom Field Definition ID | picklist |  | 40 |  |  |
