...
Represents an item on a Wishlist in a store built with B2B Commerce for Lightning.

For more information, see WishlistItem in the Object Reference for Salesforce and Lightning Platform.
...
| WishlistId | Wishlist ID | reference |  | 18 |  |  |
