...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see RegulatoryAuthority in the Emergency Response Management Object Reference, Emergency Response Management for Public Health Developer Guide, Process Compliance Navigator Guide, and Public Sector Solutions Developer Guide.
...
| Id | Regulatory Authority ID | id |  | 18 |  |  |
| IsDeleted | Deleted | boolean |  |  |  |  |
| JurisdictionRegion | Jurisdiction Region | string |  | 255 |  |  |
