...
This guide only lists certain information for each object. For more information, including descriptions of the fields, see [FormulaFunctionAllowedType](https://developer.salesforce.com/docs/atlas.en-us.260.0.object_reference.meta/object_reference/sforce_api_objects_formulafunctionallowedtype.htm "HTML (New Window)") in the Object Reference for the Salesforce Platform.

## Fields

| Field Name | Field Label | Type | Digits | Length | Precision | Scale |
| --- | --- | --- | --- | --- | --- | --- |
| DurableId | Formula Function Allowed Type Durable ID | string |  | 255 |  |  |
| FunctionId | Formula Function ID | string |  | 80 |  |  |
| Id | Formula Function Allowed Type ID | id |  | 18 |  |  |
