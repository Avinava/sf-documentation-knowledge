...
lastCollected: 2026-04-07T18:37:05.662Z
estimatedTokens: 1053
keywords: [Processing, Engine, Batch, Management, Monitor, Workflow, Services, help, automate, business, processes, APIs, Platform, Events, invocable, actions, define, run, review, definitions, jobs]
---
...
-   **[Data Model](atlas.en-us.channel_revenue_management_dev_guide.meta/channel_revenue_management_dev_guide/batch_data_model.htm)**
...
-   **[Common Tooling API Object](atlas.en-us.channel_revenue_management_dev_guide.meta/channel_revenue_management_dev_guide/batch_common_setup_objects.htm)**
    BatchJobDefinition is a common Tooling API object that is shared between Data Processing Engine and Batch Management.
-   **[Common Platform Event](atlas.en-us.channel_revenue_management_dev_guide.meta/channel_revenue_management_dev_guide/batch_management_platform_event.htm)**
...
-   **[Common Business APIs](atlas.en-us.channel_revenue_management_dev_guide.meta/channel_revenue_management_dev_guide/batch_management_apis.htm)**
    Common Business APIs are RESTful APIs that are sometimes available as Apex classes and methods.
-   **[Data Processing Engine](atlas.en-us.channel_revenue_management_dev_guide.meta/channel_revenue_management_dev_guide/data_processing_engine_dev_overview.htm)**
...
-   **[Batch Management](atlas.en-us.channel_revenue_management_dev_guide.meta/channel_revenue_management_dev_guide/batch_management_dev_overview.htm)**
...
-   **[Monitor Workflow Services](atlas.en-us.channel_revenue_management_dev_guide.meta/channel_revenue_management_dev_guide/monitor_workflow_services_dev_overview.htm)**
