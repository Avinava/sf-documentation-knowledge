...
lastCollected: 2026-04-07T18:37:05.983Z
estimatedTokens: 2020
keywords: [BatchProcessJobDefinition, BatchDataSource, BatchDataSrcFilterCriteria, BatchDataSourceOrderField, Batch, Management, job, definition, File, Suffix, Directory, Location, Declarative, Metadata, Sample, Wildcard, Support, Manifest, API, 51.0, SOAP, REST]
---
...
![Important](/docs/resources/img/en-us/260.0?doc_id=images%2Ficon_note_important.png&folder=channel_revenue_management_dev_guide)
...
- Metadata API (atlas.en-us.channel_revenue_management_dev_guide.meta/channel_revenue_management_dev_guide/batch_metadata.htm)
