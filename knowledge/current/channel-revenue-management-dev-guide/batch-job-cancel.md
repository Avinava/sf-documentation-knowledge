...
lastCollected: 2026-04-07T18:37:05.790Z
estimatedTokens: 272
keywords: [Batch, Job, Cancel, processing, engine, calc, management, status, Submitted, Progress, canceled]
---
...
See [Batch Job Cancel Output](atlas.en-us.channel_revenue_management_dev_guide.meta/channel_revenue_management_dev_guide/connect_responses_batch_job_cancel.htm "Output representation of the batch job cancel request.") for HTTP code descriptions that are unique to this resource in case of failure of the batch job cancel request.
...
- Batch Job Cancel Output (atlas.en-us.channel_revenue_management_dev_guide.meta/channel_revenue_management_dev_guide/connect_responses_batch_job_cancel.htm)
