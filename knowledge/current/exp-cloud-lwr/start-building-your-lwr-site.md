---
title: "Start Building Your LWR Site"
domain: exp-cloud-lwr
topic: start-building-your-lwr-site
apiVersion: 67.0
...
For details on more advanced customization, such as custom record components, see [Add More Customizations](atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/advanced_custom.htm "This section describes several advanced customizations, such as creating custom record components and using Apex and SOQL for search.").

-   **[Create an LWR Site in Experience Cloud](atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/get_started_create.htm)**
    Select the Build Your Own (LWR) or the Microsite (LWR) template to create an LWR site in Experience Cloud.
-   **[Create Custom Pages in an LWR Site](atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/get_started_create_pages.htm)**
...
-   **[Create Theme Layouts in an LWR Site](atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/get_started_theme_layout.htm)**
...
-   **[Create a Custom Navigation Menu Component](atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/get_started_navigation.htm)**
...
-   **[Publish Your LWR Site](atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/get_started_publish.htm)**
...
- Add More
        Customizations (atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/advanced_custom.htm)
- Create an LWR Site in Experience Cloud (atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/get_started_create.htm)
- Create Custom Pages in an LWR Site (atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/get_started_create_pages.htm)
- Create Theme Layouts in an LWR Site (atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/get_started_theme_layout.htm)
- Create Components for LWR Sites (atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/get_started_components.htm)
