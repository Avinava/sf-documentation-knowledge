---
title: "LWR Sites for Experience Cloud"
domain: exp-cloud-lwr
topic: lwr-sites-for-experience-cloud
apiVersion: 67.0
...
> Develop sites that load quickly and scale well using the Build Your Own
    ...
    Lightning Web Runtime (LWR) and the Lightning Web Components (LWC) programming model, these
    lightweight templates support fully custom solutions and deliver exceptional site
    performance.
...
-   **[What Are LWR Sites for Experience Cloud?](atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/intro_overview.htm)**
...
-   **[Before You Begin Building an LWR Site](atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/intro_before.htm)**
...
-   **[Key Resources for Developing LWR Sites](atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/intro_resources.htm)**
    Check out these resources to learn more about the main elements you use when developing an LWR site in Experience Cloud.
-   **[Release Notes for LWR Sites](atlas.en-us.exp_cloud_lwr.meta/exp_cloud_lwr/intro_release_notes.htm)**
