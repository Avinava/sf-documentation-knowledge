---
title: "What Are LWR Sites for Experience Cloud?"
domain: exp-cloud-lwr
topic: what-are-lwr-sites-for-experience-cloud
apiVersion: 67.0
...
> Powered by the Lightning Web Runtime (LWR), LWR sites deliver unparalleled site
    ...
    templates for Experience Cloud let you develop blazing fast digital experiences, such as
    websites, portals, and microsites, using the Lightning Web Components programming
    model.
...
To clarify which features apply where, we use the terms enhanced LWR sites and enhanced CMS workspaces to refer to LWR sites and CMS workspaces on the new platform.
...
See [What Is the Enhanced Sites and Content Platform](https://help.salesforce.com/s/articleView?id=experience.exp_cloud_enhanced.htm&type=5&language=en_US) in Salesforce Help.
