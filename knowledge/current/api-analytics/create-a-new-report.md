...
topic: create-a-new-report
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-03-12T09:33:58.604Z
estimatedTokens: 109
keywords: [New, Report, POST]
---
...
To create a report, you only have to specify reportMetadata with a name and a reportType to create a new report. Other properties are optional.
...
```
{
  ...
  "reportMetadata" : {
    ...
    "currency" : null,
    "description" : null,
    "detailColumns" : [ "ROLLUP_DESCRIPTION", "FULL_NAME", "ACCOUNT_NAME", "OPPORTUNITY_NAME", "STAGE_NAME", "FISCAL_QUARTER", "AMOUNT", "PROBABILITY", "AGE", "CLOSE_DATE", "CREATED_DATE", "NEXT_STEP", "LEAD_SOURCE", "TYPE" ],
