---
title: "Automotive Cloud Metadata API Types"
domain: automotive-cloud
topic: automotive-cloud-metadata-api-types
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-04-07T09:03:05.722Z
estimatedTokens: 852
keywords: [Automotive, Cloud, Metadata, API, access, feature, settings, customize, user, Developer]
---

# Automotive Cloud Metadata API Types
...
-   **[ActionableEventOrchDef](atlas.en-us.automotive_cloud.meta/automotive_cloud/auto_metadata_api_actionableeventorchdef.htm)**
...
-   **[ActionableEventTypeDef](atlas.en-us.automotive_cloud.meta/automotive_cloud/auto_metadata_api_actionableeventtypedef.htm)**
    Represents the definition of an actionable event type so that the records can be migrated from one org to another.
-   **[Flow for Automotive Cloud](atlas.en-us.automotive_cloud.meta/automotive_cloud/auto_flow_metadata_api.htm)**
...
-   **[ObjectHierarchyRelationship](atlas.en-us.automotive_cloud.meta/automotive_cloud/auto_metadata_api_objecthierarchyrelationship.htm)**
...
-   **[TelemetryActionDefinition](atlas.en-us.automotive_cloud.meta/automotive_cloud/auto_metadata_api_telemetryactiondefinition.htm)**
...
-   **[TelemetryActionDefStep](atlas.en-us.automotive_cloud.meta/automotive_cloud/auto_metadata_api_telemetryactiondefstep.htm)**
    Represents a step in the action for a telemetry signal definition.
-   **[TelemetryActnDefStepAttr](atlas.en-us.automotive_cloud.meta/automotive_cloud/auto_metadata_api_telemetryactndefstepattr.htm)**
    Represents the attributes of a telemetry action definition step.
-   **[TelemetryDefinition](atlas.en-us.automotive_cloud.meta/automotive_cloud/auto_metadata_api_telemetrydefinition.htm)**
    Represents the definition of the structure of a telemetry signal sent from a connected asset or vehicle.
-   **[TelemetryDefinitionVersion](atlas.en-us.automotive_cloud.meta/automotive_cloud/auto_metadata_api_telemetrydefinitionversion.htm)**
