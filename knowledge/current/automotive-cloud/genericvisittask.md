...
lastCollected: 2026-03-12T09:34:01.304Z
estimatedTokens: 1034
keywords: [GenericVisitTask, task, performed, visit, Automotive, Cloud, API, version, 56.0, later, Calls, Associated, Objects]
---

# GenericVisitTask

> Represents information about a task that can be performed during a
         visit. This object is available in Automotive Cloud in API version 56.0 and
      later.
