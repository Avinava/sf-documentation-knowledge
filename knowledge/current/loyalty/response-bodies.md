...
-   **[Additional Attributes](atlas.en-us.loyalty.meta/loyalty/connect_responses_additional_attributes_output.htm)**
    Output representation of the additional details of a promotion.
-   **[Additional Transaction Journal Attributes Output](atlas.en-us.loyalty.meta/loyalty/connect_responses_additional_transaction_attribute_output.htm)**
    Output representation of the additional transaction journal fields.
...
-   **[Club Member Benefits](atlas.en-us.loyalty.meta/loyalty/connect_responses_club_member_benefit.htm)**
...
-   **[Club Member Promotions](atlas.en-us.loyalty.meta/loyalty/connect_responses_club_member_promotion.htm)**
...
-   **[Coupon Usage Result](atlas.en-us.loyalty.meta/loyalty/connect_responses_couponusage.htm)**
...
-   **[Game Details (Promotion)](atlas.en-us.loyalty.meta/loyalty/connect_responses_promotion_game_details.htm)**
    The details of the game that's assigned to the customer.
-   **[Game Result](atlas.en-us.loyalty.meta/loyalty/connect_responses_game_result.htm)**
    Output representation of the game reward that a participant has won.
-   **[Game Reward Details](atlas.en-us.loyalty.meta/loyalty/connect_responses_game_reward_details.htm)**
    Output representation of the details of the game reward that a participant has won.
-   **[Game Rewards List](atlas.en-us.loyalty.meta/loyalty/connect_responses_game_rewards_list.htm)**
...
-   **[Loyalty Program Process Rule Action](atlas.en-us.loyalty.meta/loyalty/connect_responses_loyalty_program_process_rule_action.htm)**
...
-   **[Loyalty Program Process Rule Action Parameter](atlas.en-us.loyalty.meta/loyalty/connect_responses_loyalty_program_process_rule_action_parameter.htm)**
    Output representation of the loyalty program process rule action parameter.
-   **[Loyalty Program Process Rule Condition](atlas.en-us.loyalty.meta/loyalty/connect_responses_loyalty_program_process_rule_condition.htm)**
    Output representation of the loyalty program process rule condition.
-   **[Loyalty Program Process Rule Condition Filter Criteria](atlas.en-us.loyalty.meta/loyalty/connect_responses_loyalty_program_process_rule_condition_filter_criteria.htm)**
    Output representation of the loyalty program process rule condition filter criteria.
-   **[Loyalty Program Process Rule Condition Group](atlas.en-us.loyalty.meta/loyalty/connect_responses_loyalty_program_process_rule_condition_group.htm)**
...
-   **[Member Engagement Attribute](atlas.en-us.loyalty.meta/loyalty/connect_response_member_engagement_attribute.htm)**
...
-   **[Promotion Reward Application](atlas.en-us.loyalty.meta/loyalty/connect_responses_promotion_reward_application_output.htm)**
    Output representation details of the transaction journals that are created and processed.
-   **[Promotion Reward Details](atlas.en-us.loyalty.meta/loyalty/connect_responses_promotion_reward_details.htm)**
...
-   **[Rule Action](atlas.en-us.loyalty.meta/loyalty/connect_responses_rule_action.htm)**
    Output representation of the details of a promotion rule action.
-   **[Rule Action Parameter](atlas.en-us.loyalty.meta/loyalty/connect_responses_rule_action_parameter.htm)**
    Output representation of the details of a promotion rule action parameter.
-   **[Rule Condition](atlas.en-us.loyalty.meta/loyalty/connect_responses_rule_condition.htm)**
    Output representation of the details of a promotion rule condition.
-   **[Rule Filter Criteria](atlas.en-us.loyalty.meta/loyalty/connect_responses_rule_filter_criteria.htm)**
...
-   **[Rule Parameter](atlas.en-us.loyalty.meta/loyalty/connect_responses_rule_parameter.htm)**
