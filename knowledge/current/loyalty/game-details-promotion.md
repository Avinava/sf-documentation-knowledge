...
| --- | --- | --- | --- | --- |
| game​DefinitionName | String | Name of the game that's assigned to a customer. | Big, 65.0 | 65.0 |
| game​ExpirationDate | String | Date on which the game expires for the customer. | Big, 65.0 | 65.0 |
| gameParticipant​RewardId | String | The ID of the game participant reward record that stores the details of the reward that the customer receives after they play the game. | Big, 65.0 | 65.0 |
