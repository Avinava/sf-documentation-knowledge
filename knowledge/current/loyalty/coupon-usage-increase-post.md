---
title: "Coupon Usage Increase (POST)"
domain: loyalty
topic: coupon-usage-increase-post
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:34:51.052Z
estimatedTokens: 306
...
```apex
/global-promotions-management/coupons/usage-increase
```

```apex
https://yourInstance.salesforce.com/services/data/v66.0/global-promotions-management/coupons/usage-increase
```
