...
| associated​AccountDetails | Loyalty Account Input | The business account details of the member. | Required | 55.0 |
...
| canReceive​Promotions | Boolean | Indicates whether the member can receive promotions for the program. | Optional | 55.0 |
...
| enrollment​Channel | String | The channel used by members to enroll into a loyalty program.Possible values are:CallCenterEmailFranchiseMobilePartnerPosPrintSocialStoreWeb | Optional | 55.0 |
...
| referredBy​MemberReferral​Code | String | The referral code of the loyalty program member who has referred the member. | Optional | 57.0 |
...
[Corporate Member Enrollment](atlas.en-us.loyalty.meta/loyalty/connect_responses_corporate_member_enrollment_output.htm "Output representation of the corporate member enrollment create request.")
