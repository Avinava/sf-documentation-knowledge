...
| --- | --- | --- | --- | --- |
| apiExecuted​DateTime | String | The date and time on which the API was executed. | Small, 61.0 | 61.0 |
| promotionDetails | Unified Promotions Output[] | The details of the promotion. | Small, 61.0 | 61.0 |
| promotion​LastModified​DateTime | String | The date and time on which the promotion was last modified. | Small, 61.0 | 61.0 |
| promotion​RuleList | Promotion Rule[] | The rules of the promotion. The rules are represented as context rules in the response. | Small, 61.0 | 61.0 |
| related​RuleLibrary | Rule Library[] | The rule library that's associated with the promotion. | Small, 61.0 | 61.0 |
