---
title: "Unified Promotions Input"
domain: loyalty
topic: unified-promotions-input
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:34:51.012Z
estimatedTokens: 828
...
Before updating an existing promotion, get all the existing details of the promotion using the [GET](atlas.en-us.loyalty.meta/loyalty/connect_resources_unified_promotion_details.htm "Retrieve the details of a promotion. Update a promotion record.") operation. To update an existing promotion using the PUT method, you must include all the existing field values of the promotion in the payload along with the new fields, or the fields to be updated.
...
- GET (atlas.en-us.loyalty.meta/loyalty/connect_resources_unified_promotion_details.htm)
