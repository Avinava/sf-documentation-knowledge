...
This section lists the request bodies for Life Sciences Cloud Business APIs. The query parameters for an endpoint are listed along with each resource.
...
-   **[Account User Territory Info Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_account_user_territory_info.htm)**
    Input representation of the Account User Territory Information.
-   **[Action Plan Context Filters Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_action_plan_context_filters.htm)**
    Input representation of the action plan context filters.
-   **[Action Plan Template Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_action_plan_template_input.htm)**
...
-   **[Assessment Links Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_assessment_links_input.htm)**
    Associated assessments including id, category, reason and sequence.
-   **[Book Slot Chain Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_book_slot_chain_input.htm)**
    Input representation of the request to create service appointments.
-   **[Bulk Presentation Pages Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_bulk_presentation_pages_input.htm)**
    Input representation for a presentation page.
-   **[Bulk Presentation Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_bulk_presentation.htm)**
    Input representation for bulk presentation.
-   **[Bulk Presentation Update Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_bulk_presentation_input_patch.htm)**
    Input representation for bulk presentation update.
-   **[Bulk Presentation Pages Update Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_bulk_presentation_pages_input_patch.htm)**
    Input representation for a presentation page update.
-   **[Build Identity Verification Context Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_build_verification_context_input.htm)**
    Input representation of the Build Identity Verification Context resource.
-   **[Care Request Case Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_care_authorization_case_input.htm)**
    Case related to the care request.
-   **[Care Request Patient Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_care_authorization_patient_input.htm)**
...
-   **[Care Diagnosis Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_care_diagnosis_input.htm)**
...
-   **[Care Request Drug Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_care_request_drug_input.htm)**
...
-   **[Care Request Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_care_request_input.htm)**
...
-   **[Care Request Item Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_care_request_item_input.htm)**
...
-   **[Care Requests List Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_care_requests_list_input.htm)**
    A list of care authorization requests.
-   **[Care Request Reviewer Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_care_request_reviewer_input.htm)**
...
-   **[Care Request Subscriber Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_subscriber_input.htm)**
...
-   **[Create Visit Request Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_create_visit_request.htm)**
...
-   **[Digital Verification Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_digital_verification_input.htm)**
...
-   **[Download Provider Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_download_provider_input.htm)**
    The request representation to download provider data using an external identifier.
-   **[Document Management Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_document_management_input.htm)**
    Input representation for the document split request.
-   **[Document Process Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_document_process_input.htm)**
...
-   **[FHIR Coding Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_fhir_coding.htm)**
...
-   **[FHIR Dispense Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_fhir_dispense.htm)**
...
-   **[FHIR Dose](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_fhir_dose.htm)**
    Input representation for the dosage quantity.
-   **[FHIR Dose And Rate](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_fhir_dose_and_rate.htm)**
...
-   **[FHIR Medication Statement](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_fhir_medication_statemen.htm)**
...
-   **[FHIR Patient Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_fhir_patient.htm)**
    Input representation for the FHIR patient resource.
-   **[FHIR Rate](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_fhir_rate.htm)**
...
-   **[FHIR Request](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_fhir_request.htm)**
...
-   **[Merge Customers Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_merge_customers_input_representation.htm)**
...
-   **[Patient Contact Party Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_patient_contact_party.htm)**
    The input representation of the patient contact party.
-   **[Page Products Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_page_products_array_input.htm)**
    Input representation that contains the product and guidance IDs associated with a presentation page.
-   **[Page Specification Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_page_specificatio.htm)**
    Input representation of the page specification details.
-   **[Page Specification List Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_page_specification_input.htm)**
    Input representation of the page specification list.
-   **[Patient Communication Language Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_patient_communication_language.htm)**
...
-   **[Product Required Attributes Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_product_required_attribute.htm)**
    Input representation of the products required for the visit.
-   **[Program Enrollment Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_program_enrollment_input.htm)**
    Request body for care program enrollment.
-   **[Slot Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_slot_input.htm)**
...
-   **[Sample Limits Request Data Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_sample_limits_request_data_input.htm)**
    Input representation for the sample limits data to validate.
-   **[Sample Limits Validation Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_sample_limits_validation_input.htm)**
...
-   **[Search Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_search_input.htm)**
    Input representation for Search API
-   **[Transport Location Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_transport_location_input.htm)**
    Input representation for Transport Location
-   **[User Credentials Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_user_credentials_input.htm)**
    Input representation of the user credentials to perform digital verification.
-   **[Visited Party Attributes Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_visited_party_attribute.htm)**
...
-   **[Visitor Attributes Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_visitor_attribute.htm)**
...
-   **[Work Type Lead Time Input](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_requests_work_type_lead_time_input.htm)**
