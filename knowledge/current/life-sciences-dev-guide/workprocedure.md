...
lastCollected: 2026-03-12T09:34:47.624Z
estimatedTokens: 799
...
| Field | Details |
| --- | --- |
| AssociatedFlowOrchestratorName | TypestringPropertiesCreate, Filter, Group, Nillable, Sort, UpdateDescriptionThe API name of the flow orchestrator associated with the work procedure. |
...
| LeadTimeUnitType | TypepicklistPropertiesCreate, Filter, Group, Nillable, Restricted picklist, Sort, UpdateDescriptionThe unit of measure for the lead time required to complete the work procedure.Possible values are:DaysHoursMinutes |
