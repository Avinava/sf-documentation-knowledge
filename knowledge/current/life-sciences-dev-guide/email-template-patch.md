---
title: "Email Template (PATCH)"
domain: life-sciences-dev-guide
topic: email-template-patch
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-04-07T18:37:55.475Z
estimatedTokens: 1009
keywords: [Email, Template, PATCH, template.The, Health, Cloud, Starter, Life, Sciences, Commercial, Admin, Permission, accessing, API, know, Intelligent, Content]
---

> Update an email template.The Health Cloud Starter and
...
| contentDocumentId | String | ID of the content document ZIP containing the email files. You can pass this parameter if you wish to process the existing document record. You cannot provide this parameter when you pass the fileId. | Optional |
...
| fileId | String | The multipart form field key that references the uploaded file for this presentation page. You can pass this parameter if you wish to process a new file that you will include in the request. You cannot provide this parameter when you pass the contentDocumentId as only one of the two are allowed. | Optional |
| id | String | ID of the email template. Either the SourceSystemIdentifier or Salesforce ID of the LifeSciEmailTemplate record. | Required |
...
[Update Email Template Output](atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_responses_content_management_output.htm "Represents the information about the job status and any associated messages returned for Content Management APIs.")
...
- Update Email
              Template Output (atlas.en-us.life_sciences_dev_guide.meta/life_sciences_dev_guide/connect_responses_content_management_output.htm)
