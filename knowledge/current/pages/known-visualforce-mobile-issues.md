---
title: "Known Visualforce Mobile Issues"
domain: pages
topic: known-visualforce-mobile-issues
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-04-07T18:38:52.860Z
estimatedTokens: 596
keywords: [Known, Visualforce, Mobile, Issues, Salesforce, publishes, enhance, trust, support, customer, success]
---
...
-   **[Access or Permission Issues](atlas.en-us.pages.meta/pages/vf_dev_best_practices_known_issues_access.htm)**
    Access and permission issues affect which pages and records your users see in the Salesforce app.
-   **[Device Sensor Issues](atlas.en-us.pages.meta/pages/vf_dev_best_practices_known_issues_device.htm)**
    Device sensor issues include problems with the mobile device’s camera, microphone, and geolocation.
-   **[Input Issues](atlas.en-us.pages.meta/pages/vf_dev_best_practices_known_issues_input.htm)**
    Input issues affect how users enter information using input fields and selectors in the Salesforce mobile app.
-   **[Loading and Performance Issues](atlas.en-us.pages.meta/pages/vf_dev_best_practices_known_issues_loading.htm)**
    Loading and performance issues affect how responsive the Salesforce mobile app is and how quickly it loads.
-   **[Navigation Issues](atlas.en-us.pages.meta/pages/vf_dev_best_practices_known_issues_navigation.htm)**
    These issues prevent users from navigating to certain pages in the Salesforce mobile app.
-   **[Network Issues](atlas.en-us.pages.meta/pages/vf_dev_best_practices_known_issues_network.htm)**
    Network issues affect the connectivity of the Salesforce mobile app.
-   **[Salesforce Classic vs. Lightning Experience Issues](atlas.en-us.pages.meta/pages/vf_dev_best_practices_known_issues_lightning.htm)**
    These issues are caused by switching between Salesforce Classic and Lightning Experience.
-   **[Updating Records Issues](atlas.en-us.pages.meta/pages/vf_dev_best_practices_known_issues_updating.htm)**
    These issues affect users trying to update records in the Salesforce mobile app.
-   **[User Interface Issues](atlas.en-us.pages.meta/pages/vf_dev_best_practices_known_issues_ui.htm)**
