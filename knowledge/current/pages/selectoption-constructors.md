...
lastCollected: 2026-04-07T09:04:56.388Z
estimatedTokens: 124
...
-   **[SelectOption(value, label)](atlas.en-us.pages.meta/pages/apex_System_SelectOption_ctor_2.htm)**
    Creates a new instance of the SelectOption class using the specified value and label.
-   **[SelectOption(value, label, isDisabled)](atlas.en-us.pages.meta/pages/apex_System_SelectOption_ctor.htm)**
