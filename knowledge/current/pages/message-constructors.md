...
lastCollected: 2026-04-07T09:04:55.994Z
estimatedTokens: 187
keywords: [Message]
---
...
-   **[Message(severity, summary)](atlas.en-us.pages.meta/pages/apex_ApexPages_Message_ctor_3.htm)**
    Creates a new instance of the ApexPages.Message class using the specified message severity and summary.
-   **[Message(severity, summary, detail)](atlas.en-us.pages.meta/pages/apex_ApexPages_Message_ctor_2.htm)**
    Creates a new instance of the ApexPages.Message class using the specified message severity, summary, and message detail.
-   **[Message(severity, summary, detail, id)](atlas.en-us.pages.meta/pages/apex_ApexPages_Message_ctor.htm)**
