...
-   **[PageReference(partialURL)](atlas.en-us.pages.meta/pages/apex_System_PageReference_ctor_2.htm)**
    Creates a new instance of the PageReference class using the specified URL.
-   **[PageReference(record)](atlas.en-us.pages.meta/pages/apex_System_PageReference_ctor.htm)**
