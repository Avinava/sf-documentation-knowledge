---
title: "Controlling the Appearance of Charts"
domain: pages
topic: controlling-the-appearance-of-charts
apiVersion: 67.0
...
the look of markers, lines, and so on.
...
Many of the components and attributes that provide this control are explained in the [Standard Visualforce Component Reference](atlas.en-us.pages.meta/pages/pages_compref.htm "This section provides a full list of standard Visualforce components."). Some effects require combinations of attributes and components, and are explained more completely in this document.
