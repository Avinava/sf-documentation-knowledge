...
-   **[getSourceId()](atlas.en-us.pages.meta/pages/apex_ApexPages_KnowledgeArticleVersionStandardController_getSourceId.htm)**
    Returns the ID for the source object record when creating a new article from another object.
-   **[setDataCategory(categoryGroup, category)](atlas.en-us.pages.meta/pages/apex_ApexPages_KnowledgeArticleVersionStandardController_setDataCategory.htm)**
