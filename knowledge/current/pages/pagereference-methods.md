...
lastCollected: 2026-03-12T09:35:21.686Z
estimatedTokens: 823
...
-   **[getAnchor()](atlas.en-us.pages.meta/pages/apex_System_PageReference_getAnchor.htm)**
    Returns the name of the anchor referenced in the page’s URL. That is, the part of the URL after the hashtag (#).
-   **[getContent()](atlas.en-us.pages.meta/pages/apex_System_PageReference_getContent.htm)**
    Returns the output of the page, as displayed to a user in a web browser.
-   **[getContentAsPDF()](atlas.en-us.pages.meta/pages/apex_System_PageReference_getContentAsPDF.htm)**
    Returns the page in PDF, regardless of the <apex:page\> component’s renderAs attribute.
-   **[getCookies()](atlas.en-us.pages.meta/pages/apex_System_PageReference_getCookies.htm)**
...
-   **[getHeaders()](atlas.en-us.pages.meta/pages/apex_System_PageReference_getHeaders.htm)**
...
-   **[getParameters()](atlas.en-us.pages.meta/pages/apex_System_PageReference_getParameters.htm)**
...
-   **[getRedirect()](atlas.en-us.pages.meta/pages/apex_System_PageReference_getRedirect.htm)**
    Returns the current value of the PageReference object's redirect attribute.
-   **[getRedirectCode()](atlas.en-us.pages.meta/pages/apex_System_PageReference_getRedirectCode.htm)**
    Returns the HTTP redirect code used when [getRedirect()](atlas.en-us.pages.meta/pages/apex_System_PageReference_getRedirect.htm "Returns the current value of the PageReference object's redirect attribute.") is set to true for the PageReference object.
-   **[getUrl()](atlas.en-us.pages.meta/pages/apex_System_PageReference_getUrl.htm)**
...
-   **[setAnchor(anchor)](atlas.en-us.pages.meta/pages/apex_System_PageReference_setAnchor.htm)**
    Sets the URL’s anchor reference to the specified string.
-   **[setCookies(cookies)](atlas.en-us.pages.meta/pages/apex_System_PageReference_setCookies.htm)**
...
-   **[setRedirectCode(redirectCode)](atlas.en-us.pages.meta/pages/apex_System_PageReference_setRedirectCode.htm)**
