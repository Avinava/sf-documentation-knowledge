---
title: "Developing Salesforce Apps with Visualforce"
domain: pages
topic: developing-salesforce-apps-with-visualforce
apiVersion: 67.0
...
> Developers can use Visualforce to extend and add new functionality to the Salesforce
            ...
            and create an integrated experience that runs on the Lightning Platform. You can create
            Vis
...
-   **[Salesforce Platform Development Process](atlas.en-us.pages.meta/pages/pages_mobile_platform_dev_process_intro.htm)**
...
-   **[Tell Me More: Where Visualforce Pages Can Appear in the Salesforce Mobile App Where Visualforce Pages Can Appear in the Salesforce Mobile App](atlas.en-us.pages.meta/pages/vf_pages_where_accessible_from.htm)**
    When you create a Visualforce page, you can make it available from a number of places in the user interface.
-   **[Guidelines and Best Practices](atlas.en-us.pages.meta/pages/vf_dev_best_practices.htm)**
