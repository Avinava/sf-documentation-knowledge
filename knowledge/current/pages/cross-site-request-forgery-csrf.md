...
lastCollected: 2026-04-07T18:38:52.305Z
...
-   [*Trailhead*: Mitigate Cross-Site Request Forgery](https://trailhead.salesforce.com/content/learn/modules/secure-serverside-development/mitigate-crosssite-request-forgery "Trailhead: Mitigate Cross-Site Request Forgery - html (New Window)")

-   [*Secure Coding Guide*: Secure Coding Cross-Site Request Forgery](https://developer.salesforce.com/docs/atlas.en-us.260.0.secure_coding_guide.meta/secure_coding_guide/secure_coding_cross_site_req_forgery.htm "Secure Coding Guide: Secure Coding Cross-Site Request
    Forgery - html (New Window)")

-   [*ISVforce Guide*: Cross-Site Request Forgery](https://developer.salesforce.com/docs/atlas.en-us.260.0.packagingGuide.meta/packagingGuide/secure_code_violation_request_forgery.htm "ISVforce Guide: Cross-Site Request Forgery - HTML (New Window)")
