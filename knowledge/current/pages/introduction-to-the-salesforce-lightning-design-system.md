---
title: "Introduction to the Salesforce Lightning Design System"
domain: pages
topic: introduction-to-the-salesforce-lightning-design-system
apiVersion: 67.0
...
> The Salesforce Lightning Design System (SLDS) helps you build applications with the look
  ...
  that gives you access to the icons, color palettes, and font that our developers use to create
...
-   **[Applying SLDS to Visualforce Pages](atlas.en-us.pages.meta/pages/vf_dev_best_practices_slds_apply.htm)**
...
-   **[Use SLDS Icons in Visualforce](atlas.en-us.pages.meta/pages/vf_dev_best_practices_slds_icons.htm)**
...
-   **[Create a Visualforce Page for the Salesforce Mobile App Using SLDS](atlas.en-us.pages.meta/pages/vf_dev_best_practices_slds_create.htm)**
...
-   **[Responsive Page Design Using SLDS](atlas.en-us.pages.meta/pages/vf_dev_best_practices_slds_responsive.htm)**
