---
title: "Referral Event (POST)"
domain: referral-marketing
topic: referral-event-post
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:35:35.812Z
...
[Referral Event](atlas.en-us.referral_marketing.meta/referral_marketing/connect_responses_referral_event_output.htm "Output representation of the request to create a referral event record.")

## Code Examples

```
/referral-program/referral-event
```

```
https://yourInstance.salesforce.com/services/data/v66.0
/referral-program/referral-event
```
