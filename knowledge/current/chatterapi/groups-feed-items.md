---
title: "Groups Feed Items"
domain: chatterapi
topic: groups-feed-items
apiVersion: 67.0
...
Get feed items for the groups the context user either owns or is a member of.
...
In version 32.0 and later, use [Groups Feed Elements](atlas.en-us.chatterapi.meta/chatterapi/connect_resource_feeds_groups.htm#cc_groups_feed_elements).
...
- Groups Feed Elements (atlas.en-us.chatterapi.meta/chatterapi/connect_resource_feeds_groups.htm)
