---
title: "User Profile Feed Items"
domain: chatterapi
topic: user-profile-feed-items
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:34:13.509Z
...
Get the feed items on records that can be tracked in a feed. Post a feed item.
...
In version 32.0 and later, use [User Profile Feed Elements](atlas.en-us.chatterapi.meta/chatterapi/connect_resource_feeds_user_profile.htm#cc_user_profile_feed_elements).
...
- User Profile Feed Elements (atlas.en-us.chatterapi.meta/chatterapi/connect_resource_feeds_user_profile.htm)
