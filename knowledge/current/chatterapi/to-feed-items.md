...
lastCollected: 2026-03-12T09:34:13.444Z
...
Get the feed items for @mentions of the context user and posts made to the user's feed.

The To Feed includes posts that mention you and posts that other users make to your wall. Your own posts are included only if they have a comment. The comment can be from you or from another user.
...
In version 32.0 and later, use [To Feed Elements](atlas.en-us.chatterapi.meta/chatterapi/connect_resource_feeds_to.htm#cc_to_feed_elements).
...
- To Feed Elements (atlas.en-us.chatterapi.meta/chatterapi/connect_resource_feeds_to.htm)
