---
title: "Connect REST API Resources"
domain: chatterapi
topic: connect-rest-api-resources
apiVersion: 67.0
...
-   **[Activity Reminders Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_activity_reminders.htm)**
    Get upcoming activity reminders in Salesforce Classic. Get, update, or delete an activity reminder in Salesforce Classic.
-   **[Application for Program](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_apply_for_program.htm)**
...
-   **[Bot Version Activation Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_bot_version_activation.htm)**
    Get and change the activation information of a bot version.
-   **[Briefcase Priming Records Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_briefcase_priming_records.htm)**
    Get a list of records related to an offline briefcase.
-   **[Call Coaching Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_calls_resources.htm)**
...
-   **[Clean Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_clean_resources.htm)**
...
-   **[Commerce B2B Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_commerce.htm)**
...
-   **[Commerce Einstein Webstore Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_commerce_webstore_ai_resources.htm)**
...
-   **[Content Taxonomy Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_content_taxonomy_resources.htm)**
    Create, get, update, delete, and search content taxonomy terms.
-   **[Content Workspace Permissions Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_workspace_permissions.htm)**
    Get a user's permissions for a content workspace.
-   **[Conversation Application Definition Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_conversation_application_definition.htm)**
    Get information about an integration’s conversation application definition and the associated bot.
-   **[Conversations Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_conversations.htm)**
    Get and update conversation entries. Upload bulk conversations and get the statuses of the uploads.
-   **[Custom Domain Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_custom_domain_resources.htm)**
...
-   **[Customer Asset Lifecycle Management Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_asset_lifecycle.htm)**
    Generate, cancel, and change lifecycle-managed assets for sales and account reps to view in Lightning Experience.
-   **[Data 360 Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_customer_360_audiences_resources.htm)**
...
-   **[Data Integration Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_data-integration.htm)**
    Get external object names, and use those names to get contract credit information.
-   **[Duplicate Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_dedupe_resources.htm)**
    Get a directory of duplicate resources, job definitions, and jobs. Update a job status, run a job, and delete job results.
-   **[Einstein Prediction Service Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_einstein_prediction_services.htm)**
...
-   **[Prompt Templates Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_prompt_templates_resources.htm)**
    Get prompt template data and generate LLM responses using prompt templates.
-   **[Einstein Recommendation Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_einstein_recommendations.htm)**
    Get runtime metrics for Einstein Article and Einstein Reply Recommendations.
-   **[Email Merge Field Services Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_email_merge_field_services.htm)**
...
-   **[Employee Profiles Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_employee_profiles_resources.htm)**
    Get, upload and crop, and delete an employee photo or banner photo.
-   **[Enhanced CMS Workspaces Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_managed_content_enhanced_resources.htm)**
...
-   **[Environment Hub Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_environment_hub.htm)**
...
-   **[Experience Cloud Microsites Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_marketing_integration_resources.htm)**
    Get, save, and submit marketing integration forms for an Experience Cloud site.
-   **[Experience Cloud Sites Knowledge Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_communities_articles.htm)**
...
-   **[Experience Cloud Sites Moderation Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_communities_moderation.htm)**
...
-   **[Experience Cloud Sites Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_communities.htm)**
...
-   **[Experience Model Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_experience_model_resources.htm)**
    Get experience model property types.
-   **[External Email Services Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_external_email_services.htm)**
    Get information about the external email services available to the context user.
-   **[Field Service Recordset Filter Criteria Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_field_service_evaluate_recordset_filter_criteria.htm)**
    Filter records on recordset filter criteria.
-   **[Field Service Shifts from Pattern Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_field_service_shifts_from_pattern.htm)**
    Preview and create up to 2,000 shifts from a pattern.
-   **[Files Connect Repository Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_content-hub.htm)**
...
-   **[Files Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_files.htm)**
...
-   **[Flow Approval Processes Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_flow_approval_processes.htm)**
    Get the status and available actions for flow approval processes.
-   **[Folders Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_folders.htm)**
    Get information about a folder or the contents of a folder. Modify, delete, and add items to folders.
-   **[Forecasts Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_forecasting.htm)**
    Get information about forecast users, managers, and the forecast hierarchy.
-   **[Knowledge Article View Stat Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_knowledge_article_view_stats.htm)**
    Increase the view count of a knowledge article by one.
-   **[List Share Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_list_shares_home.htm)**
    Share list views with different groups in your org and use sharing to limit who is able to see a list view.
-   **[Managed Topics Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_managed_topics.htm)**
...
-   **[Messaging Channels Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_channels.htm)**
...
-   **[Microbatching Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_microbatching_resources.htm)**
    Ingest microbatching records. Get and delete microbatching errors and resubmit microbatching error records.
-   **[Motifs Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_motifs.htm)**
...
-   **[Named Credentials Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_named_credentials_resources.htm)**
...
-   **[Navigation Menu Items Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_navigation_menu_items.htm)**
    Get navigation menu items for an Experience Cloud site.
-   **[Network Data Category Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_data_category_network_resources.htm)**
...
-   **[Notification Settings Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_notification_settings_resources.htm)**
    Get, set, and reset notification settings and notification app settings.
-   **[Notifications Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_notifications_resources.htm)**
...
-   **[OAuth Credentials Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_oauth_credentials_resources.htm)**
    Find information about OAuth credentials.
-   **[OAuth Usage Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_usage_resources.htm)**
    Find information about OAuth Usage.
-   **[Orchestration Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_orchestration.htm)**
    Get orchestration instances or details about an orchestration instance.
-   **[Pardot Business Unit Context Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_pardot_business_unit_context.htm)**
    Get the Pardot business units the context user has access to.
-   **[Personalization Engagement Signals Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_personalization_engagement_signals_main.htm)**
...
-   **[Personalization Experimentation Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_personalization_experimentation.htm)**
    Create, manage, and retrieve personalization experiments.
-   **[Personalization Recommenders Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_personalization_recommenders.htm)**
    Create, manage, and retrieve personalization recommenders.
-   **[Personalization Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_audience_personalization_resources.htm)**
...
-   **[Private Connect Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_network_connection.htm)**
...
-   **[Push Notifications Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_notifcations_push.htm)**
...
-   **[Quick Text Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_quick_text.htm)**
    Get the body of a quick text.
-   **[Quip Related Records Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_quip_related_records.htm)**
    Get records related to a Quip document.
-   **[Salesforce Omnichannel Inventory Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_omnichannel_inventory_resources.htm)**
    Manage inventory across locations. Available in Salesforce Omnichannel Inventory.
-   **[Salesforce Order Management Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_order_management_resources.htm)**
    Manage orders and the order fulfillment process. Available in Salesforce Order Management orgs.
-   **[Salesforce Payments Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_payments.htm)**
    Information about Salesforce Payments, including content, rendered version, and sharing.
-   **[Salesforce Scheduler Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_lightning_scheduler.htm)**
    Get service territories and create service appointments using Salesforce Scheduler resources.
-   **[Search Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_search_resources.htm)**
    Search objects using keywords or questions.
-   **[Share Captured Activity Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_share_captured_activity.htm)**
...
-   **[Surveys Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_surveys.htm)**
...
-   **[Topics Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_topics.htm)**
...
-   **[Type System Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_type_system_resources.htm)**
    Use Type System resources to retrieve information about the types available in your org.
-   **[User Files Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_users.htm)**
    Get information about a user’s files. Upload a file.
-   **[Voice Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_voice.htm)**
