---
title: "Groups Feed Resources"
domain: chatterapi
topic: groups-feed-resources
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:34:13.240Z
...
-   [Groups Resources](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_groups.htm "Information about groups, such as the group's members, photo, and the groups in the organization. Create and delete a group, add members to a group, and change the group photo.")

-   [Record Feed Resource](atlas.en-us.chatterapi.meta/chatterapi/connect_resource_feeds_record.htm "The feed of the specified record, which could be a group, person, object, file and so on. You can post feed items to the record feed. You can get another user’s record feed.")
