---
title: "Commerce Webstore Composite Promotions"
domain: chatterapi
topic: commerce-webstore-composite-promotions
apiVersion: 67.0
...
> Create a new promotion and all of the associated objects, including
      ...
      promotion. Retrieve the details of a specified promotion.

# Commerce Webstore Composite Promotions

Create a new promotion and all of the associated objects, including segments, qualifiers, targets, and translations. The API returns the ID of the created promotion. Retrieve the details of a specified promotion.
...
| --- | --- | --- | --- | --- |
| promotionId | String | ID of the promotion record associated with the store.This is a required field if templateId and webstoreId aren’t specified. | Optional | 62.0 |
| templateId | String | Unique Identifier for the template. If specified, the API returns the promotion data related to the template ID. | Optional | 62.0 |
| webstoreId | String | ID of the store.This field is required if templateId is specified. | Optional | 62.0 |

Response body for GET

[Composite Promotion](atlas.en-us.chatterapi.meta/chatterapi/connect_responses_composite_promotion.htm "Output representation of the composite promotion information.")
...
[Composite Promotion Result](atlas.en-us.chatterapi.meta/chatterapi/connect_responses_composite_promotion_result.htm "Output representation of composite promotion create request.")
...
```
/commerce/promotions/composite-promotions
```

```
https://yourInstance.salesforce.com/services/data/v62.0​/commerce/promotions/composite-promotions?promotionId=ARDG76987698
```

```
https://yourInstance.salesforce.com/services/data/v62.0​/commerce/promotions/composite-promotions?webstoreId=ARDG76987698&templateId=10OFF
```

```
https://yourInstance.salesforce.com/services/data/v62.0/commerce/promotions/composite-promotions
```
...
- Composite
            Promotion (atlas.en-us.chatterapi.meta/chatterapi/connect_responses_composite_promotion.htm)
- Promotion
...
- Promotion Translation
                        Input (atlas.en-us.chatterapi.meta/chatterapi/connect_requests_promotion_translation_input.htm)
- Composite Promotion
            Result (atlas.en-us.chatterapi.meta/chatterapi/connect_responses_composite_promotion_result.htm)
