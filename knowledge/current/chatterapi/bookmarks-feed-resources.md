---
title: "Bookmarks Feed Resources"
domain: chatterapi
topic: bookmarks-feed-resources
apiVersion: 67.0
...
To bookmark an item, use PATCH with the [Feed Elements Capability, Bookmarks](atlas.en-us.chatterapi.meta/chatterapi/connect_resources_feed_element_capability_bookmarks.htm "Get information about whether a feed element is bookmarked, or add bookmarks to feed elements.") resource and the isBookmarkedByCurrentUser parameter. For example:
...
| --- | --- |
| /chatter/feeds/bookmarks/me | Returns the URL for the bookmarks feed for the context user. |
...
- Feed Elements Capability, Bookmarks (atlas.en-us.chatterapi.meta/chatterapi/connect_resources_feed_element_capability_bookmarks.htm)
