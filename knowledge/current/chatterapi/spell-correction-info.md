---
title: "Spell Correction Info"
domain: chatterapi
topic: spell-correction-info
apiVersion: 67.0
...
| --- | --- | --- | --- | --- |
| correctedQuery | String | Specifies the corrected query. | Small, 63.0 | 63.0 |
| hasNonCorrected​Results | Boolean | Specifies whether some non-corrected results were returned (true) or not (false). | Small, 63.0 | 63.0 |
