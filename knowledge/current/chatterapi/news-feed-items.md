---
title: "News Feed Items"
domain: chatterapi
topic: news-feed-items
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:34:13.328Z
...
Get feed items from all groups the context user either owns or is a member of, as well as from files, records, and users the context user follows. Post feed items.
...
In version 32.0 and later, use [News Feed Elements](atlas.en-us.chatterapi.meta/chatterapi/connect_resource_feeds_news.htm#cc_news_feed_elements).
...
- News Feed Elements (atlas.en-us.chatterapi.meta/chatterapi/connect_resource_feeds_news.htm)
