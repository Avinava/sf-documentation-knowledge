---
title: "Network Data Category Articles"
domain: chatterapi
topic: network-data-category-articles
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:34:13.675Z
estimatedTokens: 362
...
| --- | --- | --- | --- | --- |
| language | String | Language for the articles, limited to the knowledge languages that are enabled for the org. | Optional | 59.0 |
...
```
/connect/communities/communityId/network-data-category/networkDataCategoryId/knowledge-article
```
