---
title: "Name Value Pair Output"
domain: chatterapi
topic: name-value-pair-output
apiVersion: 67.0
release: summer-26-v67
docType: help-article
lastCollected: 2026-04-07T09:03:33.761Z
estimatedTokens: 352
keywords: [Pair, Output]
---

# Name Value Pair Output

> The name and value of a field.
...
| --- | --- | --- | --- | --- |
| name | String | Name. | Small, 57.0 | 57.0 |
| value | String | Value. | Small, 57.0 | 57.0 |

#### See Also

-   [Order Summary Graph Output](atlas.en-us.chatterapi.meta/chatterapi/connect_responses_order_summary_graph_output.htm "Response from creating a pending order summary based on an order summary graph.")
