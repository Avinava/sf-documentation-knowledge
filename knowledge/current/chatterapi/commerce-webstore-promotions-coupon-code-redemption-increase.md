---
title: "Commerce Webstore Promotions, Coupon Code Redemption, Increase"
domain: chatterapi
topic: commerce-webstore-promotions-coupon-code-redemption-increase
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-04-07T18:37:13.106Z
estimatedTokens: 224
keywords: [Commerce, Webstore, Promotions, Coupon, Code, Redemption, Increase, addition]
---

> Get coupon code redemption addition (increase)
    usage.

# Commerce Webstore Promotions, Coupon Code Redemption, Increase
...
```
/commerce/promotions/actions/increase-use/coupon-codes
```
