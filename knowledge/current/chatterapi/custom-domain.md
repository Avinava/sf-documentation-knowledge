...
lastCollected: 2026-04-07T09:03:31.057Z
estimatedTokens: 167
keywords: [Custom, Domain, Definition]
---
...
| --- | --- | --- | --- | --- |
| domainId | String | ID of the custom domain. | Small, 60.0 | 60.0 |
| domainName | String | Domain name of the custom domain. For example, www.example.com. | Small, 60.0 | 60.0 |
