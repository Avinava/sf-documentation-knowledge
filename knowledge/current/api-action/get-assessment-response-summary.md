...
lastCollected: 2026-03-12T09:33:58.051Z
estimatedTokens: 509
keywords: [Assessment, Summary, easy, flow, trigger, server-side, document, generation, Docgen, REST, HTTP, Inputs, Outputs, Usage]
---

# Get Assessment Response Summary

> Get Assessment Response Summary makes it easy to use a flow to trigger
      server-side document generation using Docgen.
