...
lastCollected: 2026-03-12T09:35:02.402Z
...
-   **[ApplicationDecision](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_applicationdecision.htm)**
...
-   **[ApplicationRenderMethod](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_applicationrendermethod.htm)**
...
-   **[ApplicationReview](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_applicationreview.htm)**
...
-   **[ApplicationStageDefinition](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_applicationstagedefinition.htm)**
    Represents a stage of an application. This object is available in Grantmaking API version 61.0 and later.
-   **[ApplicationTimeline](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_applicationtimeline.htm)**
    Represents the milestone dates in the application process. This object is available in API version 57.0 and later.
-   **[Budget](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_budget.htm)**
...
-   **[BudgetAllocation](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_budgetallocation.htm)**
...
-   **[BudgetCategory](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_budgetcategory.htm)**
    Represents the purpose of the budget line item. This object is available in API version 57.0 and later.
-   **[BudgetCategoryValue](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_budgetcategoryvalue.htm)**
    Captures budget values for category and time period. This object is available in API version 57.0 and later.
-   **[BudgetParticipant](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_budgetparticipant.htm)**
...
-   **[BudgetPeriod](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_budgetperiod.htm)**
    Defines a distinct time interval in which the estimate applies. This object is available in API version 57.0 and later.
-   **[FundingAward](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_fundingaward.htm)**
...
-   **[FundingAwardAmendment](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_fundingawardamendment.htm)**
...
-   **[FundingAwardParticipant](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_fundingawardparticipant.htm)**
...
-   **[FundingAwardRequirement](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_fundingawardrequirement.htm)**
...
-   **[FundingAwardRqmtSection](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_fundingawardrqmtsection.htm)**
...
-   **[FundingDisbursement](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_fundingdisbursement.htm)**
...
-   **[FundingOpportunity](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_fundingopportunity.htm)**
...
-   **[FundingOppParticipant](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_fundingoppparticipant.htm)**
...
-   **[IndicatorAssignment](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_indicatorassignment.htm)**
...
-   **[IndicatorPerformancePeriod](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_indicatorperformanceperiod.htm)**
...
-   **[IndividualApplication](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_individualapplication.htm)**
...
-   **[IndividualApplicationTask](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_individualapplicationtask.htm)**
    Represents a task related to an application. This object is available in Grantmaking API version 61.0 and later.
-   **[IndvApplicationTaskParticipant](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_indvapplicationtaskparticipant.htm)**
...
-   **[IndividualApplnParticipant](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_individualapplnparticipant.htm)**
...
-   **[OutcomeActivity](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_outcomeactivity.htm)**
...
-   **[PreliminaryApplicationRef](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_preliminaryapplicationref.htm)**
    Represents the saved applications and pre-screening forms. This object is available in API version 49.0 and later.
-   **[Program](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_grantmaking_program.htm)**
