---
title: "Program Management Standard Objects"
domain: nonprofit-cloud
topic: program-management-standard-objects
apiVersion: 67.0
...
Program Management data model provides objects and fields to manage programs and benefits for your nonprofit organization.
...
-   **[Benefit](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_pm_objects_benefit_standard_fields.htm)**
...
-   **[BenefitAssignment](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_pm_objects_benefitassignment_standard_fields.htm)**
...
-   **[BenefitDisbursement](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_pm_objects_benefitdisbursement_standard_fields.htm)**
...
-   **[BenefitSchedule](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_benefitschedule.htm)**
    Represents information about the plan for delivering the benefit. This object is available in API version 57.0 and later.
-   **[BenefitScheduleAssignment](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_pm_api_objects_benefitscheduleassignment.htm)**
...
-   **[BenefitSession](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_benefitsession.htm)**
...
-   **[BenefitType](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_pm_objects_benefittype_standard_fields.htm)**
...
-   **[CaseProgram](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_caseprogram.htm)**
    Represents the junction between Case and Program objects. This object is available in API version 57.0 and later.
-   **[Program](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_program.htm)**
...
-   **[ProgramCohort](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_pm_objects_programcohort.htm)**
    Represents information about the participants of a program cohort. This object is available in API version 61.0 and later.
-   **[ProgramCohortMember](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/npc_pm_objects_programcohortmember.htm)**
    Represents program enrollees that are part of a given cohort. This object is available in API version 61.0 and later.
-   **[ProgramEnrollment](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_programenrollment.htm)**
    Represents details of enrollment for benefits in a program. This object is available in API version 57.0 and later.
-   **[RecurrenceSchedule](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/sforce_api_objects_recurrenceschedule.htm)**
