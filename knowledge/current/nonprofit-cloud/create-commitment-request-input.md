...
lastCollected: 2026-03-12T09:35:00.687Z
estimatedTokens: 946
...
To include the standard fields for the donor account , use the [Create Commitment Input](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/connect_requests_create_commitment_input.htm "Input representation of the request to create commitments.") request body to specify the standard fields.
...
- Create Commitment
        Input (atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/connect_requests_create_commitment_input.htm)
