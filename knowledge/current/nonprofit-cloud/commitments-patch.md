...
[Update Commitment](atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/connect_responses_update_commitment_output.htm "Output representation of the update commitment request that contains the status, errors if any, and the links to objects after you update a gift commitment.")
...
- Update
              Commitment (atlas.en-us.nonprofit_cloud.meta/nonprofit_cloud/connect_responses_update_commitment_output.htm)
