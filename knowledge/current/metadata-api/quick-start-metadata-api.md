...
lastCollected: 2026-03-12T05:14:42.094Z
estimatedTokens: 694
keywords: [Quick, Start, Metadata, API, Get, started, retrieving, small, set, metadata, components, org, Salesforce, CLI., Resources, Beginner, Developers, Developing]
---

# Quick Start: Metadata API

> Get started with Metadata API by retrieving a small set of metadata components from your
  org on the Salesforce CLI.
...
- Prerequisites (atlas.en-us.api_meta.meta/api_meta/meta_quickstart_retrieve_prereqs.htm)
- Step 1: (Optional) Add Metadata Components to an Org Using the UI (atlas.en-us.api_meta.meta/api_meta/meta_quickstart_retrieve_add_components.htm)
- Step 2: Build a Package.xml Manifest (atlas.en-us.api_meta.meta/api_meta/meta_quickstart_retrieve_build_manifest.htm)
- Step 3: Retrieve Components with Metadata API (atlas.en-us.api_meta.meta/api_meta/meta_quickstart_retrieve_use_retrieve.htm)
