...
domain: metadata-api
topic: customerdataplatformsettings
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-03-12T05:14:38.226Z
estimatedTokens: 629
keywords: [CustomerDataPlatformSettings, Represents, org's, Data, 360, settings., Parent, Manifest, Access, File, Suffix, Directory, Location, Version, Special, Rules, Fields, Declarative, Metadata, Sample]
---
...
CustomerDataPlatformSettings values are stored in the CustomerDataPlatformSettings.settings file in the settings folder. The .settings files are different from other named components, because there is only one settings file for each settings component.
...
| --- | --- |
| enableCustomerDataPlatform | Field TypebooleanDescriptionIndicates whether an org has Data 360 enabled (true) or not (false). |
