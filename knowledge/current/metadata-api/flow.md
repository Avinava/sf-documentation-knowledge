...
lastCollected: 2026-05-10T00:40:13.828Z
estimatedTokens: 49384
...
| ingestManualAgentScores | Ingests external agent evaluation scores (annotations) into the Agentforce scoring pipeline. This value is available in API version 66.0 and later |
...
| triggerAgentBulkScoring | Triggers Agentforce Scorer processing on specified inputs using scorer API names and entity IDs. This value is available in API version 66.0 and later |
