---
title: "AccountPlanSettings"
domain: metadata-api
topic: accountplansettings
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-04-07T18:36:22.014Z
estimatedTokens: 653
keywords: [AccountPlanSettings, org’s, account, plan, settings, control, features, easy, sales, reps, objectives, actionable, metrics, store, research, analysis, Parent, Manifest, File, Suffix, Directory, Location, Declarative, Metadata, Sample, Definition, Wildcard, Support]
---
...
AccountPlanSettings values are stored in the AccountPlan.settings file in the settings folder. The .settings files are different from other named components, because there is only one settings file for each settings component.
...
| --- | --- |
| enableAccountPlan | Field TypebooleanDescriptionIndicates whether Account Plans is enabled (true) or not (false). The default value is false. |
