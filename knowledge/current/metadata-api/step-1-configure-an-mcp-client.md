---
title: "Step 1: Configure an MCP Client"
domain: metadata-api
topic: step-1-configure-an-mcp-client
apiVersion: 67.0
release: summer-26-v67
docType: help-article
lastCollected: 2026-05-10T00:40:08.460Z
estimatedTokens: 945
...
4.  From the VS Code Activity Bar, click the Agentforce icon (![Graphic of Vibe Codey](/docs/resources/img/en-us/260.0?doc_id=dev_guides%2Fapi_meta%2Fimages%2Fvibecodey_icon.png&folder=api_meta)).
5.  To open the MCP Servers interface, click the icon (![Graphic of Servers](/docs/resources/img/en-us/260.0?doc_id=dev_guides%2Fapi_meta%2Fimages%2Fserver.png&folder=api_meta)) in the Agentforce panel.
