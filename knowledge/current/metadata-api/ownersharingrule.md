...
lastCollected: 2026-04-07T07:46:08.736Z
...
> Represents an ownership-based sharing rule.
      ...
      rules that specify the access level of the target user group. This component is removed as of
      API version 33.0 and is available in earlier versions only.
...
- AccountTerritorySharingRules (atlas.en-us.api_meta.meta/api_meta/meta_sharingrules.htm)
