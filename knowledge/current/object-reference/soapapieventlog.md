---
title: "SoapApiEventLog"
domain: object-reference
topic: soapapieventlog
apiVersion: 67.0
...
| Field | Details |
| --- | --- |
| ApiType | TypestringPropertiesFilter, Group, Nillable, SortDescriptionThe type of API request.Possible values are:D—Apex ClassE—SOAP EnterpriseM—SOAP MetadataP—SOAP PartnerS—SOAP ApexT—SOAP Toolingf—Feedl—Live Agentp—SOAP ClientSync |
