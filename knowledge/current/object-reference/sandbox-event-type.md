...
topic: sandbox-event-type
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-03-12T09:35:09.585Z
estimatedTokens: 738
keywords: [Sandbox, Event, events, contain, copies]
---
...
| Field | Details |
| --- | --- |
| CURRENT_SANDBOX_ORG_ID | TypeIdDescriptionThe 15-character ID of the current sandbox organization. |
| EVENT_TYPE | TypeStringDescriptionThe type of event. The value is always Sandbox. |
| ORGANIZATION_ID | TypeIdDescriptionThe 15-character ID of the organization.For example: 00D000000000123. |
| PENDING_SANDBOX_ORG_ID | TypeIdDescriptionThe 15-character ID of the target sandbox org. |
...
| SANDBOX_ID | TypeIdDescriptionThe 15-character ID of the sandbox organization. |
| STATUS | TypeStringDescriptionThe status of the sandbox copy. |
