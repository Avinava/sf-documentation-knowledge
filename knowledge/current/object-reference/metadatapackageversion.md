...
lastCollected: 2026-03-12T09:35:12.889Z
estimatedTokens: 790
...
| Field Name | Details |
| --- | --- |
| BuildNumber | TypeintPropertiesFilter, Group, Nillable, SortDescriptionThe build number of the version. For example, if you upload two beta versions, they have build numbers 1 and 2. Then, when you upload a non-beta version, the build number is 3. When you upload a new version, the build number resets to 1. |
| IsDeprecated | TypebooleanPropertiesFilter, Group, SortDescriptionIndicates whether the package version is deprecated. Available in API version 46.0 and later. |
...
| MetadataPackageId | TypereferencePropertiesFilter, Group, Nillable, SortDescriptionThe 18-character package ID starting with 033. |
