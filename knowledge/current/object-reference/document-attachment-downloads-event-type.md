---
title: "Document Attachment Downloads Event Type"
domain: object-reference
topic: document-attachment-downloads-event-type
apiVersion: 67.0
...
| Field | Details |
| --- | --- |
| ENTITY_ID | TypeIdDescriptionThe 15-character ID of the entity that’s associated with the document or attachment. |
| EVENT_TYPE | TypeStringDescriptionThe type of event. The value is always DocumentAttachmentDownoads. |
| FILE_TYPE | TypeStringDescriptionThe type of the file or attachment. |
