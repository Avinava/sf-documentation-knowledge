---
title: "Sites Event Type"
domain: object-reference
topic: sites-event-type
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-03-12T09:35:09.611Z
...
| EVENT_TYPE | TypeStringDescriptionThe type of event. The value is always Sites. |
| HTTP_HEADERS | TypeStringDescriptionThe HTTP headers that were sent in the request. |
| HTTP_METHOD | TypeStringDescriptionThe HTTP method of the request.For example: GET, POST, PUT, and so on. |
| IS_API | TypeBooleanDescriptionTrue if this page was an API or Web Services request. |
| IS_ERROR | TypeBooleanDescriptionTrue if this page was an error page. |
...
| IS_GUEST | TypeBooleanDescriptionTrue if this page was a guest (unauthenticated) request. |
| IS_SECURE | TypeBooleanDescriptionTrue if this request is secure. |
...
| QUERY | TypeStringDescriptionThe SOQL query, if one was performed. |
...
| SITE_ID | TypeIdDescriptionThe 15-character ID of the Site.com site. |
