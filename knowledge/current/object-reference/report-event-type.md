---
title: "Report Event Type"
domain: object-reference
topic: report-event-type
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-03-12T09:35:09.556Z
...
> Report events contain information about what happened when a user ran
         ...
         plus more. For example, it has user activity for reports exported as both Formatted Report
         and Details Only output.
...
| Field | Details |
| --- | --- |
| AVERAGE_ROW_SIZE | TypeNumberDescriptionThe average row size of all rows in the Report event, in bytes. A large average size, coupled with a high ROW_COUNT, can indicate that a user is downloading information for fraudulent purposes. For example, a salesperson who downloads all sales leads before departing for a competitor.Example700 |
...
| EVENT_TYPE | TypeStringDescriptionThe type of event. The value is always Report. |
...
| UI_NUMBER_COLUMNS | TypeNumberDescriptionThe number of columns in the report. The fields that have multiple components (for example, addresses) are considered as a single column. |
