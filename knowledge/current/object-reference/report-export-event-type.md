---
title: "Report Export Event Type"
domain: object-reference
topic: report-export-event-type
apiVersion: 67.0
...
> Report Export events contain details about reports that a user
         ...
         Only output. But it doesn’t capture reports that users export as Formatted Report or XLSX
         Detail output. For that data, see the Report event type.
...
| CLIENT_INFO | TypeStringDescriptionInformation about the client that’s using Salesforce services. |
...
| EVENT_TYPE | TypeStringDescriptionThe type of event. The value is always ReportExport. |
...
| REPORT_DESCRIPTION | TypeStringDescriptionInformation about the report that was run. |
