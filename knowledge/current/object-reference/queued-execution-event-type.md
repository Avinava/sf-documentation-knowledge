---
title: "Queued Execution Event Type"
domain: object-reference
topic: queued-execution-event-type
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-03-12T09:35:09.537Z
...
| CPU_TIME | TypeNumberDescriptionThe CPU time in milliseconds that it took to complete the batch apex request. This field indicates the amount of activity taking place in the app server layer, allowing you to identify pieces of Apex or Visualforce code that need refactoring. |
...
| ENTRY_POINT | TypeStringDescriptionThe name of the Apex class that serves as the execution point for the batch job.NoteThis field contains data only for Batch Apex. It is unpopulated for Future and Queueable processes.ExampleTaskPhoneExtensionBatchUpdate |
| EVENT_TYPE | TypeStringDescriptionThe type of event. The value is always QueuedExecution. |
| JOB_ID | TypeStringDescriptionThe ID of the batch Apex job.Example7073000000lDquo |
