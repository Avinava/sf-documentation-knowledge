...
lastCollected: 2026-03-12T09:35:18.499Z
estimatedTokens: 644
...
| ActivityType | TypepicklistPropertiesFilter, Nillable, Restricted picklistDescriptionThe type of activity.Possible value is UnifiedVoiceCall. |
| CallDurationInSeconds | TypeintPropertiesFilter, NillableDescriptionThe duration of the voice call in seconds. |
| DetailId | TypereferencePropertiesFilter, Group, Nillable, SortDescriptionThe ID of the object that contains detailed activity-specific information. The object depends on the activity type. For example, the detail for a Task activity is a Task object. The detail for an Event activity is an Event object.This field is a relationship field.Relationship NameDetailRelationship TypeLookupRefers ToVoiceCall |
...
| Snippet | TypestringPropertiesNillableDescriptionAn abbreviation of the voice call content. This field has a maximum length of 255 characters. |
| Subject | TypestringPropertiesNoneDescriptionContains the subject of the voice call. |
