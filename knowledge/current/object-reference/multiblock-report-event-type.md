---
title: "Multiblock Report Event Type"
domain: object-reference
topic: multiblock-report-event-type
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-03-12T09:35:09.458Z
estimatedTokens: 1584
keywords: [Multiblock, Report, Event, events, contain, Joined, reports]
---

# Multiblock Report Event Type

> Multiblock Report events contain details about Joined Report
         reports.
...
| EVENT_TYPE | TypeStringDescriptionThe type of event. The value is always MultiblockReport. |
| HAS_CHART | TypeBooleanDescriptionTrue if the report has a chart. |
...
| MASTER_REPORT_ID | TypeStringDescriptionThe 15-character ID of the master report. |
