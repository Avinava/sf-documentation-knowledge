---
title: "Bucket Dimension Setup Input"
domain: salesforce-recipes-api
topic: bucket-dimension-setup-input
apiVersion: 67.0
...
| --- | --- | --- | --- | --- |
| buckets | Bucket​Dimension​Bucket​Input[] | The list of buckets. | Required | 51.0 |
| source​Field | Bucket​Dimension​Source​Field​Input | The source field. | Required | 51.0 |
