...
> Salesforce Shield is a trio of security tools that helps you build extra levels of
        ...
        Platform Encryption, Event Monitoring, and Field Audit Trail. Ask your Salesforce
        administrator if Salesforce Shield is available in your org.
...
![The Shield Learning Map landing page includes overview resources about Shield products, and tabs to access resources for specific Shield features and use cases.](/docs/resources/img/en-us/260.0?doc_id=help%2Fbundle_setup%2Fimages%2F226_shield_learning_map.png&folder=securityImplGuide)
