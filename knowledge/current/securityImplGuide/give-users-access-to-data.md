---
title: "Give Users Access to Data"
domain: securityImplGuide
topic: give-users-access-to-data
apiVersion: 67.0
...
-   **[Control Who Sees What](atlas.en-us.securityImplGuide.meta/securityImplGuide/security_data_access.htm)**
...
-   **[User Permissions](atlas.en-us.securityImplGuide.meta/securityImplGuide/admin_userperms.htm)**
...
-   **[Object Permissions](atlas.en-us.securityImplGuide.meta/securityImplGuide/users_profiles_object_perms.htm)**
    Object permissions specify the base-level access users have to create, read, edit, and delete records for each object.
-   **[Custom Permissions](atlas.en-us.securityImplGuide.meta/securityImplGuide/custom_perms_overview.htm)**
    Use custom permissions to give users access to custom processes or apps.
-   **[Profiles](atlas.en-us.securityImplGuide.meta/securityImplGuide/admin_userprofiles.htm)**
...
-   **[Create a User Role](atlas.en-us.securityImplGuide.meta/securityImplGuide/admin_roles.htm)**
