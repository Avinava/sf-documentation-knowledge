...
> User permissions specify what tasks users can perform and what features users can
        ...
        Setup pages, and users with the API Enabled user permission can access any Salesforce
        API.
...
To view permissions and their descriptions, from Setup, in the Quick Find box, enter Permission Sets, and then select **Permission Sets**, then select or create a permission set. Then from the Permission Set Overview page, click **App Permissions** or **System Permissions**.

-   **[Permissions and Access Settings](atlas.en-us.securityImplGuide.meta/securityImplGuide/permissions_about_users_access.htm)**
