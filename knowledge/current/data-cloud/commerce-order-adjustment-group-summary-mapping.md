...
lastCollected: 2026-03-12T05:14:13.174Z
estimatedTokens: 441
keywords: [Commerce, Order, Adjustment, Group, Summary, Mapping, After, data, stream, deployed, starter, bundle, automatically, maps, Cloud, model, objects, DMO, Data, Cloud.]
---
...
> After a data stream is deployed, the Commerce starter data bundle
         ...
         the price of a product that’s made before order fulfillment. A sales order price adjustment
         can be composed of sales order Product price adjustments that allocate the overall
