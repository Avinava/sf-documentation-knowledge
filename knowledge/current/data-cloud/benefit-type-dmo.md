---
title: "Benefit Type DMO"
domain: data-cloud
topic: benefit-type-dmo
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-05-10T00:39:11.706Z
estimatedTokens: 414
keywords: [Category, Relationships, Benefit, DMO, Cloud, model, benefits, loyalty, program, healthcare, financial, API, Primary, Subject, Area, Key]
---
...
Benefit Type ID (ssot\_\_Id\_\_c)
...
| --- | --- | --- | --- |
| Benefit Type ID | ssot__Id__c | A unique ID used as primary key for the Benefit Type DMO. | text |
