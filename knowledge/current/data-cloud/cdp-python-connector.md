...
lastCollected: 2026-04-05T00:23:29.762Z
...
> Unlock and extend the value of Data Cloud data with the CDP Python
    ...
    into Python so that you can fetch data in Pandas DataFrames. With the data in your environment,
    you can create visual data models, perform powerful analytical operations, or build powerful
    machine learning and AI models as well.
