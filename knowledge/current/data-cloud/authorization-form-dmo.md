...
lastCollected: 2026-03-12T05:14:12.880Z
estimatedTokens: 535
keywords: [Authorization, Form, DMO, Data, Cloud, data, model, set, terms, conditions, such, privacy, policy, contract, consent, forms., API, Name, Category, Primary]
---

# Authorization Form DMO

> The Authorization Form DMO is a Data Cloud data model object (DMO) for the
      set of terms and conditions, such as privacy policy, contract, or consent forms.
