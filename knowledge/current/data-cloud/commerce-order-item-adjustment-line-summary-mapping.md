...
lastCollected: 2026-03-12T05:14:13.179Z
estimatedTokens: 425
keywords: [Commerce, Order, Item, Adjustment, Line, Summary, Mapping, After, data, stream, deployed, starter, bundle, automatically, maps, Cloud, model, objects, DMO, Data]
---
...
> After a data stream is deployed, the Commerce starter data bundle
         ...
         information about a change to the price of a sales order product that is made before order
         fulfillment. A sales order product price adjustment can stand alone or be related to a
         sales order level adjustment.
