---
title: "Create a Sample  DataSource.Connection Class"
domain: apex-guide
topic: create-a-sample-datasourceconnection-class
apiVersion: 67.0
release: summer-26-v67
docType: api-reference
lastCollected: 2026-05-10T00:39:51.774Z
estimatedTokens: 1485
keywords: [Sample, DataSource.Connection, enable, Salesforce, obtain, external, system’s, schema, handle, queries, searches, sync, query, search, upsertRows, deleteRows]
---
...
-   [Next →](atlas.en-us.apexcode.meta/apexcode/apex_connector_start_provider_class.htm "Create a Sample DataSource.Provider Class")
