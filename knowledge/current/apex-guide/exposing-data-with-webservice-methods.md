...
lastCollected: 2026-03-12T05:14:34.233Z
estimatedTokens: 482
keywords: [Exposing, Data, Webservice, Invoking, custom, webservice, always, uses, system, context., Consequently, current, user's, credentials, used, any, user, who, access, their]
---
...
> Invoking a custom webservice method always uses system
   ...
   to these methods can use their full power, regardless of permissions, field-level security, or
   sharing rules. Developers who expose methods 
