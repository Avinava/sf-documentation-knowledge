...
domain: apex-guide
topic: working-with-data-in-apex
apiVersion: 67.0
release: summer-26-v67
docType: developer-guide
lastCollected: 2026-03-12T09:33:33.132Z
estimatedTokens: 569
...
> You can add and interact with data in the Lightning Platform persistence layer. The
        ...
        Manipulation Language (DML) to work with data, and use query languages to retrieve data,
        such as the (), among other things.
...
-   **[Data Manipulation Language](atlas.en-us.apexcode.meta/apexcode/langCon_apex_dml.htm)**
...
-   **[sObject Collections](atlas.en-us.apexcode.meta/apexcode/apex_sobject_collections.htm)**
    You can manage sObjects in lists, sets, and maps.
-   **[Dynamic Apex](atlas.en-us.apexcode.meta/apexcode/apex_dynamic.htm)**
...
-   **[Custom Settings](atlas.en-us.apexcode.meta/apexcode/apex_customsettings.htm)**
