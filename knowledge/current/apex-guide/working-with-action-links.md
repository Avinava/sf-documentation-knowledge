...
lastCollected: 2026-03-12T05:14:34.470Z
estimatedTokens: 1057
keywords: [Working, Action, Links, action, link, button, feed, element., Clicking, take, user, Web, page, initiate, file, download, invoke, API, call, Salesforce]
---
...
- action link
            template (atlas.en-us.apexcode.meta/apexcode/connectapi_features_action_links_overview.htm)
- ChatterFeeds.getFeedElementsFromFeed() (atlas.en-us.apexcode.meta/apexcode/connectapi_examples_get_feed_elements.htm)
- Action Links Overview, Authentication, and Security (atlas.en-us.apexcode.meta/apexcode/connectapi_features_action_links_overview.htm)
- Action Links Use Case (atlas.en-us.apexcode.meta/apexcode/connectapi_features_action_links_use_cases.htm)
