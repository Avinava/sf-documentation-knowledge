...
topic: use-server-side-javascript-with-ampscript
apiVersion: 67.0
release: summer-26-v67
docType: help-article
lastCollected: 2026-04-07T09:06:28.652Z
estimatedTokens: 142
keywords: [Server-Side, JavaScript, AMPscript, Review, reviewing, associated, familiar, document, together, encourage, best, practice]
---

# Use Server-Side JavaScript with AMPscript

> Review the Server-side JavaScript Syntax Guide before reviewing associated page. You must be familiar with both AMPscript and server-side JavaScript before using the information in this document. While you can use AMPscript and JavaScript together, we do not encourage this as a best practice. This g
