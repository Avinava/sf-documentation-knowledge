...
topic: set-up-your-development-environment-for-enhanced-packages
apiVersion: 67.0
...
2.  [Get credentials](https://developer.salesforce.com/docs/atlas.en-us.mc-app-development.meta/mc-app-development/api-integration.htm). To use Marketing Cloud APIs, add an API integration to your installed package, and obtain credentials for authentication.
3.  Get an access token. Use the access token to authenticate API requests.
    ...
    2.  For server-to-server integrations, [set up client credentials grant type.](https://developer.salesforce.com/docs/atlas.en-us.mc-app-development.meta/mc-app-development/integration-s2s-client-credentials.htm)
