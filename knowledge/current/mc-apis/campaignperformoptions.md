...
| Explanation | xsd:string | Specifies a reason for pausing a running send. |
| OccurrenceIDs | xsd:ArrayOfString | Specifies the scheduled recurrences of a program. |
| OccurrenceIDsIndex | xsd:int | Specifies the index of the next occurence. |
