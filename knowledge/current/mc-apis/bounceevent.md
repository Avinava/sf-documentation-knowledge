...
| BounceCategory | xsd:string | Defines category for bounce associated with a bounced email. |
| BounceType | xsd:string | Defines type of bounce associated with a bounced email. |
...
| SMTPCode | xsd:string | Contains SMTP code related to a bounced email. |
| SMTPReason | xsd:string | Contains SMTP reason associated with a bounced email. |
...
-   [Retrieve Bounce Events Details](atlas.en-us.noversion.mc-apis.meta/mc-apis/retrieving_bounce_event_details.htm)
