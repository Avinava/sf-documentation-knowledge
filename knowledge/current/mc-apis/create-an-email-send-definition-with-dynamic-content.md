---
title: "Create an Email Send Definition with Dynamic Content"
domain: mc-apis
topic: create-an-email-send-definition-with-dynamic-content
apiVersion: 67.0
...
## Why Create an Email Send Definition with Dynamic Content
...
## How To Create an Email Send Definition with Dynamic Content
...
/**
     ...
     * In Response capture Task ID="7029017" which is sendID. Use this to
