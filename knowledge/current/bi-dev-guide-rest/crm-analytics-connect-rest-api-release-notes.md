---
title: "CRM Analytics Connect REST API Release Notes"
domain: bi-dev-guide-rest
topic: crm-analytics-connect-rest-api-release-notes
apiVersion: 67.0
...
For new and changed CRM Analytics Connect REST resources and request and response bodies see [CRM Analytics](https://help.salesforce.com/s/articleView?id=release-notes.rn_bi_analytics_cloud.htm&language=en_US) in the Salesforce Release Notes.
