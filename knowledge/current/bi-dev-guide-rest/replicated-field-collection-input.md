---
title: "Replicated Field Collection Input"
domain: bi-dev-guide-rest
topic: replicated-field-collection-input
apiVersion: 67.0
...
| --- | --- | --- | --- | --- |
| fields | Replicated​Field​Input[] | The list of field configurations. | Required | 37.0 |
