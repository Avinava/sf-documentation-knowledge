---
title: "Get Up to Speed with Experience Builder Sites"
domain: communities-dev
topic: get-up-to-speed-with-experience-builder-sites
apiVersion: 67.0
...
The [rename to Experience Cloud](https://help.salesforce.com/articleView?id=release-notes.rn_experiences_rebrand.htm&type=5&release=230&language=en_US "HTML (New Window)") in Spring ’21 (API version 50.0) introduced some new terminology, and it can be tricky to know what’s what. Here’s the rundown.
...
-   LWR sites are built with the latest LWR-based templates, such as the Build Your Own (LWR) template. LWR sites can only be used with Lightning web components, not Aura components. See [LWR Sites for Experience Cloud](https://developer.salesforce.com/docs/atlas.en-us.260.0.exp_cloud_lwr.meta/exp_cloud_lwr/intro.htm "HTML (New Window)").
...
-   **[Before You Begin](atlas.en-us.communities_dev.meta/communities_dev/communities_dev_intro_before.htm)**
    Before you begin developing custom Experience Builder sites, ensure that you’re familiar with developing in Lightning.
-   **[What Is Salesforce Lightning?](atlas.en-us.communities_dev.meta/communities_dev/communities_dev_intro_lightning.htm)**
...
-   **[Which Experience Builder Template Do I Use?](atlas.en-us.communities_dev.meta/communities_dev/communities_dev_basics_templates.htm)**
...
-   **[Experience Cloud Developer Release Notes](atlas.en-us.communities_dev.meta/communities_dev/communities_dev_intro_release_notes.htm)**
