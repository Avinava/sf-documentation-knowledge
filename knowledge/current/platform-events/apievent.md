...
| Records | TypejsonPropertiesNillableDescriptionFor SOAP and REST API, this field contains a JSON string that represents the queried objects’ metadata. This metadata includes the number of results of a query per entity type and the entity IDs.NoteThe records subfield is no longer supported. New implementations must use the recordIds s ubfield.SOAP and REST API Example{ "totalSize" : 1,   "done" : true,   "records" : [ {     "attributes" : {       "type" : "Account"     },     "recordIds" : "001xx000003DMvCAAW",     "Contacts" : {       "totalSize" : 3,       "done" : true,       "records" : [ {         "attributes" : {           "type" : "Contact"         },         "recordIds" : "003xx000004U7xKAAS"       }, {         "attributes" : {           "type" : "Contact"         },         "recordIds" : "003xx000004U7xLAAS"       }, {         "attributes" : {           "type" : "Contact"         },         "recordIds" : "003xx000004U7xMAAS"       } ]     }   } ] }Bulk API Example{     "totalSize": 3,     "done": true,     "records": [],     "recordIds": [         "001xx000003GYiBAAW",         "001xx000003GYiCAAW",         "001xx000003GYiDAAW"     ] } |
