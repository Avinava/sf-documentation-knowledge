---
title: "Use Salesforce Features While Offline"
domain: mobile-offline
topic: use-salesforce-features-while-offline
apiVersion: 67.0
...
> Although LWC Offline is intended to “just work” when you use features while offline,
  ...
  chapter provides details for how to use these features effectively in LWCs to make them
  offline-ready.
...
-   **[Use GraphQL While Mobile and Offline](atlas.en-us.mobile_offline.meta/mobile_offline/use_graphql.htm)**
...
-   **[Use Images in an LWC Offline-Enabled Component](atlas.en-us.mobile_offline.meta/mobile_offline/use_images.htm)**
...
-   **[Upload Images While Offline](atlas.en-us.mobile_offline.meta/mobile_offline/use_images_upload_while_offline.htm)**
...
-   **[Use Third-Party JavaScript in an LWC Offline-Enabled Component](atlas.en-us.mobile_offline.meta/mobile_offline/use_javascript.htm)**
