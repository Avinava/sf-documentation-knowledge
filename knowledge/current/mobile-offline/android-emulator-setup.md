...
lastCollected: 2026-03-12T09:34:56.714Z
...
-   **[Configure Minimum Required Android Emulator Settings](atlas.en-us.mobile_offline.meta/mobile_offline/quickstart_lwc_action_android_setup.htm#quickstart_lwc_action_android_setup_create_emulator)**
    Ensure your virtual device meets the minimum device and Android API version requirements to run your mobile app.
-   **[Install the Field Service App for Android](atlas.en-us.mobile_offline.meta/mobile_offline/quickstart_lwc_action_android_setup.htm#quickstart_lwc_action_android_setup_install_app)**
...
3.  Click **More Actions** or ![More Actions button with three vertical dots](/docs/resources/img/en-us/260.0?doc_id=images%2Fqs_studio_icon_more_actions.png&folder=mobile_offline) in the top left, depending on your version of Android Studio, and then select **Virtual Device Manager** from the dropdown.
4.  Click the ![Edit button with pencil icon](/docs/resources/img/en-us/260.0?doc_id=images%2Fqs_studio_icon_edit.png&folder=mobile_offline) in the Actions column of the device you’d like to edit.
...
5.  Click **Change** in the line that displays the version number.
    ...
    ![Android Studio virtual device configuration panel, API version setting](/docs/resources/img/en-us/260.0?doc_id=images%2Fqs_studio_avd_api_version.png&folder=mobile_offline)

6.  In the pop-up window, select API 30 version or later.
7.  Click **OK**.
8.  Scroll down in the window to the Memory and Storage section.

    ![Android Studio virtual device configuration panel, memory and storage settings](/docs/resources/img/en-us/260.0?doc_id=images%2Fqs_studio_avd_ram.png&folder=mobile_offline)
...
10.  Click **Finish**.
11.  Click ![Start Emulator button with play icon](/docs/resources/img/en-us/260.0?doc_id=images%2Fqs_studio_icon_start_emulator.png&folder=mobile_offline) in the Actions column of the device to launch the Android Emulator.
...
1.  Download the latest Android virtual device build of the [Salesforce Field Service mobile app APK file.](https://sfdc.co/fieldservice-mobile-app-android-simulator "HTML (New Window)")
...
6.  Click the vertical dots button on the top right and select **Change Server**.
    ...
    ![Field Service mobile app login. Select Change Connection in the top-right menu.](/docs/resources/img/en-us/260.0?doc_id=images%2Fqs_app_login_change_connection.png&folder=mobile_offline)
...
- Configure Minimum Required Android Emulator Settings (atlas.en-us.mobile_offline.meta/mobile_offline/quickstart_lwc_action_android_setup.htm)
- Install the Field Service App for Android (atlas.en-us.mobile_offline.meta/mobile_offline/quickstart_lwc_action_android_setup.htm)
