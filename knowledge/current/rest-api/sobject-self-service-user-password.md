...
lastCollected: 2026-04-07T09:02:36.234Z
estimatedTokens: 544
...
> Accesses self-service user passwords based on the specified
   user ID. Sets, resets, or gets the expiration status of a self-service user password based on the
   HTTP method. Use the GET method to retrieve a password’s expiration status, the POST method to
   set a password, or the DELETE method to initiate a password reset.
...
- Reset Self-Service User Password (atlas.en-us.api_rest.meta/api_rest/resources_sobject_self_service_user_password_delete.htm)
- Return Headers Using sObject Self-Service User Password (atlas.en-us.api_rest.meta/api_rest/resources_sobject_self_service_user_password_head.htm)
- ← Previous (atlas.en-us.api_rest.meta/api_rest/resources_sobject_user_password.htm)
- Next → (atlas.en-us.api_rest.meta/api_rest/resources_appmenu.htm)
