...
lastCollected: 2026-05-10T00:39:57.515Z
estimatedTokens: 161
...
> Returns only the headers from a GET request to the Embedded Service Configuration
  ...
  the content of the resource. You must be logged in to the account that owns the
  EmbeddedServiceConfigDeveloperName you are querying. This resource is available in REST API
