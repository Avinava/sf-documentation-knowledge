...
lastCollected: 2026-03-12T05:14:36.239Z
estimatedTokens: 404
keywords: [Getting, Information, Organization, examples, section, REST, API, resources, retrieve, organization-level, information, such, list, objects, organization.]
---
...
- Get a List of Objects (atlas.en-us.api_rest.meta/api_rest/dome_describeGlobal.htm)
- Get a List of Objects If Metadata Has Changed (atlas.en-us.api_rest.meta/api_rest/describe_global_with_ifmodified_header.htm)
- Next → (atlas.en-us.api_rest.meta/api_rest/using_resources_working_with_object_metadata.htm)
