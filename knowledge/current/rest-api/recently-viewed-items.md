...
lastCollected: 2026-03-12T05:14:35.862Z
estimatedTokens: 469
keywords: [Recently, Viewed, Items, most, recently, accessed, items, were, viewed, referenced, current, user., Salesforce, stores, information, record, views, uses, generate, list]
---
...
> Gets the most recently accessed items that were viewed or
		...
		the interface and uses it to generate a list of recently viewed and referenced records, such
		as in the sidebar and for the auto-complete options in search.
