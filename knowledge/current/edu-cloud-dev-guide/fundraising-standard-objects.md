...
lastCollected: 2026-03-12T09:34:25.689Z
...
-   **[DocGenerationQueryResult](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_docgenerationqueryresult.htm)**
...
-   **[DonorGiftConcept](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_donorgiftconcept.htm)**
...
-   **[DonorGiftConceptOpportunity](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_donorgiftconceptopportunity.htm)**
    The junction between a Donor Gift Concept and an Opportunity. This object is available in API version 66.0 and later.
-   **[DonorGiftSummary](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_donorgiftsummary.htm)**
    Represents gift summaries for accounts and contacts. This object is available in API version 59.0 and later.
-   **[GiftActuarialEntry](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_giftactuarialentry.htm)**
...
-   **[GiftStewardship](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_giftstewardship.htm)**
...
-   **[GiftStewardshipActivity](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_giftstewardshipactivity.htm)**
    Represents an activity carried out as part of gift stewardship. This object is available in API version 65.0 and later.
-   **[GiftAgreement](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_giftagreement.htm)**
    The agreement to accept a gift. This object is available in API version 64.0 and later.
-   **[GiftBatch](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_giftbatch.htm)**
    Represents the details and status of the batch of gifts. This object is available in API version 59.0 and later.
-   **[GiftCommitment](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_giftcommitment.htm)**
    Represents the commitment made by a donor. This object is available in API version 59.0 and later.
-   **[GiftCmtChangeAttrLog](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_giftcmtchangeattrlog.htm)**
...
-   **[GiftCommitmentSchedule](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_giftcommitmentschedule.htm)**
    Represents the schedule for fulfilling the commitment. This object is available in API version 59.0 and later.
-   **[GiftDefaultDesignation](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_giftdefaultdesignation.htm)**
...
-   **[GiftDefaultSoftCredit](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_giftdefaultsoftcredit.htm)**
...
-   **[GiftDesignation](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_giftdesignation.htm)**
...
-   **[GiftEntry](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_giftentry.htm)**
...
-   **[GiftRefund](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_giftrefund.htm)**
    Represents a refund of a gift. This object is available in API version 59.0 and later.
-   **[GiftSoftCredit](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_giftsoftcredit.htm)**
...
-   **[GiftTransaction](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_gifttransaction.htm)**
    Represents a completed transaction from a gift. This object is available in API version 59.0 and later.
-   **[GiftTransactionDesignation](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_gifttransactiondesignation.htm)**
...
-   **[GiftTribute](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_gifttribute.htm)**
    Represents the details and status of the gift tribute. This object is available in API version 59.0 and later.
-   **[GiftValueForecast](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_giftvalueforecast.htm)**
    The past, current, and projected monetary value of a gift. This object is available in API version 64.0 and later.
-   **[OutreachSourceCode](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_outreachsourcecode.htm)**
...
-   **[OutreachSummary](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_outreachsummary.htm)**
    Represents a summary of results of the outreach campaign. This object is available in API version 59.0 and later.
-   **[PartyCategory](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_partycategory.htm)**
...
-   **[PartyPhilanthropicAssessment](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/sforce_api_objects_partyphilanthropicassessment.htm)**
...
-   **[PartyPhilanthropicIndicator](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/sforce_api_objects_partyphilanthropicindicator.htm)**
...
-   **[PartyPhilanthropicMilestone](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/sforce_api_objects_partyphilanthropicmilestone.htm)**
...
-   **[PartyPhilanthropicOccurrence](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/sforce_api_objects_partyphilanthropicoccurrence.htm)**
    xxx This object is available in API version XX.0 and later.
-   **[PartyPhilanthropicRsrchPrfl](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_partyphilanthropicrsrchprfl.htm)**
...
-   **[PaymentInstrument](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/npc_fundraising_api_objects_paymentinstrument.htm)**
...
-   **[PlannedGift](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_plannedgift.htm)**
    A complex gift such as an annuity, bequest, or trust. This object is available in API version 64.0 and later.
-   **[PlannedGiftAnnuityRate](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_plannedgiftannuityrate.htm)**
    The rate used to calculate payments for a charitable gift annuity. This object is available in API version 64.0 and later.
-   **[PlannedGiftPerformance](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/fundraising_api_objects_plannedgiftperformance.htm)**
