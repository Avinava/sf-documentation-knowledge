...
-   **[Gift Transaction Designations](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/connect_resources_gift_designations.htm)**
    Get designations associated with a gift transaction, campaign, commitment, or opportunity.
-   **[Gift Commitment Transactions](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/connect_resources_gift_commitments.htm)**
    Get a list of gift transactions associated with a gift commitment for a donor account.
-   **[Gift Commitment Default Designations](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/connect_resources_commitment_default_designations.htm)**
    Get default designations associated with a gift commitment.
-   **[Gift Campaign Default Designations](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/connect_resources_campaign_default_designations.htm)**
    Get default designations associated with a gift campaign.
-   **[Gifts Transactions (POST)](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/connect_resources_gift_transaction_post.htm)**
...
-   **[Transactions Payment Updates (POST)](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/connect_resources_transaction_payment_update.htm)**
...
-   **[Commitments Payment Updates (POST)](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/connect_resources_commitments_payment_update.htm)**
    Update the metadata for your payment instruments for all active gift commitments.

## Related Topics

- Benefit Assignment (POST) (atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/connect_resources_mentoring_benefit_assignment.htm)
