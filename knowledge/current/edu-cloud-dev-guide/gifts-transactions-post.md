...
[Create Gift](atlas.en-us.edu_cloud_dev_guide.meta/edu_cloud_dev_guide/connect_responses_create_gift_output.htm "Output representation of the details of the created gift transaction response.")
