...
lastCollected: 2026-04-07T18:37:30.431Z
estimatedTokens: 780
keywords: [StandardObjectNameChangeEvent, ChangeEvent, supports, Change, Capture, subscribe, stream, events, receive, tied, record, changes, Salesforce, include, creation, updates, deletion, undeletion, event, isn’t, doesn’t, support, CRUD, operations, queries, It’s, included, discover, Message, API, Schema]
---
...
> A ChangeEvent object is available for each object that supports Change Data Capture.
    ...
    deletion of a record, and undeletion of a record. A change event isn’t a Salesforce object
    — it doesn’t support CRUD operations or queries. It’s included in the object reference so
    you can discover which Salesforce objects support change events.
