...
This guide assumes expertise in Salesforce administration and security, and knowledge of SQL and relational database concepts. It also assumes a familiarity with the content in [Record-Level Access: Under the Hood](https://developer.salesforce.com/docs/atlas.en-us.260.0.salesforce_record_access_under_the_hood.meta/salesforce_record_access_under_the_hood/uth_intro.htm "HTML (New Window)"), which explains the inner workings of the flexible and powerful Salesforce record access infrastructure.
