...
lastCollected: 2026-03-12T09:34:58.296Z
...
> A ChangeEvent object is available for each object that supports Change Data Capture. You
  can subscribe to a stream of change events using Change Data Capture to receive data tied to
  ...
  object—it doesn’t support CRUD operations or queries. It’s included in the object reference
  so you can discover which Salesforce objects support change events.
...
```
{
  ...
  "payload": {
    "ChangeEventHeader": {
      ...
      "changeType": "CREATE", 
      "changeOrigin": "com/salesforce/api/soap/63.0.0;client=SfdcInternalAPI/", 
