...
| [channel-revenue-management-dev-guide](../../knowledge/current/channel-revenue-management-dev-guide/_index.md) | **Channel Revenue Management Developer Guide** | 131 | Use Channel Revenue Management API and developer resources to programmatically m |
| [platform-connect](../../knowledge/current/platform-connect/_index.md) | **Canvas Developer Guide** | 124 | Learn how to integrate third-party applications into Salesforce using the Canvas |
| [api-asynch](../../knowledge/current/api-asynch/_index.md) | **Bulk API 2.0 and Bulk API Developer Guide** | 120 | Quickly load your org’s data into Salesforce, or query large data sets with Bulk |
...
| [change-data-capture](../../knowledge/current/change-data-capture/_index.md) | **Change Data Capture Developer Guide** | 79 | Receive near-real-time changes of Salesforce records, and synchronize correspond |
| [cpq-dev-api](../../knowledge/current/cpq-dev-api/_index.md) | **Salesforce CPQ Developer Guide** | 79 | Start working with Salesforce CPQ API and plugins. |
| [workdotcom-dev-guide](../../knowledge/current/workdotcom-dev-guide/_index.md) | **Work.com Developer Guide** | 79 | Build custom solutions for Work.com |
| [api-cti](../../knowledge/current/api-cti/_index.md) | **Open CTI Developer Guide** | 78 | Learn how to use a JavaScript API to build and integrate computer-telephony inte |
| [eu-developer-guide](../../knowledge/current/eu-developer-guide/_index.md) | **Energy and Utilities Cloud Developer Guide** | 74 | Use APIs and developer resources to configure, customize, and extend the capabil |
| [exp-cloud-lwr](../../knowledge/current/exp-cloud-lwr/_index.md) | **LWR Sites for Experience Cloud** | 74 | Develop Experience Cloud sites that load quickly and scale well using the Lightn |
...
| [bi-dev-guide-json](../../knowledge/current/bi-dev-guide-json/_index.md) | **Analytics Dashboard JSON Developer Guide** | 30 | Describes the properties that can be included in the dashboard JSON. Modify the  |
| [daas](../../knowledge/current/daas/_index.md) | **Ant Migration Tool Guide** | 30 | Move metadata components between your Salesforce development and production orgs |
| [bi-dev-guide-cli-reference](../../knowledge/current/bi-dev-guide-cli-reference/_index.md) | **Salesforce Analytics Plugin CLI Command Reference** | 29 | An alphabetized list of CLI commands that you use with Salesforce DX Analytics p |
| [case-feed-dev](../../knowledge/current/case-feed-dev/_index.md) | **Publisher and Quick Action Developer Guide** | 24 | Learn how you can use Lightning components, Visualforce, and Apex to customize y |
| [salesforce-guided-engagement](../../knowledge/current/salesforce-guided-engagement/_index.md) | **Lightning Flow for Service Developer Guide** | 24 | Associate record pages with actions to guide users through multi-step processes  |
| [order-management-developer-guide-html](../../knowledge/current/order-management-developer-guide-html/_index.md) | **Salesforce Order Management Developer Guide** | 22 | Customize Salesforce Order Management and integrate it with your storefront, inv |
| [usefulFormulaFields](../../knowledge/current/usefulFormulaFields/_index.md) | **Examples of Advanced Formula Fields** | 21 | Review examples of formula fields for various types of apps that you can use and |
| [bi-dev-guide-xmd](../../knowledge/current/bi-dev-guide-xmd/_index.md) | **Analytics Extended Metadata (XMD) Developer Guide** | 20 | Describes how to use extended metadata (XMD) to customize the formatting of data |
...
| [maps-developer-guide](../../knowledge/current/maps-developer-guide/_index.md) | **Salesforce Maps Apex Developer Guide** | 17 | Apex developer guide for technical admins and developers using Salesforce Maps. |
| [cgcloud-rtr-dev-guide](../../knowledge/current/cgcloud-rtr-dev-guide/_index.md) | **Consumer Goods Cloud Real Time Reporting Developer Guide** | 14 | Configure Consumer Goods Cloud Real Time Reporting to export CSV files. |
| [bi-dev-guide-ext-data](../../knowledge/current/bi-dev-guide-ext-data/_index.md) | **Analytics External Data API Developer Guide** | 13 | Describes how to use the External Data API to prepare and upload CSV files to CR |
| [bi-dev-guide-lwc-in-db](../../knowledge/current/bi-dev-guide-lwc-in-db/_index.md) | **Lightning Web Components in CRM Analytics Dashboards** | 13 | Describes how to create and use custom Lightning Web Components in CRM Analytics |
| [draes](../../knowledge/current/draes/_index.md) | **Designing Record Access for Enterprise Scale** | 13 | Optimize your organization's record access control performance. Topics provide g |
| [usefulValidationRules](../../knowledge/current/usefulValidationRules/_index.md) | **Examples of Validation Rules** | 13 | Review examples of validation rules for various types of apps that you can use a |
| [asl-dev-guide](../../knowledge/current/asl-dev-guide/_index.md) | **Accounting Subledger Developer Guide** | 12 | Accounting Subledger gives you the tools and developer resources you need to con |
| [salesforce-app-limits-cheatsheet](../../knowledge/current/salesforce-app-limits-cheatsheet/_index.md) | **Salesforce Developer Limits and Allocations Quick Reference** | 11 | Find the most critical limits for developing Lightning Platform applications. |
| [salesforce-developer-environment-tipsheet](../../knowledge/current/salesforce-developer-environment-tipsheet/_index.md) | **Setting Up Your Java Developer Environment** | 11 | Configure your local dev environment for integrating with Salesforce using Java. |
| [bigobjects](../../knowledge/current/bigobjects/_index.md) | **Big Objects Implementation Guide** | 10 | Describes the benefits of big objects, and details of creating, populating, and  |
| [caf-dev-guide](../../knowledge/current/caf-dev-guide/_index.md) | **Custom Address Fields Developer Guide** | 10 | Create and manage custom address fields. Access address data stored in these cus |
| [comm-cli-reference](../../knowledge/current/comm-cli-reference/_index.md) | **Salesforce Commerce Plug-In CLI Command Reference** | 10 | Use CLI commands to create and manage applications on the Lightning Platform. |
| [salesforce-dashboard-samples](../../knowledge/current/salesforce-dashboard-samples/_index.md) | **Sample CRM Dashboards** | 10 | This guide highlights some of the great features available in Salesforce dashboa |
| [salesforce-record-access-under-the-hood](../../knowledge/current/salesforce-record-access-under-the-hood/_index.md) | **Record-Level Access: Under the Hood** | 10 | See different levels of data access, as well as table-level ("under the hood") v |
| [appExchangeInstallGuide](../../knowledge/current/appExchangeInstallGuide/_index.md) | **Application Installation Guide** | 8 | Describes how to install a package from AppExchange and roll out the package to  |
| [field-history-retention](../../knowledge/current/field-history-retention/_index.md) | **Field Audit Trail Implementation Guide** | 8 | Field Audit Trail lets you define a policy to retain archived field history data |
