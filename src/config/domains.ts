...
export const DOMAINS: DomainConfig[] = [
    // --- P0: Critical domains ---
    {
        ...
        description: 'Salesforce CLI (sf) command reference — all commands across plugins',
    ...
    },
    {
        ...
        priority: 'P0',
        atlas: 'atlas.en-us.revenue_cloud_dev_guide',
        description: 'Product catalog, pricing, billing, Dynamic Revenue Orchestrator',
    ...
    },
    {
        ...
        name: 'Data Cloud',
        priority: 'P0',
        atlas: 'atlas.en-us.data_cloud_dev_guide',
        description: 'Data Cloud developer guide — data models, connectors, identity resolution',
    ...
    },
    {
        ...
        name: 'Agentforce',
        priority: 'P0',
        atlas: 'atlas.en-us.einstein_copilot_dev_guide',
    ...
    // --- P1: Important domains ---
    {
        ...
        description: 'Apex class library reference — all system classes and methods',
    ...
    },
    {
        ...
        description: 'Apex language guide — syntax, triggers, testing, best practices',
        tags: ['apex', 'development', 'language'],
    },
    {
        id: 'rest-api',
    ...
    },
    {
        ...
        description: 'LWC developer guide — components, lifecycle, wire service, events',
    ...
    // --- P2: Nice-to-have domains ---
    {
        ...
        name: 'OmniStudio',
        priority: 'P2',
        atlas: 'atlas.en-us.omnistudio',
        description: 'OmniStudio — OmniScripts, FlexCards, DataRaptors, Integration Procedures',
...
export function getDomainsByPriority(priority: 'P0' | 'P1' | 'P2'): DomainConfig[] {
